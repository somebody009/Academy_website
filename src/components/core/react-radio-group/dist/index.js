...
var $9yYIj$dssuiprimitive = require("../../primitive")
var $9yYIj$dssuireactcomposerefs = require("../../react-compose-refs")
var $9yYIj$dssuireactcontext = require("../../react-context")
var $9yYIj$dssuireactprimitive = require("../../react-primitive")
var $9yYIj$dssuireactrovingfocus = require("../../react-roving-focus")
var $9yYIj$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
var $9yYIj$dssuireactdirection = require("../../react-direction")
var $9yYIj$dssuireactusesize = require("../../react-use-size")
var $9yYIj$dssuireactuseprevious = require("../../react-use-previous")
var $9yYIj$dssuireactpresence = require("../../react-presence")
...
/* -------------------------------------------------------------------------------------------------
 * Radio
 * -----------------------------------------------------------------------------------------------*/ const $ce74a64c62457efb$var$RADIO_NAME =
  "Radio"
const [$ce74a64c62457efb$var$createRadioContext, $ce74a64c62457efb$export$67d2296460f1b002] =
  $9yYIj$dssuireactcontext.createContextScope($ce74a64c62457efb$var$RADIO_NAME)
const [$ce74a64c62457efb$var$RadioProvider, $ce74a64c62457efb$var$useRadioContext] =
  $ce74a64c62457efb$var$createRadioContext($ce74a64c62457efb$var$RADIO_NAME)
const $ce74a64c62457efb$export$d7b12c4107be0d61 = /*#__PURE__*/ $9yYIj$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $9yYIj$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) => setButton(node))
  ...
  return /*#__PURE__*/ $9yYIj$react.createElement(
    $ce74a64c62457efb$var$RadioProvider,
    {
      scope: __scopeRadio,
      checked: checked,
      disabled: disabled,
    },
    /*#__PURE__*/ $9yYIj$react.createElement(
      $9yYIj$dssuireactprimitive.Primitive.button,
      $parcel$interopDefault($9yYIj$babelruntimehelpersextends)(
        {
          type: "button",
          role: "radio",
        ...
        {
          ref: composedRefs,
          onClick: $9yYIj$dssuiprimitive.composeEventHandlers(props.onClick, (event) => {
    ...
    isFormControl &&
      /*#__PURE__*/ $9yYIj$react.createElement($ce74a64c62457efb$var$BubbleInput, {
        control: button,
...
/* -------------------------------------------------------------------------------------------------
 * RadioIndicator
 * -----------------------------------------------------------------------------------------------*/ const $ce74a64c62457efb$var$INDICATOR_NAME =
  "RadioIndicator"
const $ce74a64c62457efb$export$d35a9ffa9a04f9e7 = /*#__PURE__*/ $9yYIj$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $9yYIj$react.createElement(
    $9yYIj$dssuireactpresence.Presence,
    {
      present: forceMount || context.checked,
    },
    /*#__PURE__*/ $9yYIj$react.createElement(
      $9yYIj$dssuireactprimitive.Primitive.span,
      $parcel$interopDefault($9yYIj$babelruntimehelpersextends)(
        {
...
/* ---------------------------------------------------------------------------------------------- */ const $ce74a64c62457efb$var$BubbleInput =
  (props) => {
    const { control: control, checked: checked, bubbles: bubbles = true, ...inputProps } = props
    const ref = $9yYIj$react.useRef(null)
    const prevChecked = $9yYIj$dssuireactuseprevious.usePrevious(checked)
    const controlSize = $9yYIj$dssuireactusesize.useSize(control) // Bubble checked change to parents (e.g form change event)
...
const $240483839a8a76fd$var$ARROW_KEYS = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"]
/* -------------------------------------------------------------------------------------------------
 * RadioGroup
 * -----------------------------------------------------------------------------------------------*/ const $240483839a8a76fd$var$RADIO_GROUP_NAME =
  "RadioGroup"
const [$240483839a8a76fd$var$createRadioGroupContext, $240483839a8a76fd$export$c547093f11b76da2] =
  $9yYIj$dssuireactcontext.createContextScope($240483839a8a76fd$var$RADIO_GROUP_NAME, [
    $9yYIj$dssuireactrovingfocus.createRovingFocusGroupScope,
    $ce74a64c62457efb$export$67d2296460f1b002,
  ])
const $240483839a8a76fd$var$useRovingFocusGroupScope = $9yYIj$dssuireactrovingfocus.createRovingFocusGroupScope()
const $240483839a8a76fd$var$useRadioScope = $ce74a64c62457efb$export$67d2296460f1b002()
const [$240483839a8a76fd$var$RadioGroupProvider, $240483839a8a76fd$var$useRadioGroupContext] =
  $240483839a8a76fd$var$createRadioGroupContext($240483839a8a76fd$var$RADIO_GROUP_NAME)
const $240483839a8a76fd$export$a98f0dcb43a68a25 = /*#__PURE__*/ $9yYIj$react.forwardRef((props, forwardedRef) => {
  ...
  const direction = $9yYIj$dssuireactdirection.useDirection(dir)
  const [value, setValue] = $9yYIj$dssuireactusecontrollablestate.useControllableState({
    prop: valueProp,
    defaultProp: defaultValue,
    onChange: onValueChange,
  })
  return /*#__PURE__*/ $9yYIj$react.createElement(
    $240483839a8a76fd$var$RadioGroupProvider,
    {
    ...
    /*#__PURE__*/ $9yYIj$react.createElement(
      $9yYIj$dssuireactrovingfocus.Root,
      $parcel$interopDefault($9yYIj$babelruntimehelpersextends)(
        {
          asChild: true,
        },
      ...
      /*#__PURE__*/ $9yYIj$react.createElement(
        $9yYIj$dssuireactprimitive.Primitive.div,
        $parcel$interopDefault($9yYIj$babelruntimehelpersextends)(
          {
            role: "radiogroup",
...
/* -------------------------------------------------------------------------------------------------
 * RadioGroupItem
 * -----------------------------------------------------------------------------------------------*/ const $240483839a8a76fd$var$ITEM_NAME =
  "RadioGroupItem"
const $240483839a8a76fd$export$9f866c100ef519e4 = /*#__PURE__*/ $9yYIj$react.forwardRef((props, forwardedRef) => {
  ...
  const ref = $9yYIj$react.useRef(null)
  const composedRefs = $9yYIj$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref)
  ...
  return /*#__PURE__*/ $9yYIj$react.createElement(
    $9yYIj$dssuireactrovingfocus.Item,
    $parcel$interopDefault($9yYIj$babelruntimehelpersextends)(
      {
        asChild: true,
      },
    ...
    /*#__PURE__*/ $9yYIj$react.createElement(
      $ce74a64c62457efb$export$d7b12c4107be0d61,
      $parcel$interopDefault($9yYIj$babelruntimehelpersextends)(
        {
          disabled: isDisabled,
        ...
        itemProps,
        {
          ...
          onKeyDown: $9yYIj$dssuiprimitive.composeEventHandlers((event) => {
            // According to WAI ARIA, radio groups don't activate items on enter keypress
            if (event.key === "Enter") event.preventDefault()
          }),
          onFocus: $9yYIj$dssuiprimitive.composeEventHandlers(itemProps.onFocus, () => {
            var _ref$current
            /**
...
/* -------------------------------------------------------------------------------------------------
 * RadioGroupIndicator
 * -----------------------------------------------------------------------------------------------*/ const $240483839a8a76fd$var$INDICATOR_NAME =
  "RadioGroupIndicator"
const $240483839a8a76fd$export$5fb54c671a65c88 = /*#__PURE__*/ $9yYIj$react.forwardRef((props, forwardedRef) => {
  const { __scopeRadioGroup: __scopeRadioGroup, ...indicatorProps } = props
  const radioScope = $240483839a8a76fd$var$useRadioScope(__scopeRadioGroup)
  return /*#__PURE__*/ $9yYIj$react.createElement(
    $ce74a64c62457efb$export$d35a9ffa9a04f9e7,
    $parcel$interopDefault($9yYIj$babelruntimehelpersextends)({}, radioScope, indicatorProps, {
      ref: forwardedRef,
    })
  )
})
...
/* ---------------------------------------------------------------------------------------------- */ const $240483839a8a76fd$export$be92b6f5f03c0fe9 =
  $240483839a8a76fd$export$a98f0dcb43a68a25
