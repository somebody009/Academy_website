...
var $iVrL9$dssuiprimitive = require("../../primitive")
var $iVrL9$dssuireactcomposerefs = require("../../react-compose-refs")
var $iVrL9$dssuireactcontext = require("../../react-context")
var $iVrL9$dssuireactdismissablelayer = require("../../react-dismissable-layer")
var $iVrL9$dssuireactid = require("../../react-id")
var $iVrL9$dssuireactpopper = require("../../react-popper")
var $iVrL9$dssuireactportal = require("../../react-portal")
var $iVrL9$dssuireactpresence = require("../../react-presence")
var $iVrL9$dssuireactprimitive = require("../../react-primitive")
var $iVrL9$dssuireactslot = require("../../react-slot")
var $iVrL9$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
var $iVrL9$dssuireactvisuallyhidden = require("../../react-visually-hidden")
...
const [$c34afbc43c90cc6f$var$createTooltipContext, $c34afbc43c90cc6f$export$1c540a2224f0d865] =
  $iVrL9$dssuireactcontext.createContextScope("Tooltip", [$iVrL9$dssuireactpopper.createPopperScope])
const $c34afbc43c90cc6f$var$usePopperScope = $iVrL9$dssuireactpopper.createPopperScope()
/* -------------------------------------------------------------------------------------------------
 * TooltipProvider
 * -----------------------------------------------------------------------------------------------*/ const $c34afbc43c90cc6f$var$PROVIDER_NAME =
  "TooltipProvider"
const $c34afbc43c90cc6f$var$DEFAULT_DELAY_DURATION = 700
const $c34afbc43c90cc6f$var$TOOLTIP_OPEN = "tooltip.open"
const [$c34afbc43c90cc6f$var$TooltipProviderContextProvider, $c34afbc43c90cc6f$var$useTooltipProviderContext] =
  $c34afbc43c90cc6f$var$createTooltipContext($c34afbc43c90cc6f$var$PROVIDER_NAME)
const $c34afbc43c90cc6f$export$f78649fb9ca566b8 = (props) => {
  const {
    __scopeTooltip: __scopeTooltip,
    delayDuration: delayDuration = $c34afbc43c90cc6f$var$DEFAULT_DELAY_DURATION,
  ...
  return /*#__PURE__*/ $iVrL9$react.createElement(
    $c34afbc43c90cc6f$var$TooltipProviderContextProvider,
    {
...
/* -------------------------------------------------------------------------------------------------
 * Tooltip
 * -----------------------------------------------------------------------------------------------*/ const $c34afbc43c90cc6f$var$TOOLTIP_NAME =
  "Tooltip"
const [$c34afbc43c90cc6f$var$TooltipContextProvider, $c34afbc43c90cc6f$var$useTooltipContext] =
  $c34afbc43c90cc6f$var$createTooltipContext($c34afbc43c90cc6f$var$TOOLTIP_NAME)
const $c34afbc43c90cc6f$export$28c660c63b792dea = (props) => {
  ...
  const providerContext = $c34afbc43c90cc6f$var$useTooltipProviderContext(
    $c34afbc43c90cc6f$var$TOOLTIP_NAME,
  ...
  const contentId = $iVrL9$dssuireactid.useId()
  const openTimerRef = $iVrL9$react.useRef(0)
  const disableHoverableContent =
    disableHoverableContentProp !== null && disableHoverableContentProp !== void 0
      ? disableHoverableContentProp
      : providerContext.disableHoverableContent
  const delayDuration =
    delayDurationProp !== null && delayDurationProp !== void 0 ? delayDurationProp : providerContext.delayDuration
  const wasOpenDelayedRef = $iVrL9$react.useRef(false)
  const [open1 = false, setOpen] = $iVrL9$dssuireactusecontrollablestate.useControllableState({
    prop: openProp,
  ...
  return /*#__PURE__*/ $iVrL9$react.createElement(
    $iVrL9$dssuireactpopper.Root,
    popperScope,
    /*#__PURE__*/ $iVrL9$react.createElement(
      $c34afbc43c90cc6f$var$TooltipContextProvider,
      {
        scope: __scopeTooltip,
        contentId: contentId,
        open: open1,
...
/* -------------------------------------------------------------------------------------------------
 * TooltipTrigger
 * -----------------------------------------------------------------------------------------------*/ const $c34afbc43c90cc6f$var$TRIGGER_NAME =
  "TooltipTrigger"
const $c34afbc43c90cc6f$export$8c610744efcf8a1d = /*#__PURE__*/ $iVrL9$react.forwardRef((props, forwardedRef) => {
  ...
  const providerContext = $c34afbc43c90cc6f$var$useTooltipProviderContext(
    $c34afbc43c90cc6f$var$TRIGGER_NAME,
    __scopeTooltip
  )
  const popperScope = $c34afbc43c90cc6f$var$usePopperScope(__scopeTooltip)
  const ref = $iVrL9$react.useRef(null)
  const composedRefs = $iVrL9$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref, context.onTriggerChange)
  ...
  return /*#__PURE__*/ $iVrL9$react.createElement(
    $iVrL9$dssuireactpopper.Anchor,
    $parcel$interopDefault($iVrL9$babelruntimehelpersextends)(
      {
        asChild: true,
      },
      popperScope
    ...
    /*#__PURE__*/ $iVrL9$react.createElement(
      $iVrL9$dssuireactprimitive.Primitive.button,
      $parcel$interopDefault($iVrL9$babelruntimehelpersextends)(
        {
        ...
        {
          ref: composedRefs,
          onPointerMove: $iVrL9$dssuiprimitive.composeEventHandlers(props.onPointerMove, (event) => {
          ...
          onPointerLeave: $iVrL9$dssuiprimitive.composeEventHandlers(props.onPointerLeave, () => {
            context.onTriggerLeave()
            hasPointerMoveOpenedRef.current = false
          }),
          onPointerDown: $iVrL9$dssuiprimitive.composeEventHandlers(props.onPointerDown, () => {
            isPointerDownRef.current = true
            document.addEventListener("pointerup", handlePointerUp, {
              once: true,
            })
          }),
          onFocus: $iVrL9$dssuiprimitive.composeEventHandlers(props.onFocus, () => {
            if (!isPointerDownRef.current) context.onOpen()
          }),
          onBlur: $iVrL9$dssuiprimitive.composeEventHandlers(props.onBlur, context.onClose),
          onClick: $iVrL9$dssuiprimitive.composeEventHandlers(props.onClick, context.onClose),
        }
      )
    )
  )
...
/* -------------------------------------------------------------------------------------------------
 * TooltipPortal
 * -----------------------------------------------------------------------------------------------*/ const $c34afbc43c90cc6f$var$PORTAL_NAME =
  "TooltipPortal"
const [$c34afbc43c90cc6f$var$PortalProvider, $c34afbc43c90cc6f$var$usePortalContext] =
  $c34afbc43c90cc6f$var$createTooltipContext($c34afbc43c90cc6f$var$PORTAL_NAME, {
...
const $c34afbc43c90cc6f$export$7b36b8f925ab7497 = (props) => {
  ...
  return /*#__PURE__*/ $iVrL9$react.createElement(
    $c34afbc43c90cc6f$var$PortalProvider,
    {
      scope: __scopeTooltip,
      forceMount: forceMount,
    },
    /*#__PURE__*/ $iVrL9$react.createElement(
      $iVrL9$dssuireactpresence.Presence,
      {
        present: forceMount || context.open,
      },
      /*#__PURE__*/ $iVrL9$react.createElement(
        $iVrL9$dssuireactportal.Portal,
        {
          asChild: true,
          container: container,
        },
...
/* -------------------------------------------------------------------------------------------------
 * TooltipContent
 * -----------------------------------------------------------------------------------------------*/ const $c34afbc43c90cc6f$var$CONTENT_NAME =
  "TooltipContent"
const $c34afbc43c90cc6f$export$e9003e2be37ec060 = /*#__PURE__*/ $iVrL9$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $iVrL9$react.createElement(
    ...
    context.disableHoverableContent
      ? /*#__PURE__*/ $iVrL9$react.createElement(
          $c34afbc43c90cc6f$var$TooltipContentImpl,
          $parcel$interopDefault($iVrL9$babelruntimehelpersextends)(
            {
              side: side,
            },
      ...
      : /*#__PURE__*/ $iVrL9$react.createElement(
          $c34afbc43c90cc6f$var$TooltipContentHoverable,
          $parcel$interopDefault($iVrL9$babelruntimehelpersextends)(
            {
              side: side,
            },
...
const $c34afbc43c90cc6f$var$TooltipContentHoverable = /*#__PURE__*/ $iVrL9$react.forwardRef((props, forwardedRef) => {
  const context = $c34afbc43c90cc6f$var$useTooltipContext($c34afbc43c90cc6f$var$CONTENT_NAME, props.__scopeTooltip)
  const providerContext = $c34afbc43c90cc6f$var$useTooltipProviderContext(
    $c34afbc43c90cc6f$var$CONTENT_NAME,
    props.__scopeTooltip
  )
  const ref = $iVrL9$react.useRef(null)
  const composedRefs = $iVrL9$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref)
  ...
  const handleCreateGraceArea = $iVrL9$react.useCallback(
    (event, hoverTarget) => {
  ...
  return /*#__PURE__*/ $iVrL9$react.createElement(
    $c34afbc43c90cc6f$var$TooltipContentImpl,
    $parcel$interopDefault($iVrL9$babelruntimehelpersextends)({}, props, {
      ref: composedRefs,
    })
  )
})
const [
  $c34afbc43c90cc6f$var$VisuallyHiddenContentContextProvider,
  $c34afbc43c90cc6f$var$useVisuallyHiddenContentContext,
] = $c34afbc43c90cc6f$var$createTooltipContext($c34afbc43c90cc6f$var$TOOLTIP_NAME, {
  isInside: false,
})
const $c34afbc43c90cc6f$var$TooltipContentImpl = /*#__PURE__*/ $iVrL9$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $iVrL9$react.createElement(
    $iVrL9$dssuireactdismissablelayer.DismissableLayer,
    {
      asChild: true,
    ...
    /*#__PURE__*/ $iVrL9$react.createElement(
      $iVrL9$dssuireactpopper.Content,
      $parcel$interopDefault($iVrL9$babelruntimehelpersextends)(
        {
          "data-state": context.stateAttribute,
        },
        ...
        contentProps,
        {
          ...
          style: {
            ...contentProps.style,
            "--dss-tooltip-content-transform-origin": "var(--dss-popper-transform-origin)",
            "--dss-tooltip-content-available-width": "var(--dss-popper-available-width)",
            "--dss-tooltip-content-available-height": "var(--dss-popper-available-height)",
            "--dss-tooltip-trigger-width": "var(--dss-popper-anchor-width)",
            "--dss-tooltip-trigger-height": "var(--dss-popper-anchor-height)",
          },
        }
      ),
      /*#__PURE__*/ $iVrL9$react.createElement($iVrL9$dssuireactslot.Slottable, null, children),
      /*#__PURE__*/ $iVrL9$react.createElement(
        $c34afbc43c90cc6f$var$VisuallyHiddenContentContextProvider,
        {
          scope: __scopeTooltip,
        ...
        /*#__PURE__*/ $iVrL9$react.createElement(
          $iVrL9$dssuireactvisuallyhidden.Root,
          {
...
/* -------------------------------------------------------------------------------------------------
 * TooltipArrow
 * -----------------------------------------------------------------------------------------------*/ const $c34afbc43c90cc6f$var$ARROW_NAME =
  "TooltipArrow"
const $c34afbc43c90cc6f$export$c27ee0ad710f7559 = /*#__PURE__*/ $iVrL9$react.forwardRef((props, forwardedRef) => {
  ...
  const popperScope = $c34afbc43c90cc6f$var$usePopperScope(__scopeTooltip)
  const visuallyHiddenContentContext = $c34afbc43c90cc6f$var$useVisuallyHiddenContentContext(
    $c34afbc43c90cc6f$var$ARROW_NAME,
    __scopeTooltip
  ...
  return visuallyHiddenContentContext.isInside
    ? null
    : /*#__PURE__*/ $iVrL9$react.createElement(
        $iVrL9$dssuireactpopper.Arrow,
        $parcel$interopDefault($iVrL9$babelruntimehelpersextends)({}, popperScope, arrowProps, {
          ref: forwardedRef,
        })
      )
})
...
/* -----------------------------------------------------------------------------------------------*/ function $c34afbc43c90cc6f$var$getExitSideFromRect(
  point,
  rect
) {
