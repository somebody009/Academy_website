...
import {
  useState as $8wepK$useState,
  useRef as $8wepK$useRef,
  useEffect as $8wepK$useEffect,
  createElement as $8wepK$createElement,
  useCallback as $8wepK$useCallback,
  useMemo as $8wepK$useMemo,
  forwardRef as $8wepK$forwardRef,
} from "react";
import { composeEventHandlers as $8wepK$composeEventHandlers } from "../../primitive";
import { useComposedRefs as $8wepK$useComposedRefs } from "../../react-compose-refs";
import { createContextScope as $8wepK$createContextScope } from "../../react-context";
import { DismissableLayer as $8wepK$DismissableLayer } from "../../react-dismissable-layer";
import { useId as $8wepK$useId } from "../../react-id";
import {
  createPopperScope as $8wepK$createPopperScope,
  Root as $8wepK$Root,
  Anchor as $8wepK$Anchor,
  Content as $8wepK$Content,
  Arrow as $8wepK$Arrow,
} from "../../react-popper";
import { Portal as $8wepK$Portal } from "../../react-portal";
import { Presence as $8wepK$Presence } from "../../react-presence";
import { Primitive as $8wepK$Primitive } from "../../react-primitive";
import { Slottable as $8wepK$Slottable } from "../../react-slot";
import { useControllableState as $8wepK$useControllableState } from "../../react-use-controllable-state";
import { Root as $8wepK$Root1 } from "../../react-visually-hidden";

const [
  $a093c7e1ec25a057$var$createTooltipContext,
  $a093c7e1ec25a057$export$1c540a2224f0d865,
] = $8wepK$createContextScope("Tooltip", [$8wepK$createPopperScope]);
const $a093c7e1ec25a057$var$usePopperScope = $8wepK$createPopperScope();
/* -------------------------------------------------------------------------------------------------
 * TooltipProvider
 * -----------------------------------------------------------------------------------------------*/ const $a093c7e1ec25a057$var$PROVIDER_NAME =
  "TooltipProvider";
...
const $a093c7e1ec25a057$export$f78649fb9ca566b8 = (props) => {
  const {
    ...
    delayDuration: delayDuration = $a093c7e1ec25a057$var$DEFAULT_DELAY_DURATION,
...
/* -------------------------------------------------------------------------------------------------
 * Tooltip
 * -----------------------------------------------------------------------------------------------*/ const $a093c7e1ec25a057$var$TOOLTIP_NAME =
  "Tooltip";
const [
...
/* -------------------------------------------------------------------------------------------------
 * TooltipTrigger
 * -----------------------------------------------------------------------------------------------*/ const $a093c7e1ec25a057$var$TRIGGER_NAME =
  "TooltipTrigger";
const $a093c7e1ec25a057$export$8c610744efcf8a1d =
  /*#__PURE__*/ $8wepK$forwardRef((props, forwardedRef) => {
    ...
    const composedRefs = $8wepK$useComposedRefs(
      forwardedRef,
      ref,
    ...
    return /*#__PURE__*/ $8wepK$createElement(
      $8wepK$Anchor,
      $8wepK$babelruntimehelpersesmextends(
        {
          asChild: true,
        },
        popperScope
      ...
      /*#__PURE__*/ $8wepK$createElement(
        ...
        $8wepK$babelruntimehelpersesmextends(
          ...
          {
            ref: composedRefs,
            onPointerMove: $8wepK$composeEventHandlers(
              props.onPointerMove,
              (event) => {
            ...
            onPointerLeave: $8wepK$composeEventHandlers(
            ...
            onPointerDown: $8wepK$composeEventHandlers(
              props.onPointerDown,
              () => {
            ...
            onClick: $8wepK$composeEventHandlers(
              props.onClick,
              context.onClose
            ),
          }
...
/* -------------------------------------------------------------------------------------------------
 * TooltipPortal
 * -----------------------------------------------------------------------------------------------*/ const $a093c7e1ec25a057$var$PORTAL_NAME =
  "TooltipPortal";
const [
...
/* -------------------------------------------------------------------------------------------------
 * TooltipContent
 * -----------------------------------------------------------------------------------------------*/ const $a093c7e1ec25a057$var$CONTENT_NAME =
  "TooltipContent";
const $a093c7e1ec25a057$export$e9003e2be37ec060 =
  /*#__PURE__*/ $8wepK$forwardRef((props, forwardedRef) => {
...
const $a093c7e1ec25a057$var$TooltipContentHoverable =
  /*#__PURE__*/ $8wepK$forwardRef((props, forwardedRef) => {
    ...
    const { onPointerInTransitChange: onPointerInTransitChange } =
      providerContext;
    const handleRemoveGraceArea = $8wepK$useCallback(() => {
      setPointerGraceArea(null);
      onPointerInTransitChange(false);
    }, [onPointerInTransitChange]);
    const handleCreateGraceArea = $8wepK$useCallback(
      (event, hoverTarget) => {
        ...
        const paddedExitPoints = $a093c7e1ec25a057$var$getPaddedExitPoints(
          exitPoint,
          exitSide
        );
        const hoverTargetPoints = $a093c7e1ec25a057$var$getPointsFromRect(
    ...
    return /*#__PURE__*/ $8wepK$createElement(
      $a093c7e1ec25a057$var$TooltipContentImpl,
      $8wepK$babelruntimehelpersesmextends({}, props, {
        ref: composedRefs,
      })
    );
  });
      ...
      /*#__PURE__*/ $8wepK$createElement(
        ...
        $8wepK$babelruntimehelpersesmextends(
          ...
          contentProps,
          {
            ...
            style: {
              ...contentProps.style,
              "--dss-tooltip-content-transform-origin":
                "var(--dss-popper-transform-origin)",
              "--dss-tooltip-content-available-width":
                "var(--dss-popper-available-width)",
              "--dss-tooltip-content-available-height":
        ...
        /*#__PURE__*/ $8wepK$createElement($8wepK$Slottable, null, children),
        /*#__PURE__*/ $8wepK$createElement(
          $a093c7e1ec25a057$var$VisuallyHiddenContentContextProvider,
          {
            scope: __scopeTooltip,
...
/* -------------------------------------------------------------------------------------------------
 * TooltipArrow
 * -----------------------------------------------------------------------------------------------*/ const $a093c7e1ec25a057$var$ARROW_NAME =
  "TooltipArrow";
const $a093c7e1ec25a057$export$c27ee0ad710f7559 =
  /*#__PURE__*/ $8wepK$forwardRef((props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside
      ...
      : /*#__PURE__*/ $8wepK$createElement(
          $8wepK$Arrow,
          $8wepK$babelruntimehelpersesmextends({}, popperScope, arrowProps, {
            ref: forwardedRef,
          })
        );
  });
...
/* -----------------------------------------------------------------------------------------------*/ function $a093c7e1ec25a057$var$getExitSideFromRect(
  point,
  rect
) {
...
function $a093c7e1ec25a057$var$getPaddedExitPoints(
  exitPoint,
  exitSide,
  padding = 5
) {
...
const $a093c7e1ec25a057$export$2881499e37b75b9a =
  $a093c7e1ec25a057$export$f78649fb9ca566b8;
const $a093c7e1ec25a057$export$be92b6f5f03c0fe9 =
  $a093c7e1ec25a057$export$28c660c63b792dea;
const $a093c7e1ec25a057$export$41fb9f06171c75f4 =
  $a093c7e1ec25a057$export$8c610744efcf8a1d;
const $a093c7e1ec25a057$export$602eac185826482c =
  $a093c7e1ec25a057$export$7b36b8f925ab7497;
const $a093c7e1ec25a057$export$7c6e2c02157bb7d2 =
  $a093c7e1ec25a057$export$e9003e2be37ec060;
const $a093c7e1ec25a057$export$21b07c8f274aebd5 =
