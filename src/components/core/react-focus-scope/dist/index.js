...
var $buum9$dssuireactcomposerefs = require("../../react-compose-refs")
var $buum9$dssuireactprimitive = require("../../react-primitive")
var $buum9$dssuireactusecallbackref = require("../../react-use-callback-ref")
...
/* -------------------------------------------------------------------------------------------------
 * FocusScope
 * -----------------------------------------------------------------------------------------------*/ const $2bc01e66e04aa9ed$var$FOCUS_SCOPE_NAME =
  "FocusScope"
const $2bc01e66e04aa9ed$export$20e40289641fbbb6 = /*#__PURE__*/ $buum9$react.forwardRef((props, forwardedRef) => {
  ...
  const onMountAutoFocus = $buum9$dssuireactusecallbackref.useCallbackRef(onMountAutoFocusProp)
  const onUnmountAutoFocus = $buum9$dssuireactusecallbackref.useCallbackRef(onUnmountAutoFocusProp)
  const lastFocusedElementRef = $buum9$react.useRef(null)
  const composedRefs = $buum9$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) => setContainer(node))
    ...
    if (container1) {
      ...
      if (!hasFocusedCandidate) {
        const mountEvent = new CustomEvent(
          $2bc01e66e04aa9ed$var$AUTOFOCUS_ON_MOUNT,
          $2bc01e66e04aa9ed$var$EVENT_OPTIONS
        )
        container1.addEventListener($2bc01e66e04aa9ed$var$AUTOFOCUS_ON_MOUNT, onMountAutoFocus)
        container1.dispatchEvent(mountEvent)
        if (!mountEvent.defaultPrevented) {
          $2bc01e66e04aa9ed$var$focusFirst(
            $2bc01e66e04aa9ed$var$removeLinks($2bc01e66e04aa9ed$var$getTabbableCandidates(container1)),
            {
              select: true,
            }
          )
  ...
  const handleKeyDown = $buum9$react.useCallback(
    (event) => {
  ...
  return /*#__PURE__*/ $buum9$react.createElement(
    $buum9$dssuireactprimitive.Primitive.div,
    $parcel$interopDefault($buum9$babelruntimehelpersextends)(
      {
        tabIndex: -1,
      },
      scopeProps,
 ...
 */ function $2bc01e66e04aa9ed$var$findVisible(elements, container) {
  for (const element of elements) {
    ...
    if (
      !$2bc01e66e04aa9ed$var$isHidden(element, {
        upTo: container,
      })
    )
      return element
...
/* -------------------------------------------------------------------------------------------------
 * FocusScope stack
 * -----------------------------------------------------------------------------------------------*/ const $2bc01e66e04aa9ed$var$focusScopesStack =
  $2bc01e66e04aa9ed$var$createFocusScopesStack()
