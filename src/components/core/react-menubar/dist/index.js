...
var $fIWtd$dssuireactcollection = require("../../react-collection")
var $fIWtd$dssuireactdirection = require("../../react-direction")
var $fIWtd$dssuiprimitive = require("../../primitive")
var $fIWtd$dssuireactcomposerefs = require("../../react-compose-refs")
var $fIWtd$dssuireactcontext = require("../../react-context")
var $fIWtd$dssuireactid = require("../../react-id")
var $fIWtd$dssuireactmenu = require("../../react-menu")
var $fIWtd$dssuireactrovingfocus = require("../../react-roving-focus")
var $fIWtd$dssuireactprimitive = require("../../react-primitive")
var $fIWtd$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
...
/* -------------------------------------------------------------------------------------------------
 * Menubar
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$MENUBAR_NAME =
  "Menubar"
const [
  $f5560139001bae38$var$Collection,
  $f5560139001bae38$var$useCollection,
  $f5560139001bae38$var$createCollectionScope,
] = $fIWtd$dssuireactcollection.createCollection($f5560139001bae38$var$MENUBAR_NAME)
const [$f5560139001bae38$var$createMenubarContext, $f5560139001bae38$export$7a4049d5555b545c] =
  $fIWtd$dssuireactcontext.createContextScope($f5560139001bae38$var$MENUBAR_NAME, [
    $f5560139001bae38$var$createCollectionScope,
    $fIWtd$dssuireactrovingfocus.createRovingFocusGroupScope,
  ])
const $f5560139001bae38$var$useMenuScope = $fIWtd$dssuireactmenu.createMenuScope()
const $f5560139001bae38$var$useRovingFocusGroupScope = $fIWtd$dssuireactrovingfocus.createRovingFocusGroupScope()
const [$f5560139001bae38$var$MenubarContextProvider, $f5560139001bae38$var$useMenubarContext] =
  $f5560139001bae38$var$createMenubarContext($f5560139001bae38$var$MENUBAR_NAME)
const $f5560139001bae38$export$7d4583da7581e674 = /*#__PURE__*/ $fIWtd$react.forwardRef((props, forwardedRef) => {
  const {
    __scopeMenubar: __scopeMenubar,
    value: valueProp,
  ...
  const direction = $fIWtd$dssuireactdirection.useDirection(dir)
  const rovingFocusGroupScope = $f5560139001bae38$var$useRovingFocusGroupScope(__scopeMenubar)
  const [value1 = "", setValue] = $fIWtd$dssuireactusecontrollablestate.useControllableState({
    prop: valueProp,
  ...
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $f5560139001bae38$var$MenubarContextProvider,
    {
      scope: __scopeMenubar,
      value: value1,
      onMenuOpen: $fIWtd$react.useCallback(
        (value) => {
          setValue(value)
      ...
      onMenuClose: $fIWtd$react.useCallback(() => setValue(""), [setValue]),
      onMenuToggle: $fIWtd$react.useCallback(
        (value) => {
          setValue((prevValue) => (Boolean(prevValue) ? "" : value)) // `openMenuOpen` and `onMenuToggle` are called exclusively so we
    ...
    /*#__PURE__*/ $fIWtd$react.createElement(
      $f5560139001bae38$var$Collection.Provider,
      {
        scope: __scopeMenubar,
      },
      /*#__PURE__*/ $fIWtd$react.createElement(
        $f5560139001bae38$var$Collection.Slot,
        {
          scope: __scopeMenubar,
        },
        /*#__PURE__*/ $fIWtd$react.createElement(
          $fIWtd$dssuireactrovingfocus.Root,
          $parcel$interopDefault($fIWtd$babelruntimehelpersextends)(
            {
              asChild: true,
            },
          ...
          /*#__PURE__*/ $fIWtd$react.createElement(
            $fIWtd$dssuireactprimitive.Primitive.div,
            $parcel$interopDefault($fIWtd$babelruntimehelpersextends)(
              {
                role: "menubar",
              },
...
/* -------------------------------------------------------------------------------------------------
 * MenubarMenu
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$MENU_NAME =
  "MenubarMenu"
const [$f5560139001bae38$var$MenubarMenuProvider, $f5560139001bae38$var$useMenubarMenuContext] =
  $f5560139001bae38$var$createMenubarContext($f5560139001bae38$var$MENU_NAME)
const $f5560139001bae38$export$c777b394d551050b = (props) => {
  const { __scopeMenubar: __scopeMenubar, value: valueProp, ...menuProps } = props
  const autoValue = $fIWtd$dssuireactid.useId() // We need to provide an initial deterministic value as `useId` will return
  ...
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $f5560139001bae38$var$MenubarMenuProvider,
    {
      scope: __scopeMenubar,
      value: value,
      triggerId: $fIWtd$dssuireactid.useId(),
      triggerRef: triggerRef,
      contentId: $fIWtd$dssuireactid.useId(),
      wasKeyboardTriggerOpenRef: wasKeyboardTriggerOpenRef,
    },
    /*#__PURE__*/ $fIWtd$react.createElement(
      $fIWtd$dssuireactmenu.Root,
      $parcel$interopDefault($fIWtd$babelruntimehelpersextends)(
        {},
        menuScope,
        {
...
/* -------------------------------------------------------------------------------------------------
 * MenubarTrigger
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$TRIGGER_NAME =
  "MenubarTrigger"
const $f5560139001bae38$export$df05cd234081ebd5 = /*#__PURE__*/ $fIWtd$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $fIWtd$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref, menuContext.triggerRef)
  const [isFocused, setIsFocused] = $fIWtd$react.useState(false)
  const open = context.value === menuContext.value
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $f5560139001bae38$var$Collection.ItemSlot,
    {
      scope: __scopeMenubar,
    ...
    /*#__PURE__*/ $fIWtd$react.createElement(
      $fIWtd$dssuireactrovingfocus.Item,
      $parcel$interopDefault($fIWtd$babelruntimehelpersextends)(
        {
          asChild: true,
        },
      ...
      /*#__PURE__*/ $fIWtd$react.createElement(
        ...
        /*#__PURE__*/ $fIWtd$react.createElement(
          $fIWtd$dssuireactprimitive.Primitive.button,
          $parcel$interopDefault($fIWtd$babelruntimehelpersextends)(
            {
              type: "button",
              role: "menuitem",
            ...
            {
              ref: composedRefs,
              onPointerDown: $fIWtd$dssuiprimitive.composeEventHandlers(props.onPointerDown, (event) => {
              ...
              onPointerEnter: $fIWtd$dssuiprimitive.composeEventHandlers(props.onPointerEnter, () => {
              ...
              onKeyDown: $fIWtd$dssuiprimitive.composeEventHandlers(props.onKeyDown, (event) => {
                if (disabled) return
              ...
              onFocus: $fIWtd$dssuiprimitive.composeEventHandlers(props.onFocus, () => setIsFocused(true)),
              onBlur: $fIWtd$dssuiprimitive.composeEventHandlers(props.onBlur, () => setIsFocused(false)),
            }
          )
        )
      )
...
/* -------------------------------------------------------------------------------------------------
 * MenubarPortal
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$PORTAL_NAME =
  "MenubarPortal"
const $f5560139001bae38$export$a98ed304d621e164 = (props) => {
  const { __scopeMenubar: __scopeMenubar, ...portalProps } = props
  const menuScope = $f5560139001bae38$var$useMenuScope(__scopeMenubar)
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $fIWtd$dssuireactmenu.Portal,
    $parcel$interopDefault($fIWtd$babelruntimehelpersextends)({}, menuScope, portalProps)
  )
}
...
/* -------------------------------------------------------------------------------------------------
 * MenubarContent
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$CONTENT_NAME =
  "MenubarContent"
const $f5560139001bae38$export$f42a00bc8a46c161 = /*#__PURE__*/ $fIWtd$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $fIWtd$dssuireactmenu.Content,
    $parcel$interopDefault($fIWtd$babelruntimehelpersextends)(
      {
        id: menuContext.contentId,
        "aria-labelledby": menuContext.triggerId,
        "data-dss-menubar-content": "",
      },
      menuScope,
      contentProps,
      {
        ref: forwardedRef,
        align: align,
        onCloseAutoFocus: $fIWtd$dssuiprimitive.composeEventHandlers(props.onCloseAutoFocus, (event) => {
          const menubarOpen = Boolean(context.value)
          if (!menubarOpen && !hasInteractedOutsideRef.current) {
            var _menuContext$triggerR
            ;(_menuContext$triggerR = menuContext.triggerRef.current) === null ||
              _menuContext$triggerR === void 0 ||
        ...
        onFocusOutside: $fIWtd$dssuiprimitive.composeEventHandlers(props.onFocusOutside, (event) => {
        ...
        onInteractOutside: $fIWtd$dssuiprimitive.composeEventHandlers(props.onInteractOutside, () => {
          hasInteractedOutsideRef.current = true
        }),
        onEntryFocus: (event) => {
          if (!menuContext.wasKeyboardTriggerOpenRef.current) event.preventDefault()
        },
        onKeyDown: $fIWtd$dssuiprimitive.composeEventHandlers(
          props.onKeyDown,
          (event) => {
            if (["ArrowRight", "ArrowLeft"].includes(event.key)) {
              const target = event.target
              const targetIsSubTrigger = target.hasAttribute("data-dss-menubar-subtrigger")
              const isKeyDownInsideSubMenu = target.closest("[data-dss-menubar-content]") !== event.currentTarget
              ...
              candidateValues = context.loop
                ? $f5560139001bae38$var$wrapArray(candidateValues, currentIndex + 1)
        ...
        style: {
          ...props.style,
          "--dss-menubar-content-transform-origin": "var(--dss-popper-transform-origin)",
          "--dss-menubar-content-available-width": "var(--dss-popper-available-width)",
          "--dss-menubar-content-available-height": "var(--dss-popper-available-height)",
          "--dss-menubar-trigger-width": "var(--dss-popper-anchor-width)",
          "--dss-menubar-trigger-height": "var(--dss-popper-anchor-height)",
        },
      }
    )
  )
...
/* -------------------------------------------------------------------------------------------------
 * MenubarGroup
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$GROUP_NAME =
  "MenubarGroup"
const $f5560139001bae38$export$7669e79198e0f2eb = /*#__PURE__*/ $fIWtd$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $f5560139001bae38$var$useMenuScope(__scopeMenubar)
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $fIWtd$dssuireactmenu.Group,
    $parcel$interopDefault($fIWtd$babelruntimehelpersextends)({}, menuScope, groupProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * MenubarLabel
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$LABEL_NAME =
  "MenubarLabel"
const $f5560139001bae38$export$39935c5b19a4b4e = /*#__PURE__*/ $fIWtd$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $f5560139001bae38$var$useMenuScope(__scopeMenubar)
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $fIWtd$dssuireactmenu.Label,
    $parcel$interopDefault($fIWtd$babelruntimehelpersextends)({}, menuScope, labelProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * MenubarItem
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$ITEM_NAME =
  "MenubarItem"
const $f5560139001bae38$export$92f903c8c91c291c = /*#__PURE__*/ $fIWtd$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $f5560139001bae38$var$useMenuScope(__scopeMenubar)
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $fIWtd$dssuireactmenu.Item,
    $parcel$interopDefault($fIWtd$babelruntimehelpersextends)({}, menuScope, itemProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * MenubarCheckboxItem
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$CHECKBOX_ITEM_NAME =
  "MenubarCheckboxItem"
const $f5560139001bae38$export$372384eccd27af53 = /*#__PURE__*/ $fIWtd$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $f5560139001bae38$var$useMenuScope(__scopeMenubar)
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $fIWtd$dssuireactmenu.CheckboxItem,
    $parcel$interopDefault($fIWtd$babelruntimehelpersextends)({}, menuScope, checkboxItemProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * MenubarRadioGroup
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$RADIO_GROUP_NAME =
  "MenubarRadioGroup"
const $f5560139001bae38$export$94dfa2322f330fdb = /*#__PURE__*/ $fIWtd$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $f5560139001bae38$var$useMenuScope(__scopeMenubar)
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $fIWtd$dssuireactmenu.RadioGroup,
    $parcel$interopDefault($fIWtd$babelruntimehelpersextends)({}, menuScope, radioGroupProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * MenubarRadioItem
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$RADIO_ITEM_NAME =
  "MenubarRadioItem"
const $f5560139001bae38$export$7d2f467b4a7f68d8 = /*#__PURE__*/ $fIWtd$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $f5560139001bae38$var$useMenuScope(__scopeMenubar)
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $fIWtd$dssuireactmenu.RadioItem,
    $parcel$interopDefault($fIWtd$babelruntimehelpersextends)({}, menuScope, radioItemProps, {
      ref: forwardedRef,
    })
  )
})
 ...
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$INDICATOR_NAME =
  "MenubarItemIndicator"
const $f5560139001bae38$export$63e15a0e2af5a57 = /*#__PURE__*/ $fIWtd$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $f5560139001bae38$var$useMenuScope(__scopeMenubar)
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $fIWtd$dssuireactmenu.ItemIndicator,
    $parcel$interopDefault($fIWtd$babelruntimehelpersextends)({}, menuScope, itemIndicatorProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * MenubarSeparator
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$SEPARATOR_NAME =
  "MenubarSeparator"
const $f5560139001bae38$export$588aef9e7b5183b5 = /*#__PURE__*/ $fIWtd$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $f5560139001bae38$var$useMenuScope(__scopeMenubar)
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $fIWtd$dssuireactmenu.Separator,
    $parcel$interopDefault($fIWtd$babelruntimehelpersextends)({}, menuScope, separatorProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * MenubarArrow
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$ARROW_NAME =
  "MenubarArrow"
const $f5560139001bae38$export$474b9891f5b9e633 = /*#__PURE__*/ $fIWtd$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $f5560139001bae38$var$useMenuScope(__scopeMenubar)
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $fIWtd$dssuireactmenu.Arrow,
    $parcel$interopDefault($fIWtd$babelruntimehelpersextends)({}, menuScope, arrowProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * MenubarSub
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$SUB_NAME =
  "MenubarSub"
const $f5560139001bae38$export$ed0be551778c493a = (props) => {
  ...
  const menuScope = $f5560139001bae38$var$useMenuScope(__scopeMenubar)
  const [open = false, setOpen] = $fIWtd$dssuireactusecontrollablestate.useControllableState({
    prop: openProp,
    defaultProp: defaultOpen,
    onChange: onOpenChange,
  })
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $fIWtd$dssuireactmenu.Sub,
    $parcel$interopDefault($fIWtd$babelruntimehelpersextends)({}, menuScope, {
      open: open,
...
/* -------------------------------------------------------------------------------------------------
 * MenubarSubTrigger
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$SUB_TRIGGER_NAME =
  "MenubarSubTrigger"
const $f5560139001bae38$export$1820ea18a1dfed3c = /*#__PURE__*/ $fIWtd$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $f5560139001bae38$var$useMenuScope(__scopeMenubar)
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $fIWtd$dssuireactmenu.SubTrigger,
    $parcel$interopDefault($fIWtd$babelruntimehelpersextends)(
      {
        "data-dss-menubar-subtrigger": "",
      },
      menuScope,
      subTriggerProps,
      {
...
/* -------------------------------------------------------------------------------------------------
 * MenubarSubContent
 * -----------------------------------------------------------------------------------------------*/ const $f5560139001bae38$var$SUB_CONTENT_NAME =
  "MenubarSubContent"
const $f5560139001bae38$export$1b21e255bb3e4f7f = /*#__PURE__*/ $fIWtd$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $f5560139001bae38$var$useMenuScope(__scopeMenubar)
  return /*#__PURE__*/ $fIWtd$react.createElement(
    $fIWtd$dssuireactmenu.SubContent,
    $parcel$interopDefault($fIWtd$babelruntimehelpersextends)(
      {},
      menuScope,
      {
