...
import {
  forwardRef as $g1Vy2$forwardRef,
  useState as $g1Vy2$useState,
  useRef as $g1Vy2$useRef,
  createElement as $g1Vy2$createElement,
  useMemo as $g1Vy2$useMemo,
  useEffect as $g1Vy2$useEffect,
} from "react";
import { clamp as $g1Vy2$clamp } from "../../number";
import { composeEventHandlers as $g1Vy2$composeEventHandlers } from "../../primitive";
import { useComposedRefs as $g1Vy2$useComposedRefs } from "../../react-compose-refs";
import { createContextScope as $g1Vy2$createContextScope } from "../../react-context";
import { useControllableState as $g1Vy2$useControllableState } from "../../react-use-controllable-state";
import { useDirection as $g1Vy2$useDirection } from "../../react-direction";
import { usePrevious as $g1Vy2$usePrevious } from "../../react-use-previous";
import { useSize as $g1Vy2$useSize } from "../../react-use-size";
import { Primitive as $g1Vy2$Primitive } from "../../react-primitive";
import { createCollection as $g1Vy2$createCollection } from "../../react-collection";
...
/* -------------------------------------------------------------------------------------------------
 * Slider
 * -----------------------------------------------------------------------------------------------*/ const $faa2e61a3361514f$var$SLIDER_NAME =
  "Slider";
const [
...
] = $g1Vy2$createContextScope($faa2e61a3361514f$var$SLIDER_NAME, [
  $faa2e61a3361514f$var$createCollectionScope,
]);
const [
...
const $faa2e61a3361514f$export$472062a354075cee =
  /*#__PURE__*/ $g1Vy2$forwardRef((props, forwardedRef) => {
    const {
      name: name,
      min: min = 0,
      max: max = 100,
    ...
    const composedRefs = $g1Vy2$useComposedRefs(forwardedRef, (node) =>
      setSlider(node)
    );
    ...
    const [values = [], setValues] = $g1Vy2$useControllableState({
      ...
      onChange: (value) => {
        ...
        (_thumbs$valueIndexToC = thumbs[valueIndexToChangeRef.current]) ===
          null ||
    ...
    function handleSlideStart(value) {
      const closestIndex = $faa2e61a3361514f$var$getClosestValueIndex(
        values,
        value
      );
    ...
    function updateValues(
      ...
      setValues((prevValues = []) => {
        const nextValues = $faa2e61a3361514f$var$getNextSortedValues(
          prevValues,
          nextValue,
          atIndex
        );
        if (
          $faa2e61a3361514f$var$hasMinStepsBetweenValues(
            nextValues,
    ...
    return /*#__PURE__*/ $g1Vy2$createElement(
      $faa2e61a3361514f$var$SliderProvider,
      {
      ...
      /*#__PURE__*/ $g1Vy2$createElement(
        ...
        /*#__PURE__*/ $g1Vy2$createElement(
          ...
          /*#__PURE__*/ $g1Vy2$createElement(
            SliderOrientation,
            $g1Vy2$babelruntimehelpersesmextends(
              {
              ...
              {
                ref: composedRefs,
                onPointerDown: $g1Vy2$composeEventHandlers(
                ...
                onStepKeyDown: ({ event: event, direction: stepDirection }) => {
                  if (!disabled) {
                    const isPageKey = $faa2e61a3361514f$var$PAGE_KEYS.includes(
                      event.key
                    );
                    const isSkipKey =
                      isPageKey ||
                      (event.shiftKey &&
                        $faa2e61a3361514f$var$ARROW_KEYS.includes(event.key));
...
const $faa2e61a3361514f$var$SliderHorizontal = /*#__PURE__*/ $g1Vy2$forwardRef(
  (props, forwardedRef) => {
    const {
      min: min,
      max: max,
          ...
          sliderProps,
          {
            ...
            onStepKeyDown: (event) => {
              const slideDirection = isSlidingFromLeft
                ? "from-left"
                : "from-right";
              const isBackKey = $faa2e61a3361514f$var$BACK_KEYS[
                slideDirection
              ].includes(event.key);
              onStepKeyDown === null ||
...
/* -------------------------------------------------------------------------------------------------
 * SliderVertical
 * -----------------------------------------------------------------------------------------------*/ const $faa2e61a3361514f$var$SliderVertical =
  /*#__PURE__*/ $g1Vy2$forwardRef((props, forwardedRef) => {
    const {
      min: min,
      max: max,
...
/* -------------------------------------------------------------------------------------------------
 * SliderImpl
 * -----------------------------------------------------------------------------------------------*/ const $faa2e61a3361514f$var$SliderImpl =
  /*#__PURE__*/ $g1Vy2$forwardRef((props, forwardedRef) => {
    const {
    ...
    return /*#__PURE__*/ $g1Vy2$createElement(
      $g1Vy2$Primitive.span,
      $g1Vy2$babelruntimehelpersesmextends({}, sliderProps, {
        ref: forwardedRef,
        ...
        onPointerMove: $g1Vy2$composeEventHandlers(
          props.onPointerMove,
          (event) => {
            const target = event.target;
...
/* -------------------------------------------------------------------------------------------------
 * SliderTrack
 * -----------------------------------------------------------------------------------------------*/ const $faa2e61a3361514f$var$TRACK_NAME =
  "SliderTrack";
const $faa2e61a3361514f$export$105594979f116971 =
  /*#__PURE__*/ $g1Vy2$forwardRef((props, forwardedRef) => {
...
/* -------------------------------------------------------------------------------------------------
 * SliderRange
 * -----------------------------------------------------------------------------------------------*/ const $faa2e61a3361514f$var$RANGE_NAME =
  "SliderRange";
const $faa2e61a3361514f$export$a5cf38a7a000fe77 =
  /*#__PURE__*/ $g1Vy2$forwardRef((props, forwardedRef) => {
...
/* -------------------------------------------------------------------------------------------------
 * SliderThumb
 * -----------------------------------------------------------------------------------------------*/ const $faa2e61a3361514f$var$THUMB_NAME =
  "SliderThumb";
const $faa2e61a3361514f$export$2c1b491743890dec =
  /*#__PURE__*/ $g1Vy2$forwardRef((props, forwardedRef) => {
    ...
    return /*#__PURE__*/ $g1Vy2$createElement(
      ...
      $g1Vy2$babelruntimehelpersesmextends({}, props, {
        ref: composedRefs,
        index: index,
      })
    );
  });
const $faa2e61a3361514f$var$SliderThumbImpl = /*#__PURE__*/ $g1Vy2$forwardRef(
  (props, forwardedRef) => {
    ...
    const orientationSize =
      size === null || size === void 0 ? void 0 : size[orientation.size];
...
/* -----------------------------------------------------------------------------------------------*/ const $faa2e61a3361514f$var$BubbleInput =
  (props) => {
 ...
 */ function $faa2e61a3361514f$var$hasMinStepsBetweenValues(
  ...
  if (minStepsBetweenValues > 0) {
    const stepsBetweenValues =
      $faa2e61a3361514f$var$getStepsBetweenValues(values);
...
const $faa2e61a3361514f$export$13921ac0cc260818 =
  $faa2e61a3361514f$export$105594979f116971;
const $faa2e61a3361514f$export$9a58ef0d7ad3278c =
  $faa2e61a3361514f$export$a5cf38a7a000fe77;
const $faa2e61a3361514f$export$6521433ed15a34db =
