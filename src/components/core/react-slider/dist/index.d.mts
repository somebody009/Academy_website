...
export const createSliderScope: import("../../react-context").CreateScope;
...
export const SliderTrack: React.ForwardRefExoticComponent<
  SliderTrackProps & React.RefAttributes<HTMLSpanElement>
>;
export interface SliderRangeProps extends PrimitiveSpanProps {}
export const SliderRange: React.ForwardRefExoticComponent<
...
export const SliderThumb: React.ForwardRefExoticComponent<
