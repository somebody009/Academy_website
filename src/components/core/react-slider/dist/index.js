...
var $inrcs$dssuinumber = require("../../number")
var $inrcs$dssuiprimitive = require("../../primitive")
var $inrcs$dssuireactcomposerefs = require("../../react-compose-refs")
var $inrcs$dssuireactcontext = require("../../react-context")
var $inrcs$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
var $inrcs$dssuireactdirection = require("../../react-direction")
var $inrcs$dssuireactuseprevious = require("../../react-use-previous")
var $inrcs$dssuireactusesize = require("../../react-use-size")
var $inrcs$dssuireactprimitive = require("../../react-primitive")
var $inrcs$dssuireactcollection = require("../../react-collection")
...
const $1791bb30e2e418d5$var$PAGE_KEYS = ["PageUp", "PageDown"]
const $1791bb30e2e418d5$var$ARROW_KEYS = ["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"]
...
/* -------------------------------------------------------------------------------------------------
 * Slider
 * -----------------------------------------------------------------------------------------------*/ const $1791bb30e2e418d5$var$SLIDER_NAME =
  "Slider"
const [
  $1791bb30e2e418d5$var$Collection,
  $1791bb30e2e418d5$var$useCollection,
  $1791bb30e2e418d5$var$createCollectionScope,
] = $inrcs$dssuireactcollection.createCollection($1791bb30e2e418d5$var$SLIDER_NAME)
const [$1791bb30e2e418d5$var$createSliderContext, $1791bb30e2e418d5$export$ef72632d7b901f97] =
  $inrcs$dssuireactcontext.createContextScope($1791bb30e2e418d5$var$SLIDER_NAME, [
    $1791bb30e2e418d5$var$createCollectionScope,
  ])
const [$1791bb30e2e418d5$var$SliderProvider, $1791bb30e2e418d5$var$useSliderContext] =
  $1791bb30e2e418d5$var$createSliderContext($1791bb30e2e418d5$var$SLIDER_NAME)
const $1791bb30e2e418d5$export$472062a354075cee = /*#__PURE__*/ $inrcs$react.forwardRef((props, forwardedRef) => {
  const {
    ...
    minStepsBetweenThumbs: minStepsBetweenThumbs = 0,
  ...
  const composedRefs = $inrcs$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) => setSlider(node))
  ...
  const [values = [], setValues] = $inrcs$dssuireactusecontrollablestate.useControllableState({
    prop: value1,
  ...
  function updateValues(
    ...
    const nextValue = $inrcs$dssuinumber.clamp(snapToStep, [min, max])
  ...
  return /*#__PURE__*/ $inrcs$react.createElement(
    $1791bb30e2e418d5$var$SliderProvider,
    {
    ...
    /*#__PURE__*/ $inrcs$react.createElement(
      $1791bb30e2e418d5$var$Collection.Provider,
      {
        scope: props.__scopeSlider,
      },
      /*#__PURE__*/ $inrcs$react.createElement(
        $1791bb30e2e418d5$var$Collection.Slot,
        {
          scope: props.__scopeSlider,
        },
        /*#__PURE__*/ $inrcs$react.createElement(
          SliderOrientation,
          $parcel$interopDefault($inrcs$babelruntimehelpersextends)(
            {
            ...
            {
              ref: composedRefs,
              onPointerDown: $inrcs$dssuiprimitive.composeEventHandlers(sliderProps.onPointerDown, () => {
              ...
              onStepKeyDown: ({ event: event, direction: stepDirection }) => {
                if (!disabled) {
                  ...
                  const isSkipKey =
                    isPageKey || (event.shiftKey && $1791bb30e2e418d5$var$ARROW_KEYS.includes(event.key))
    ...
    isFormControl &&
      values.map((value, index) =>
        /*#__PURE__*/ $inrcs$react.createElement($1791bb30e2e418d5$var$BubbleInput, {
          key: index,
 ...
 * SliderHorizontal
 * -----------------------------------------------------------------------------------------------*/ const [
  $1791bb30e2e418d5$var$SliderOrientationProvider,
  $1791bb30e2e418d5$var$useSliderOrientationContext,
] = $1791bb30e2e418d5$var$createSliderContext($1791bb30e2e418d5$var$SLIDER_NAME, {
  startEdge: "left",
  endEdge: "right",
  size: "width",
...
const $1791bb30e2e418d5$var$SliderHorizontal = /*#__PURE__*/ $inrcs$react.forwardRef((props, forwardedRef) => {
  ...
  const direction = $inrcs$dssuireactdirection.useDirection(dir)
  ...
  return /*#__PURE__*/ $inrcs$react.createElement(
    ...
    /*#__PURE__*/ $inrcs$react.createElement(
      $1791bb30e2e418d5$var$SliderImpl,
      $parcel$interopDefault($inrcs$babelruntimehelpersextends)(
        {
          dir: direction,
        ...
        sliderProps,
        {
          ...
          style: {
            ...sliderProps.style,
            ["--dss-slider-thumb-transform"]: "translateX(-50%)",
          },
          onSlideStart: (event) => {
...
/* -------------------------------------------------------------------------------------------------
 * SliderVertical
 * -----------------------------------------------------------------------------------------------*/ const $1791bb30e2e418d5$var$SliderVertical =
  /*#__PURE__*/ $inrcs$react.forwardRef((props, forwardedRef) => {
    const {
      min: min,
      max: max,
      inverted: inverted,
    ...
    const ref = $inrcs$dssuireactcomposerefs.useComposedRefs(forwardedRef, sliderRef)
    const rectRef = $inrcs$react.useRef()
      ...
      /*#__PURE__*/ $inrcs$react.createElement(
        ...
        $parcel$interopDefault($inrcs$babelruntimehelpersextends)(
          ...
          sliderProps,
          {
            ...
            style: {
              ...sliderProps.style,
              ["--dss-slider-thumb-transform"]: "translateY(50%)",
            },
            onSlideStart: (event) => {
...
/* -------------------------------------------------------------------------------------------------
 * SliderImpl
 * -----------------------------------------------------------------------------------------------*/ const $1791bb30e2e418d5$var$SliderImpl =
  /*#__PURE__*/ $inrcs$react.forwardRef((props, forwardedRef) => {
    const {
    ...
    return /*#__PURE__*/ $inrcs$react.createElement(
      $inrcs$dssuireactprimitive.Primitive.span,
      $parcel$interopDefault($inrcs$babelruntimehelpersextends)({}, sliderProps, {
        ref: forwardedRef,
        onKeyDown: $inrcs$dssuiprimitive.composeEventHandlers(props.onKeyDown, (event) => {
          if (event.key === "Home") {
        ...
        onPointerDown: $inrcs$dssuiprimitive.composeEventHandlers(props.onPointerDown, (event) => {
        ...
        onPointerMove: $inrcs$dssuiprimitive.composeEventHandlers(props.onPointerMove, (event) => {
          const target = event.target
          if (target.hasPointerCapture(event.pointerId)) onSlideMove(event)
        }),
        onPointerUp: $inrcs$dssuiprimitive.composeEventHandlers(props.onPointerUp, (event) => {
          const target = event.target
...
/* -------------------------------------------------------------------------------------------------
 * SliderTrack
 * -----------------------------------------------------------------------------------------------*/ const $1791bb30e2e418d5$var$TRACK_NAME =
  "SliderTrack"
...
/* -------------------------------------------------------------------------------------------------
 * SliderRange
 * -----------------------------------------------------------------------------------------------*/ const $1791bb30e2e418d5$var$RANGE_NAME =
  "SliderRange"
const $1791bb30e2e418d5$export$a5cf38a7a000fe77 = /*#__PURE__*/ $inrcs$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $inrcs$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref)
  const valuesCount = context.values.length
  const percentages = context.values.map((value) =>
    $1791bb30e2e418d5$var$convertValueToPercentage(value, context.min, context.max)
  )
...
/* -------------------------------------------------------------------------------------------------
 * SliderThumb
 * -----------------------------------------------------------------------------------------------*/ const $1791bb30e2e418d5$var$THUMB_NAME =
  "SliderThumb"
const $1791bb30e2e418d5$export$2c1b491743890dec = /*#__PURE__*/ $inrcs$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $inrcs$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) => setThumb(node))
  const index = $inrcs$react.useMemo(
    () => (thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1),
    [getItems, thumb]
  )
  return /*#__PURE__*/ $inrcs$react.createElement(
    $1791bb30e2e418d5$var$SliderThumbImpl,
    $parcel$interopDefault($inrcs$babelruntimehelpersextends)({}, props, {
      ref: composedRefs,
      index: index,
    })
  )
...
const $1791bb30e2e418d5$var$SliderThumbImpl = /*#__PURE__*/ $inrcs$react.forwardRef((props, forwardedRef) => {
  ...
  const [thumb, setThumb] = $inrcs$react.useState(null)
  const composedRefs = $inrcs$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) => setThumb(node))
  const size = $inrcs$dssuireactusesize.useSize(thumb) // We cast because index could be `-1` which would return undefined
  const value = context.values[index]
  const percent =
    value === undefined ? 0 : $1791bb30e2e418d5$var$convertValueToPercentage(value, context.min, context.max)
  ...
  const thumbInBoundsOffset = orientationSize
    ? $1791bb30e2e418d5$var$getThumbInBoundsOffset(orientationSize, percent, orientation.direction)
    : 0
  ...
  return /*#__PURE__*/ $inrcs$react.createElement(
    ...
    {
      style: {
        transform: "var(--dss-slider-thumb-transform)",
        position: "absolute",
        [orientation.startEdge]: `calc(${percent}% + ${thumbInBoundsOffset}px)`,
      },
    },
    /*#__PURE__*/ $inrcs$react.createElement(
      $1791bb30e2e418d5$var$Collection.ItemSlot,
      {
        scope: props.__scopeSlider,
      },
      /*#__PURE__*/ $inrcs$react.createElement(
          ...
          thumbProps,
          {
            ...
            style:
              value === undefined
                ...
                : props.style,
            onFocus: $inrcs$dssuiprimitive.composeEventHandlers(props.onFocus, () => {
...
/* -----------------------------------------------------------------------------------------------*/ const $1791bb30e2e418d5$var$BubbleInput =
  (props) => {
    const { value: value, ...inputProps } = props
    const ref = $inrcs$react.useRef(null)
    const prevValue = $inrcs$dssuireactuseprevious.usePrevious(value) // Bubble value change to parents (e.g form change event)
    $inrcs$react.useEffect(() => {
...
function $1791bb30e2e418d5$var$convertValueToPercentage(value, min, max) {
  ...
  return $inrcs$dssuinumber.clamp(percentage, [0, 100])
}
/**
 ...
 */ function $1791bb30e2e418d5$var$getThumbInBoundsOffset(width, left, direction) {
  ...
  const offset = $1791bb30e2e418d5$var$linearScale([0, halfPercent], [0, halfWidth])
