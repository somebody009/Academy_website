...
var $8oLOM$dssuiprimitive = require("../../primitive")
var $8oLOM$dssuireactcontext = require("../../react-context")
var $8oLOM$dssuireactrovingfocus = require("../../react-roving-focus")
var $8oLOM$dssuireactpresence = require("../../react-presence")
var $8oLOM$dssuireactprimitive = require("../../react-primitive")
var $8oLOM$dssuireactdirection = require("../../react-direction")
var $8oLOM$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
var $8oLOM$dssuireactid = require("../../react-id")
...
/* -------------------------------------------------------------------------------------------------
 * Tabs
 * -----------------------------------------------------------------------------------------------*/ const $2bbff03427f8eaee$var$TABS_NAME =
  "Tabs"
const [$2bbff03427f8eaee$var$createTabsContext, $2bbff03427f8eaee$export$355f5bd209d7b13a] =
  $8oLOM$dssuireactcontext.createContextScope($2bbff03427f8eaee$var$TABS_NAME, [
    $8oLOM$dssuireactrovingfocus.createRovingFocusGroupScope,
  ])
const $2bbff03427f8eaee$var$useRovingFocusGroupScope = $8oLOM$dssuireactrovingfocus.createRovingFocusGroupScope()
const [$2bbff03427f8eaee$var$TabsProvider, $2bbff03427f8eaee$var$useTabsContext] =
  $2bbff03427f8eaee$var$createTabsContext($2bbff03427f8eaee$var$TABS_NAME)
const $2bbff03427f8eaee$export$b2539bed5023c21c = /*#__PURE__*/ $8oLOM$react.forwardRef((props, forwardedRef) => {
  ...
  const direction = $8oLOM$dssuireactdirection.useDirection(dir)
  const [value, setValue] = $8oLOM$dssuireactusecontrollablestate.useControllableState({
    prop: valueProp,
    onChange: onValueChange,
    defaultProp: defaultValue,
  })
  return /*#__PURE__*/ $8oLOM$react.createElement(
    $2bbff03427f8eaee$var$TabsProvider,
    {
      scope: __scopeTabs,
      baseId: $8oLOM$dssuireactid.useId(),
      value: value,
    ...
    /*#__PURE__*/ $8oLOM$react.createElement(
      $8oLOM$dssuireactprimitive.Primitive.div,
      $parcel$interopDefault($8oLOM$babelruntimehelpersextends)(
        {
          dir: direction,
...
/* -------------------------------------------------------------------------------------------------
 * TabsList
 * -----------------------------------------------------------------------------------------------*/ const $2bbff03427f8eaee$var$TAB_LIST_NAME =
  "TabsList"
const $2bbff03427f8eaee$export$9712d22edc0d78c1 = /*#__PURE__*/ $8oLOM$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $8oLOM$react.createElement(
    $8oLOM$dssuireactrovingfocus.Root,
    $parcel$interopDefault($8oLOM$babelruntimehelpersextends)(
      {
        asChild: true,
      },
...
/* -------------------------------------------------------------------------------------------------
 * TabsTrigger
 * -----------------------------------------------------------------------------------------------*/ const $2bbff03427f8eaee$var$TRIGGER_NAME =
  "TabsTrigger"
const $2bbff03427f8eaee$export$8114b9fdfdf9f3ba = /*#__PURE__*/ $8oLOM$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $8oLOM$react.createElement(
    $8oLOM$dssuireactrovingfocus.Item,
    $parcel$interopDefault($8oLOM$babelruntimehelpersextends)(
      {
        asChild: true,
      },
    ...
    /*#__PURE__*/ $8oLOM$react.createElement(
      $8oLOM$dssuireactprimitive.Primitive.button,
      $parcel$interopDefault($8oLOM$babelruntimehelpersextends)(
        {
          type: "button",
          role: "tab",
        ...
        {
          ref: forwardedRef,
          onMouseDown: $8oLOM$dssuiprimitive.composeEventHandlers(props.onMouseDown, (event) => {
          ...
          onKeyDown: $8oLOM$dssuiprimitive.composeEventHandlers(props.onKeyDown, (event) => {
            if ([" ", "Enter"].includes(event.key)) context.onValueChange(value)
          }),
          onFocus: $8oLOM$dssuiprimitive.composeEventHandlers(props.onFocus, () => {
...
/* -------------------------------------------------------------------------------------------------
 * TabsContent
 * -----------------------------------------------------------------------------------------------*/ const $2bbff03427f8eaee$var$CONTENT_NAME =
  "TabsContent"
const $2bbff03427f8eaee$export$bd905d70e8fd2ebb = /*#__PURE__*/ $8oLOM$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $8oLOM$react.createElement(
    $8oLOM$dssuireactpresence.Presence,
    {
...
/* ---------------------------------------------------------------------------------------------- */ function $2bbff03427f8eaee$var$makeTriggerId(
  baseId,
  value
) {
