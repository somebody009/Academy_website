...
var $9QJ9Y$dssuiprimitive = require("../../primitive")
var $9QJ9Y$dssuireactcollection = require("../../react-collection")
var $9QJ9Y$dssuireactcomposerefs = require("../../react-compose-refs")
var $9QJ9Y$dssuireactcontext = require("../../react-context")
var $9QJ9Y$dssuireactid = require("../../react-id")
var $9QJ9Y$dssuireactprimitive = require("../../react-primitive")
var $9QJ9Y$dssuireactusecallbackref = require("../../react-use-callback-ref")
var $9QJ9Y$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
var $9QJ9Y$dssuireactdirection = require("../../react-direction")
...
/* -------------------------------------------------------------------------------------------------
 * RovingFocusGroup
 * -----------------------------------------------------------------------------------------------*/ const $0063afae63b3fa70$var$GROUP_NAME =
  "RovingFocusGroup"
const [
  $0063afae63b3fa70$var$Collection,
  $0063afae63b3fa70$var$useCollection,
  $0063afae63b3fa70$var$createCollectionScope,
] = $9QJ9Y$dssuireactcollection.createCollection($0063afae63b3fa70$var$GROUP_NAME)
const [$0063afae63b3fa70$var$createRovingFocusGroupContext, $0063afae63b3fa70$export$c7109489551a4f4] =
  $9QJ9Y$dssuireactcontext.createContextScope($0063afae63b3fa70$var$GROUP_NAME, [
    $0063afae63b3fa70$var$createCollectionScope,
  ])
const [$0063afae63b3fa70$var$RovingFocusProvider, $0063afae63b3fa70$var$useRovingFocusContext] =
  $0063afae63b3fa70$var$createRovingFocusGroupContext($0063afae63b3fa70$var$GROUP_NAME)
const $0063afae63b3fa70$export$8699f7c8af148338 = /*#__PURE__*/ $9QJ9Y$react.forwardRef((props, forwardedRef) => {
  return /*#__PURE__*/ $9QJ9Y$react.createElement(
    $0063afae63b3fa70$var$Collection.Provider,
    {
      scope: props.__scopeRovingFocusGroup,
    },
    /*#__PURE__*/ $9QJ9Y$react.createElement(
      $0063afae63b3fa70$var$Collection.Slot,
      {
        scope: props.__scopeRovingFocusGroup,
      },
      /*#__PURE__*/ $9QJ9Y$react.createElement(
        $0063afae63b3fa70$var$RovingFocusGroupImpl,
        $parcel$interopDefault($9QJ9Y$babelruntimehelpersextends)({}, props, {
          ref: forwardedRef,
        })
      )
    )
...
/* -----------------------------------------------------------------------------------------------*/ const $0063afae63b3fa70$var$RovingFocusGroupImpl =
  /*#__PURE__*/ $9QJ9Y$react.forwardRef((props, forwardedRef) => {
    const {
    ...
    const composedRefs = $9QJ9Y$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref)
    const direction = $9QJ9Y$dssuireactdirection.useDirection(dir)
    const [currentTabStopId = null, setCurrentTabStopId] = $9QJ9Y$dssuireactusecontrollablestate.useControllableState({
      prop: currentTabStopIdProp,
      defaultProp: defaultCurrentTabStopId,
      onChange: onCurrentTabStopIdChange,
    })
    const [isTabbingBackOut, setIsTabbingBackOut] = $9QJ9Y$react.useState(false)
    const handleEntryFocus = $9QJ9Y$dssuireactusecallbackref.useCallbackRef(onEntryFocus)
    ...
    return /*#__PURE__*/ $9QJ9Y$react.createElement(
      $0063afae63b3fa70$var$RovingFocusProvider,
      {
      ...
      /*#__PURE__*/ $9QJ9Y$react.createElement(
        $9QJ9Y$dssuireactprimitive.Primitive.div,
        $parcel$interopDefault($9QJ9Y$babelruntimehelpersextends)(
          {
          ...
          groupProps,
          {
            ...
            onMouseDown: $9QJ9Y$dssuiprimitive.composeEventHandlers(props.onMouseDown, () => {
              isClickFocusRef.current = true
            }),
            onFocus: $9QJ9Y$dssuiprimitive.composeEventHandlers(props.onFocus, (event) => {
              ...
              if (event.target === event.currentTarget && isKeyboardFocus && !isTabbingBackOut) {
                const entryFocusEvent = new CustomEvent(
                  $0063afae63b3fa70$var$ENTRY_FOCUS,
                  $0063afae63b3fa70$var$EVENT_OPTIONS
                )
            ...
            onBlur: $9QJ9Y$dssuiprimitive.composeEventHandlers(props.onBlur, () => setIsTabbingBackOut(false)),
          }
        )
      )
    )
 ...
 * -----------------------------------------------------------------------------------------------*/ const $0063afae63b3fa70$var$ITEM_NAME =
  "RovingFocusGroupItem"
const $0063afae63b3fa70$export$ab9df7c53fe8454 = /*#__PURE__*/ $9QJ9Y$react.forwardRef((props, forwardedRef) => {
  ...
  const autoId = $9QJ9Y$dssuireactid.useId()
  ...
  return /*#__PURE__*/ $9QJ9Y$react.createElement(
    $0063afae63b3fa70$var$Collection.ItemSlot,
    {
      scope: __scopeRovingFocusGroup,
      id: id,
      focusable: focusable,
    ...
    /*#__PURE__*/ $9QJ9Y$react.createElement(
      $9QJ9Y$dssuireactprimitive.Primitive.span,
      $parcel$interopDefault($9QJ9Y$babelruntimehelpersextends)(
        {
        ...
        {
          ref: forwardedRef,
          onMouseDown: $9QJ9Y$dssuiprimitive.composeEventHandlers(props.onMouseDown, (event) => {
            // We prevent focusing non-focusable items on `mousedown`.
            // Even though the item has tabIndex={-1}, that only means take it out of the tab order.
            if (!focusable)
              event.preventDefault() // Safari doesn't focus a button when clicked so we run our logic on mousedown also
            else context.onItemFocus(id)
          }),
          onFocus: $9QJ9Y$dssuiprimitive.composeEventHandlers(props.onFocus, () => context.onItemFocus(id)),
          onKeyDown: $9QJ9Y$dssuiprimitive.composeEventHandlers(props.onKeyDown, (event) => {
            ...
            if (focusIntent !== undefined) {
              ...
              if (focusIntent === "last") candidateNodes.reverse()
                ...
                candidateNodes = context.loop
                  ? $0063afae63b3fa70$var$wrapArray(candidateNodes, currentIndex + 1)
