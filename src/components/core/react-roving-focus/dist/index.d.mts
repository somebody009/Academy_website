...
export const createRovingFocusGroupScope: import("../../react-context").CreateScope;
...
export const RovingFocusGroup: React.ForwardRefExoticComponent<
...
export const RovingFocusGroupItem: React.ForwardRefExoticComponent<
