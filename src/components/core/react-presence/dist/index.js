...
var $fnLeV$dssuireactcomposerefs = require("../../react-compose-refs")
var $fnLeV$dssuireactuselayouteffect = require("../../react-use-layout-effect")
...
const $a2fa0214bb2735a1$export$99c2b779aa4e8b8b = (props) => {
  ...
  const ref = $fnLeV$dssuireactcomposerefs.useComposedRefs(presence.ref, child.ref)
  const forceMount = typeof children === "function"
  return forceMount || presence.isPresent
    ? /*#__PURE__*/ $fnLeV$react.cloneElement(child, {
        ref: ref,
      })
    : null
}
 ...
 * -----------------------------------------------------------------------------------------------*/ function $a2fa0214bb2735a1$var$usePresence(
  ...
  $fnLeV$dssuireactuselayouteffect.useLayoutEffect(() => {
    ...
    if (hasPresentChanged) {
      ...
      if (present) send("MOUNT")
        ...
        (styles === null || styles === void 0 ? void 0 : styles.display) === "none"
      )
...
/* -----------------------------------------------------------------------------------------------*/ function $a2fa0214bb2735a1$var$getAnimationName(
  styles
) {
