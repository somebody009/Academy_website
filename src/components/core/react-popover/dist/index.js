...
var $aJPOC$dssuiprimitive = require("../../primitive")
var $aJPOC$dssuireactcomposerefs = require("../../react-compose-refs")
var $aJPOC$dssuireactcontext = require("../../react-context")
var $aJPOC$dssuireactdismissablelayer = require("../../react-dismissable-layer")
var $aJPOC$dssuireactfocusguards = require("../../react-focus-guards")
var $aJPOC$dssuireactfocusscope = require("../../react-focus-scope")
var $aJPOC$dssuireactid = require("../../react-id")
var $aJPOC$dssuireactpopper = require("../../react-popper")
var $aJPOC$dssuireactportal = require("../../react-portal")
var $aJPOC$dssuireactpresence = require("../../react-presence")
var $aJPOC$dssuireactprimitive = require("../../react-primitive")
var $aJPOC$dssuireactslot = require("../../react-slot")
var $aJPOC$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
...
/* -------------------------------------------------------------------------------------------------
 * Popover
 * -----------------------------------------------------------------------------------------------*/ const $7d632c09314cddaf$var$POPOVER_NAME =
  "Popover"
const [$7d632c09314cddaf$var$createPopoverContext, $7d632c09314cddaf$export$c8393c9e73286932] =
  $aJPOC$dssuireactcontext.createContextScope($7d632c09314cddaf$var$POPOVER_NAME, [
    $aJPOC$dssuireactpopper.createPopperScope,
  ])
const $7d632c09314cddaf$var$usePopperScope = $aJPOC$dssuireactpopper.createPopperScope()
const [$7d632c09314cddaf$var$PopoverProvider, $7d632c09314cddaf$var$usePopoverContext] =
  $7d632c09314cddaf$var$createPopoverContext($7d632c09314cddaf$var$POPOVER_NAME)
const $7d632c09314cddaf$export$5b6b19405a83ff9d = (props) => {
  ...
  const [open = false, setOpen] = $aJPOC$dssuireactusecontrollablestate.useControllableState({
    prop: openProp,
    defaultProp: defaultOpen,
    onChange: onOpenChange,
  })
  return /*#__PURE__*/ $aJPOC$react.createElement(
    $aJPOC$dssuireactpopper.Root,
    popperScope,
    /*#__PURE__*/ $aJPOC$react.createElement(
      $7d632c09314cddaf$var$PopoverProvider,
      {
        scope: __scopePopover,
        contentId: $aJPOC$dssuireactid.useId(),
        triggerRef: triggerRef,
        open: open,
        onOpenChange: setOpen,
        onOpenToggle: $aJPOC$react.useCallback(() => setOpen((prevOpen) => !prevOpen), [setOpen]),
...
/* -------------------------------------------------------------------------------------------------
 * PopoverAnchor
 * -----------------------------------------------------------------------------------------------*/ const $7d632c09314cddaf$var$ANCHOR_NAME =
  "PopoverAnchor"
const $7d632c09314cddaf$export$96e5381f42521a79 = /*#__PURE__*/ $aJPOC$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $aJPOC$react.createElement(
    $aJPOC$dssuireactpopper.Anchor,
    $parcel$interopDefault($aJPOC$babelruntimehelpersextends)({}, popperScope, anchorProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * PopoverTrigger
 * -----------------------------------------------------------------------------------------------*/ const $7d632c09314cddaf$var$TRIGGER_NAME =
  "PopoverTrigger"
const $7d632c09314cddaf$export$7dacb05d26466c3 = /*#__PURE__*/ $aJPOC$react.forwardRef((props, forwardedRef) => {
  ...
  const popperScope = $7d632c09314cddaf$var$usePopperScope(__scopePopover)
  const composedTriggerRef = $aJPOC$dssuireactcomposerefs.useComposedRefs(forwardedRef, context.triggerRef)
  const trigger = /*#__PURE__*/ $aJPOC$react.createElement(
    $aJPOC$dssuireactprimitive.Primitive.button,
    $parcel$interopDefault($aJPOC$babelruntimehelpersextends)(
      {
        type: "button",
      ...
      triggerProps,
      {
        ...
        onClick: $aJPOC$dssuiprimitive.composeEventHandlers(props.onClick, context.onOpenToggle),
      }
    )
  )
...
/* -------------------------------------------------------------------------------------------------
 * PopoverPortal
 * -----------------------------------------------------------------------------------------------*/ const $7d632c09314cddaf$var$PORTAL_NAME =
  "PopoverPortal"
const [$7d632c09314cddaf$var$PortalProvider, $7d632c09314cddaf$var$usePortalContext] =
  $7d632c09314cddaf$var$createPopoverContext($7d632c09314cddaf$var$PORTAL_NAME, {
...
const $7d632c09314cddaf$export$dd679ffb4362d2d4 = (props) => {
  ...
  return /*#__PURE__*/ $aJPOC$react.createElement(
    $7d632c09314cddaf$var$PortalProvider,
    {
      scope: __scopePopover,
      forceMount: forceMount,
    },
    /*#__PURE__*/ $aJPOC$react.createElement(
      $aJPOC$dssuireactpresence.Presence,
      {
        present: forceMount || context.open,
      },
      /*#__PURE__*/ $aJPOC$react.createElement(
        $aJPOC$dssuireactportal.Portal,
        {
          asChild: true,
          container: container,
        },
...
/* -------------------------------------------------------------------------------------------------
 * PopoverContent
 * -----------------------------------------------------------------------------------------------*/ const $7d632c09314cddaf$var$CONTENT_NAME =
  "PopoverContent"
const $7d632c09314cddaf$export$d7e1f420b25549ff = /*#__PURE__*/ $aJPOC$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $aJPOC$react.createElement(
    ...
    context.modal
      ? /*#__PURE__*/ $aJPOC$react.createElement(
          $7d632c09314cddaf$var$PopoverContentModal,
          $parcel$interopDefault($aJPOC$babelruntimehelpersextends)({}, contentProps, {
            ref: forwardedRef,
          })
        )
      : /*#__PURE__*/ $aJPOC$react.createElement(
          $7d632c09314cddaf$var$PopoverContentNonModal,
          $parcel$interopDefault($aJPOC$babelruntimehelpersextends)({}, contentProps, {
            ref: forwardedRef,
          })
        )
...
/* -----------------------------------------------------------------------------------------------*/ const $7d632c09314cddaf$var$PopoverContentModal =
  /*#__PURE__*/ $aJPOC$react.forwardRef((props, forwardedRef) => {
    const context = $7d632c09314cddaf$var$usePopoverContext($7d632c09314cddaf$var$CONTENT_NAME, props.__scopePopover)
    const contentRef = $aJPOC$react.useRef(null)
    const composedRefs = $aJPOC$dssuireactcomposerefs.useComposedRefs(forwardedRef, contentRef)
    ...
    return /*#__PURE__*/ $aJPOC$react.createElement(
      $aJPOC$reactremovescroll.RemoveScroll,
      {
        as: $aJPOC$dssuireactslot.Slot,
        allowPinchZoom: true,
      },
      /*#__PURE__*/ $aJPOC$react.createElement(
        $7d632c09314cddaf$var$PopoverContentImpl,
        $parcel$interopDefault($aJPOC$babelruntimehelpersextends)({}, props, {
          ref: composedRefs, // we make sure we're not trapping once it's been closed
          trapFocus: context.open,
          disableOutsidePointerEvents: true,
          onCloseAutoFocus: $aJPOC$dssuiprimitive.composeEventHandlers(props.onCloseAutoFocus, (event) => {
          ...
          onPointerDownOutside: $aJPOC$dssuiprimitive.composeEventHandlers(
          ...
          onFocusOutside: $aJPOC$dssuiprimitive.composeEventHandlers(
...
/* -----------------------------------------------------------------------------------------------*/ const $7d632c09314cddaf$var$PopoverContentImpl =
  /*#__PURE__*/ $aJPOC$react.forwardRef((props, forwardedRef) => {
    const {
      __scopePopover: __scopePopover,
      trapFocus: trapFocus,
    ...
    $aJPOC$dssuireactfocusguards.useFocusGuards()
    return /*#__PURE__*/ $aJPOC$react.createElement(
      $aJPOC$dssuireactfocusscope.FocusScope,
      {
        asChild: true,
        loop: true,
        trapped: trapFocus,
      ...
      /*#__PURE__*/ $aJPOC$react.createElement(
        $aJPOC$dssuireactdismissablelayer.DismissableLayer,
        {
          asChild: true,
          disableOutsidePointerEvents: disableOutsidePointerEvents,
          onInteractOutside: onInteractOutside,
        ...
        /*#__PURE__*/ $aJPOC$react.createElement(
          $aJPOC$dssuireactpopper.Content,
          $parcel$interopDefault($aJPOC$babelruntimehelpersextends)(
            {
              "data-state": $7d632c09314cddaf$var$getState(context.open),
              role: "dialog",
            ...
            contentProps,
            {
              ...
              style: {
                ...contentProps.style,
                "--dss-popover-content-transform-origin": "var(--dss-popper-transform-origin)",
                "--dss-popover-content-available-width": "var(--dss-popper-available-width)",
                "--dss-popover-content-available-height": "var(--dss-popper-available-height)",
                "--dss-popover-trigger-width": "var(--dss-popper-anchor-width)",
                "--dss-popover-trigger-height": "var(--dss-popper-anchor-height)",
              },
            }
          )
        )
...
/* -------------------------------------------------------------------------------------------------
 * PopoverClose
 * -----------------------------------------------------------------------------------------------*/ const $7d632c09314cddaf$var$CLOSE_NAME =
  "PopoverClose"
const $7d632c09314cddaf$export$d6ac43ebaa40d53e = /*#__PURE__*/ $aJPOC$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $aJPOC$react.createElement(
    ...
    $parcel$interopDefault($aJPOC$babelruntimehelpersextends)(
      ...
      {
        ref: forwardedRef,
        onClick: $aJPOC$dssuiprimitive.composeEventHandlers(props.onClick, () => context.onOpenChange(false)),
      }
    )
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * PopoverArrow
 * -----------------------------------------------------------------------------------------------*/ const $7d632c09314cddaf$var$ARROW_NAME =
  "PopoverArrow"
const $7d632c09314cddaf$export$3152841115e061b2 = /*#__PURE__*/ $aJPOC$react.forwardRef((props, forwardedRef) => {
  ...
  const popperScope = $7d632c09314cddaf$var$usePopperScope(__scopePopover)
  return /*#__PURE__*/ $aJPOC$react.createElement(
    $aJPOC$dssuireactpopper.Arrow,
    $parcel$interopDefault($aJPOC$babelruntimehelpersextends)({}, popperScope, arrowProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -----------------------------------------------------------------------------------------------*/ function $7d632c09314cddaf$var$getState(
  open
) {
