...
import {
  useRef as $am6gm$useRef,
  useState as $am6gm$useState,
  createElement as $am6gm$createElement,
  useCallback as $am6gm$useCallback,
  forwardRef as $am6gm$forwardRef,
  useEffect as $am6gm$useEffect,
} from "react";
import { composeEventHandlers as $am6gm$composeEventHandlers } from "../../primitive";
import { useComposedRefs as $am6gm$useComposedRefs } from "../../react-compose-refs";
import { createContextScope as $am6gm$createContextScope } from "../../react-context";
import { DismissableLayer as $am6gm$DismissableLayer } from "../../react-dismissable-layer";
import { useFocusGuards as $am6gm$useFocusGuards } from "../../react-focus-guards";
import { FocusScope as $am6gm$FocusScope } from "../../react-focus-scope";
import { useId as $am6gm$useId } from "../../react-id";
import {
  createPopperScope as $am6gm$createPopperScope,
  Root as $am6gm$Root,
  Anchor as $am6gm$Anchor,
  Content as $am6gm$Content,
  Arrow as $am6gm$Arrow,
} from "../../react-popper";
import { Portal as $am6gm$Portal } from "../../react-portal";
import { Presence as $am6gm$Presence } from "../../react-presence";
import { Primitive as $am6gm$Primitive } from "../../react-primitive";
import { Slot as $am6gm$Slot } from "../../react-slot";
import { useControllableState as $am6gm$useControllableState } from "../../react-use-controllable-state";
import { hideOthers as $am6gm$hideOthers } from "aria-hidden";
import { RemoveScroll as $am6gm$RemoveScroll } from "react-remove-scroll";

/* -------------------------------------------------------------------------------------------------
 * Popover
 * -----------------------------------------------------------------------------------------------*/ const $cb5cc270b50c6fcd$var$POPOVER_NAME =
  "Popover";
const [
  $cb5cc270b50c6fcd$var$createPopoverContext,
  $cb5cc270b50c6fcd$export$c8393c9e73286932,
] = $am6gm$createContextScope($cb5cc270b50c6fcd$var$POPOVER_NAME, [
...
const [
  ...
  $cb5cc270b50c6fcd$var$POPOVER_NAME
);
const $cb5cc270b50c6fcd$export$5b6b19405a83ff9d = (props) => {
  ...
  return /*#__PURE__*/ $am6gm$createElement(
    $am6gm$Root,
    popperScope,
    /*#__PURE__*/ $am6gm$createElement(
      $cb5cc270b50c6fcd$var$PopoverProvider,
      {
        ...
        onOpenToggle: $am6gm$useCallback(
          () => setOpen((prevOpen) => !prevOpen),
          [setOpen]
        ),
        hasCustomAnchor: hasCustomAnchor,
        onCustomAnchorAdd: $am6gm$useCallback(
          () => setHasCustomAnchor(true),
          []
        ),
        onCustomAnchorRemove: $am6gm$useCallback(
...
/* -------------------------------------------------------------------------------------------------
 * PopoverAnchor
 * -----------------------------------------------------------------------------------------------*/ const $cb5cc270b50c6fcd$var$ANCHOR_NAME =
  "PopoverAnchor";
const $cb5cc270b50c6fcd$export$96e5381f42521a79 =
  /*#__PURE__*/ $am6gm$forwardRef((props, forwardedRef) => {
    const { __scopePopover: __scopePopover, ...anchorProps } = props;
    const context = $cb5cc270b50c6fcd$var$usePopoverContext(
      $cb5cc270b50c6fcd$var$ANCHOR_NAME,
      __scopePopover
    );
    const popperScope = $cb5cc270b50c6fcd$var$usePopperScope(__scopePopover);
    const {
    ...
    return /*#__PURE__*/ $am6gm$createElement(
      $am6gm$Anchor,
      $am6gm$babelruntimehelpersesmextends({}, popperScope, anchorProps, {
        ref: forwardedRef,
      })
    );
  });
...
/* -------------------------------------------------------------------------------------------------
 * PopoverTrigger
 * -----------------------------------------------------------------------------------------------*/ const $cb5cc270b50c6fcd$var$TRIGGER_NAME =
  "PopoverTrigger";
const $cb5cc270b50c6fcd$export$7dacb05d26466c3 =
  /*#__PURE__*/ $am6gm$forwardRef((props, forwardedRef) => {
    ...
    const popperScope = $cb5cc270b50c6fcd$var$usePopperScope(__scopePopover);
    const composedTriggerRef = $am6gm$useComposedRefs(
      forwardedRef,
      context.triggerRef
    );
    const trigger = /*#__PURE__*/ $am6gm$createElement(
      $am6gm$Primitive.button,
      $am6gm$babelruntimehelpersesmextends(
        {
          type: "button",
        ...
        triggerProps,
        {
          ...
          onClick: $am6gm$composeEventHandlers(
            props.onClick,
...
/* -------------------------------------------------------------------------------------------------
 * PopoverPortal
 * -----------------------------------------------------------------------------------------------*/ const $cb5cc270b50c6fcd$var$PORTAL_NAME =
  "PopoverPortal";
const [
...
/* -------------------------------------------------------------------------------------------------
 * PopoverContent
 * -----------------------------------------------------------------------------------------------*/ const $cb5cc270b50c6fcd$var$CONTENT_NAME =
  "PopoverContent";
const $cb5cc270b50c6fcd$export$d7e1f420b25549ff =
  /*#__PURE__*/ $am6gm$forwardRef((props, forwardedRef) => {
    ...
    return /*#__PURE__*/ $am6gm$createElement(
      ...
      context.modal
        ? /*#__PURE__*/ $am6gm$createElement(
            ...
            $am6gm$babelruntimehelpersesmextends({}, contentProps, {
              ref: forwardedRef,
            })
          )
        : /*#__PURE__*/ $am6gm$createElement(
...
/* -----------------------------------------------------------------------------------------------*/ const $cb5cc270b50c6fcd$var$PopoverContentModal =
  /*#__PURE__*/ $am6gm$forwardRef((props, forwardedRef) => {
    const context = $cb5cc270b50c6fcd$var$usePopoverContext(
      $cb5cc270b50c6fcd$var$CONTENT_NAME,
      props.__scopePopover
    ...
    return /*#__PURE__*/ $am6gm$createElement(
      ...
      /*#__PURE__*/ $am6gm$createElement(
        ...
        $am6gm$babelruntimehelpersesmextends({}, props, {
          ref: composedRefs, // we make sure we're not trapping once it's been closed
          trapFocus: context.open,
          disableOutsidePointerEvents: true,
          onCloseAutoFocus: $am6gm$composeEventHandlers(
          ...
          onPointerDownOutside: $am6gm$composeEventHandlers(
          ...
          onFocusOutside: $am6gm$composeEventHandlers(
...
const $cb5cc270b50c6fcd$var$PopoverContentNonModal =
  /*#__PURE__*/ $am6gm$forwardRef((props, forwardedRef) => {
    const context = $cb5cc270b50c6fcd$var$usePopoverContext(
      $cb5cc270b50c6fcd$var$CONTENT_NAME,
      props.__scopePopover
...
/* -----------------------------------------------------------------------------------------------*/ const $cb5cc270b50c6fcd$var$PopoverContentImpl =
  /*#__PURE__*/ $am6gm$forwardRef((props, forwardedRef) => {
    const {
      __scopePopover: __scopePopover,
      trapFocus: trapFocus,
...
/* -------------------------------------------------------------------------------------------------
 * PopoverClose
 * -----------------------------------------------------------------------------------------------*/ const $cb5cc270b50c6fcd$var$CLOSE_NAME =
  "PopoverClose";
const $cb5cc270b50c6fcd$export$d6ac43ebaa40d53e =
  /*#__PURE__*/ $am6gm$forwardRef((props, forwardedRef) => {
    const { __scopePopover: __scopePopover, ...closeProps } = props;
    const context = $cb5cc270b50c6fcd$var$usePopoverContext(
      $cb5cc270b50c6fcd$var$CLOSE_NAME,
      __scopePopover
    );
    return /*#__PURE__*/ $am6gm$createElement(
      $am6gm$Primitive.button,
      $am6gm$babelruntimehelpersesmextends(
        ...
        {
          ref: forwardedRef,
          onClick: $am6gm$composeEventHandlers(props.onClick, () =>
...
/* -------------------------------------------------------------------------------------------------
 * PopoverArrow
 * -----------------------------------------------------------------------------------------------*/ const $cb5cc270b50c6fcd$var$ARROW_NAME =
  "PopoverArrow";
const $cb5cc270b50c6fcd$export$3152841115e061b2 =
  /*#__PURE__*/ $am6gm$forwardRef((props, forwardedRef) => {
    const { __scopePopover: __scopePopover, ...arrowProps } = props;
    const popperScope = $cb5cc270b50c6fcd$var$usePopperScope(__scopePopover);
    return /*#__PURE__*/ $am6gm$createElement(
      $am6gm$Arrow,
      $am6gm$babelruntimehelpersesmextends({}, popperScope, arrowProps, {
        ref: forwardedRef,
      })
    );
  });
...
/* -----------------------------------------------------------------------------------------------*/ function $cb5cc270b50c6fcd$var$getState(
  open
) {
...
const $cb5cc270b50c6fcd$export$b688253958b8dfe7 =
  $cb5cc270b50c6fcd$export$96e5381f42521a79;
const $cb5cc270b50c6fcd$export$41fb9f06171c75f4 =
  $cb5cc270b50c6fcd$export$7dacb05d26466c3;
const $cb5cc270b50c6fcd$export$602eac185826482c =
  $cb5cc270b50c6fcd$export$dd679ffb4362d2d4;
const $cb5cc270b50c6fcd$export$7c6e2c02157bb7d2 =
  $cb5cc270b50c6fcd$export$d7e1f420b25549ff;
const $cb5cc270b50c6fcd$export$f39c2d165cd861fe =
  $cb5cc270b50c6fcd$export$d6ac43ebaa40d53e;
const $cb5cc270b50c6fcd$export$21b07c8f274aebd5 =
