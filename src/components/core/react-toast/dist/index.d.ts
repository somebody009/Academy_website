...
export const createToastScope: import("../../react-context").CreateScope
...
type PrimitiveOrderedListProps = dss.ComponentPropsWithoutRef<typeof Primitive.ol>
...
type DismissableLayerProps = dss.ComponentPropsWithoutRef<typeof DismissableLayer.Root>
