...
var $iTyic$dssuiprimitive = require("../../primitive")
var $iTyic$dssuireactcomposerefs = require("../../react-compose-refs")
var $iTyic$dssuireactcollection = require("../../react-collection")
var $iTyic$dssuireactcontext = require("../../react-context")
var $iTyic$dssuireactdismissablelayer = require("../../react-dismissable-layer")
var $iTyic$dssuireactportal = require("../../react-portal")
var $iTyic$dssuireactpresence = require("../../react-presence")
var $iTyic$dssuireactprimitive = require("../../react-primitive")
var $iTyic$dssuireactusecallbackref = require("../../react-use-callback-ref")
var $iTyic$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
var $iTyic$dssuireactuselayouteffect = require("../../react-use-layout-effect")
var $iTyic$dssuireactvisuallyhidden = require("../../react-visually-hidden")
...
/* -------------------------------------------------------------------------------------------------
 * ToastProvider
 * -----------------------------------------------------------------------------------------------*/ const $9208a85b3e79d33f$var$PROVIDER_NAME =
  "ToastProvider"
const [
  $9208a85b3e79d33f$var$Collection,
  $9208a85b3e79d33f$var$useCollection,
  $9208a85b3e79d33f$var$createCollectionScope,
] = $iTyic$dssuireactcollection.createCollection("Toast")
const [$9208a85b3e79d33f$var$createToastContext, $9208a85b3e79d33f$export$8a359da18fbc9073] =
  $iTyic$dssuireactcontext.createContextScope("Toast", [$9208a85b3e79d33f$var$createCollectionScope])
const [$9208a85b3e79d33f$var$ToastProviderProvider, $9208a85b3e79d33f$var$useToastProviderContext] =
  $9208a85b3e79d33f$var$createToastContext($9208a85b3e79d33f$var$PROVIDER_NAME)
const $9208a85b3e79d33f$export$f5d03d415824e0e = (props) => {
  const {
    ...
    swipeThreshold: swipeThreshold = 50,
    children: children,
  } = props
  ...
  return /*#__PURE__*/ $iTyic$react.createElement(
    $9208a85b3e79d33f$var$Collection.Provider,
    {
      scope: __scopeToast,
    },
    /*#__PURE__*/ $iTyic$react.createElement(
      $9208a85b3e79d33f$var$ToastProviderProvider,
      {
        scope: __scopeToast,
        label: label,
        duration: duration,
...
/* -------------------------------------------------------------------------------------------------
 * ToastViewport
 * -----------------------------------------------------------------------------------------------*/ const $9208a85b3e79d33f$var$VIEWPORT_NAME =
  "ToastViewport"
const $9208a85b3e79d33f$var$VIEWPORT_DEFAULT_HOTKEY = ["F8"]
...
const $9208a85b3e79d33f$export$6192c2425ecfd989 = /*#__PURE__*/ $iTyic$react.forwardRef((props, forwardedRef) => {
  const {
    __scopeToast: __scopeToast,
    hotkey: hotkey = $9208a85b3e79d33f$var$VIEWPORT_DEFAULT_HOTKEY,
    label: label = "Notifications ({hotkey})",
    ...viewportProps
  } = props
  ...
  const composedRefs = $iTyic$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref, context.onViewportChange)
  ...
  const getSortedTabbableCandidates = $iTyic$react.useCallback(
    ({ tabbingDirection: tabbingDirection }) => {
      const toastItems = getItems()
      const tabbableCandidates = toastItems.map((toastItem) => {
        const toastNode = toastItem.ref.current
        const toastTabbableCandidates = [toastNode, ...$9208a85b3e79d33f$var$getTabbableCandidates(toastNode)]
  ...
  return /*#__PURE__*/ $iTyic$react.createElement(
    $iTyic$dssuireactdismissablelayer.Branch,
    {
      ref: wrapperRef,
      role: "region",
    ...
    hasToasts &&
      /*#__PURE__*/ $iTyic$react.createElement($9208a85b3e79d33f$var$FocusProxy, {
    ...
    /*#__PURE__*/ $iTyic$react.createElement(
      $9208a85b3e79d33f$var$Collection.Slot,
      {
        scope: __scopeToast,
      },
      /*#__PURE__*/ $iTyic$react.createElement(
        $iTyic$dssuireactprimitive.Primitive.ol,
        $parcel$interopDefault($iTyic$babelruntimehelpersextends)(
          {
            tabIndex: -1,
          },
          viewportProps,
...
/* -----------------------------------------------------------------------------------------------*/ const $9208a85b3e79d33f$var$FOCUS_PROXY_NAME =
  "ToastFocusProxy"
const $9208a85b3e79d33f$var$FocusProxy = /*#__PURE__*/ $iTyic$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $iTyic$react.createElement(
    $iTyic$dssuireactvisuallyhidden.VisuallyHidden,
    $parcel$interopDefault($iTyic$babelruntimehelpersextends)(
      {
        "aria-hidden": true,
        tabIndex: 0,
...
/* -------------------------------------------------------------------------------------------------
 * Toast
 * -----------------------------------------------------------------------------------------------*/ const $9208a85b3e79d33f$var$TOAST_NAME =
  "Toast"
...
const $9208a85b3e79d33f$export$8d8dc7d5f743331b = /*#__PURE__*/ $iTyic$react.forwardRef((props, forwardedRef) => {
  ...
  const [open = true, setOpen] = $iTyic$dssuireactusecontrollablestate.useControllableState({
    prop: openProp,
    defaultProp: defaultOpen,
    onChange: onOpenChange,
  })
  return /*#__PURE__*/ $iTyic$react.createElement(
    $iTyic$dssuireactpresence.Presence,
    {
      present: forceMount || open,
    },
    /*#__PURE__*/ $iTyic$react.createElement(
      $9208a85b3e79d33f$var$ToastImpl,
      $parcel$interopDefault($iTyic$babelruntimehelpersextends)(
        {
          open: open,
        },
        toastProps,
        {
          ...
          onPause: $iTyic$dssuireactusecallbackref.useCallbackRef(props.onPause),
          onResume: $iTyic$dssuireactusecallbackref.useCallbackRef(props.onResume),
          onSwipeStart: $iTyic$dssuiprimitive.composeEventHandlers(props.onSwipeStart, (event) => {
            event.currentTarget.setAttribute("data-swipe", "start")
          }),
          onSwipeMove: $iTyic$dssuiprimitive.composeEventHandlers(props.onSwipeMove, (event) => {
            const { x: x, y: y } = event.detail.delta
            event.currentTarget.setAttribute("data-swipe", "move")
            event.currentTarget.style.setProperty("--dss-toast-swipe-move-x", `${x}px`)
            event.currentTarget.style.setProperty("--dss-toast-swipe-move-y", `${y}px`)
          }),
          onSwipeCancel: $iTyic$dssuiprimitive.composeEventHandlers(props.onSwipeCancel, (event) => {
            event.currentTarget.setAttribute("data-swipe", "cancel")
            event.currentTarget.style.removeProperty("--dss-toast-swipe-move-x")
            event.currentTarget.style.removeProperty("--dss-toast-swipe-move-y")
            event.currentTarget.style.removeProperty("--dss-toast-swipe-end-x")
            event.currentTarget.style.removeProperty("--dss-toast-swipe-end-y")
          }),
          onSwipeEnd: $iTyic$dssuiprimitive.composeEventHandlers(props.onSwipeEnd, (event) => {
            const { x: x, y: y } = event.detail.delta
            event.currentTarget.setAttribute("data-swipe", "end")
            event.currentTarget.style.removeProperty("--dss-toast-swipe-move-x")
            event.currentTarget.style.removeProperty("--dss-toast-swipe-move-y")
            event.currentTarget.style.setProperty("--dss-toast-swipe-end-x", `${x}px`)
            event.currentTarget.style.setProperty("--dss-toast-swipe-end-y", `${y}px`)
            setOpen(false)
          }),
        }
      )
...
/* -----------------------------------------------------------------------------------------------*/ const [
  $9208a85b3e79d33f$var$ToastInteractiveProvider,
  $9208a85b3e79d33f$var$useToastInteractiveContext,
] = $9208a85b3e79d33f$var$createToastContext($9208a85b3e79d33f$var$TOAST_NAME, {
  onClose() {},
})
const $9208a85b3e79d33f$var$ToastImpl = /*#__PURE__*/ $iTyic$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $iTyic$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) => setNode(node))
  ...
  const handleClose = $iTyic$dssuireactusecallbackref.useCallbackRef(() => {
  ...
  const startTimer = $iTyic$react.useCallback(
    (duration) => {
  ...
  }, [context.viewport, duration1, onPause, onResume, startTimer]) // start timer when toast opens or duration changes.
  ...
  return /*#__PURE__*/ $iTyic$react.createElement(
    $iTyic$react.Fragment,
    null,
    announceTextContent &&
      /*#__PURE__*/ $iTyic$react.createElement(
        $9208a85b3e79d33f$var$ToastAnnounce,
        {
    ...
    /*#__PURE__*/ $iTyic$react.createElement(
      ...
      /*#__PURE__*/ $iTyic$reactdom.createPortal(
        /*#__PURE__*/ $iTyic$react.createElement(
          $9208a85b3e79d33f$var$Collection.ItemSlot,
          {
            scope: __scopeToast,
          },
          /*#__PURE__*/ $iTyic$react.createElement(
            $iTyic$dssuireactdismissablelayer.Root,
            {
              asChild: true,
              onEscapeKeyDown: $iTyic$dssuiprimitive.composeEventHandlers(onEscapeKeyDown, () => {
                if (!context.isFocusedToastEscapeKeyDownRef.current) handleClose()
                context.isFocusedToastEscapeKeyDownRef.current = false
              }),
            },
            /*#__PURE__*/ $iTyic$react.createElement(
              $iTyic$dssuireactprimitive.Primitive.li,
              $parcel$interopDefault($iTyic$babelruntimehelpersextends)(
                {
                ...
                toastProps,
                {
                  ...
                  onKeyDown: $iTyic$dssuiprimitive.composeEventHandlers(props.onKeyDown, (event) => {
                  ...
                  onPointerDown: $iTyic$dssuiprimitive.composeEventHandlers(props.onPointerDown, (event) => {
                  ...
                  onPointerMove: $iTyic$dssuiprimitive.composeEventHandlers(props.onPointerMove, (event) => {
                    ...
                    if (hasSwipeMoveStarted) {
                      ...
                      $9208a85b3e79d33f$var$handleAndDispatchCustomEvent(
                        $9208a85b3e79d33f$var$TOAST_SWIPE_MOVE,
                        onSwipeMove,
                        eventDetail,
                        {
                          discrete: false,
                      ...
                      $9208a85b3e79d33f$var$isDeltaInDirection(delta, context.swipeDirection, moveStartBuffer)
                    ) {
                      swipeDeltaRef.current = delta
                      $9208a85b3e79d33f$var$handleAndDispatchCustomEvent(
                        $9208a85b3e79d33f$var$TOAST_SWIPE_START,
                        onSwipeStart,
                        eventDetail,
                        {
                          discrete: false,
                  ...
                  onPointerUp: $iTyic$dssuiprimitive.composeEventHandlers(props.onPointerUp, (event1) => {
                    ...
                    if (delta) {
                      ...
                      if (
                        $9208a85b3e79d33f$var$isDeltaInDirection(delta, context.swipeDirection, context.swipeThreshold)
                      )
                        $9208a85b3e79d33f$var$handleAndDispatchCustomEvent(
                          $9208a85b3e79d33f$var$TOAST_SWIPE_END,
                          onSwipeEnd,
                          eventDetail,
                          {
                            discrete: true,
                        ...
                        $9208a85b3e79d33f$var$handleAndDispatchCustomEvent(
                          $9208a85b3e79d33f$var$TOAST_SWIPE_CANCEL,
                          onSwipeCancel,
                          eventDetail,
                          {
                            discrete: true,
...
/* -----------------------------------------------------------------------------------------------*/ const $9208a85b3e79d33f$var$ToastAnnounce =
  (props) => {
    ...
    $9208a85b3e79d33f$var$useNextFrame(() => setRenderAnnounceText(true)) // cleanup after announcing
    $iTyic$react.useEffect(() => {
    ...
    return isAnnounced
      ...
      : /*#__PURE__*/ $iTyic$react.createElement(
          ...
          /*#__PURE__*/ $iTyic$react.createElement(
            ...
            announceProps,
            renderAnnounceText &&
              /*#__PURE__*/ $iTyic$react.createElement($iTyic$react.Fragment, null, context.label, " ", children)
          )
        )
  }
/* -------------------------------------------------------------------------------------------------
 * ToastTitle
 * -----------------------------------------------------------------------------------------------*/ const $9208a85b3e79d33f$var$TITLE_NAME =
  "ToastTitle"
const $9208a85b3e79d33f$export$16d42d7c29b95a4 = /*#__PURE__*/ $iTyic$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $iTyic$react.createElement(
    $iTyic$dssuireactprimitive.Primitive.div,
    $parcel$interopDefault($iTyic$babelruntimehelpersextends)({}, titleProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * ToastDescription
 * -----------------------------------------------------------------------------------------------*/ const $9208a85b3e79d33f$var$DESCRIPTION_NAME =
  "ToastDescription"
const $9208a85b3e79d33f$export$ecddd96c53621d9a = /*#__PURE__*/ $iTyic$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $iTyic$react.createElement(
    $iTyic$dssuireactprimitive.Primitive.div,
    $parcel$interopDefault($iTyic$babelruntimehelpersextends)({}, descriptionProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * ToastAction
 * -----------------------------------------------------------------------------------------------*/ const $9208a85b3e79d33f$var$ACTION_NAME =
  "ToastAction"
const $9208a85b3e79d33f$export$3019feecfda683d2 = /*#__PURE__*/ $iTyic$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $iTyic$react.createElement(
    $9208a85b3e79d33f$var$ToastAnnounceExclude,
    {
      altText: altText,
      asChild: true,
    },
    /*#__PURE__*/ $iTyic$react.createElement(
      $9208a85b3e79d33f$export$811e70f61c205839,
      $parcel$interopDefault($iTyic$babelruntimehelpersextends)({}, actionProps, {
        ref: forwardedRef,
      })
    )
  )
...
$9208a85b3e79d33f$export$3019feecfda683d2.propTypes = {
  altText(props) {
    if (!props.altText)
      return new Error(`Missing prop \`altText\` expected on \`${$9208a85b3e79d33f$var$ACTION_NAME}\``)
    return null
  },
}
...
/* -------------------------------------------------------------------------------------------------
 * ToastClose
 * -----------------------------------------------------------------------------------------------*/ const $9208a85b3e79d33f$var$CLOSE_NAME =
  "ToastClose"
const $9208a85b3e79d33f$export$811e70f61c205839 = /*#__PURE__*/ $iTyic$react.forwardRef((props, forwardedRef) => {
  ...
  const interactiveContext = $9208a85b3e79d33f$var$useToastInteractiveContext(
    $9208a85b3e79d33f$var$CLOSE_NAME,
    __scopeToast
  )
  return /*#__PURE__*/ $iTyic$react.createElement(
    $9208a85b3e79d33f$var$ToastAnnounceExclude,
    ...
    /*#__PURE__*/ $iTyic$react.createElement(
      $iTyic$dssuireactprimitive.Primitive.button,
      $parcel$interopDefault($iTyic$babelruntimehelpersextends)(
        {
          type: "button",
        },
        ...
        {
          ref: forwardedRef,
          onClick: $iTyic$dssuiprimitive.composeEventHandlers(props.onClick, interactiveContext.onClose),
        }
      )
    )
  )
...
/* ---------------------------------------------------------------------------------------------- */ const $9208a85b3e79d33f$var$ToastAnnounceExclude =
  /*#__PURE__*/ $iTyic$react.forwardRef((props, forwardedRef) => {
    const { __scopeToast: __scopeToast, altText: altText, ...announceExcludeProps } = props
    return /*#__PURE__*/ $iTyic$react.createElement(
      $iTyic$dssuireactprimitive.Primitive.div,
      $parcel$interopDefault($iTyic$babelruntimehelpersextends)(
        {
          "data-dss-toast-announce-exclude": "",
          "data-dss-toast-announce-alt": altText || undefined,
        },
...
function $9208a85b3e79d33f$var$getAnnounceTextContent(container) {
  ...
  childNodes.forEach((node) => {
    ...
    if ($9208a85b3e79d33f$var$isHTMLElement(node)) {
      ...
      const isExcluded = node.dataset.dssToastAnnounceExclude === ""
      if (!isHidden) {
        if (isExcluded) {
          const altText = node.dataset.dssToastAnnounceAlt
...
/* ---------------------------------------------------------------------------------------------- */ function $9208a85b3e79d33f$var$handleAndDispatchCustomEvent(
  name,
  handler,
  detail,
  { discrete: discrete }
  ...
  if (discrete) $iTyic$dssuireactprimitive.dispatchDiscreteCustomEvent(currentTarget, event)
...
function $9208a85b3e79d33f$var$useNextFrame(callback = () => {}) {
  const fn = $iTyic$dssuireactusecallbackref.useCallbackRef(callback)
  $iTyic$dssuireactuselayouteffect.useLayoutEffect(() => {
    let raf1 = 0
    let raf2 = 0
