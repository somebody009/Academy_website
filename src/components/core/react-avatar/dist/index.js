...
var $6FDFN$dssuireactcontext = require("../../react-context")
var $6FDFN$dssuireactusecallbackref = require("../../react-use-callback-ref")
var $6FDFN$dssuireactuselayouteffect = require("../../react-use-layout-effect")
var $6FDFN$dssuireactprimitive = require("../../react-primitive")
...
/* -------------------------------------------------------------------------------------------------
 * Avatar
 * -----------------------------------------------------------------------------------------------*/ const $94437fed6c1d6d8a$var$AVATAR_NAME =
  "Avatar"
const [$94437fed6c1d6d8a$var$createAvatarContext, $94437fed6c1d6d8a$export$90370d16b488820f] =
  $6FDFN$dssuireactcontext.createContextScope($94437fed6c1d6d8a$var$AVATAR_NAME)
const [$94437fed6c1d6d8a$var$AvatarProvider, $94437fed6c1d6d8a$var$useAvatarContext] =
  $94437fed6c1d6d8a$var$createAvatarContext($94437fed6c1d6d8a$var$AVATAR_NAME)
const $94437fed6c1d6d8a$export$e2255cf6045e8d47 = /*#__PURE__*/ $6FDFN$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $6FDFN$react.createElement(
    $94437fed6c1d6d8a$var$AvatarProvider,
    {
      scope: __scopeAvatar,
      imageLoadingStatus: imageLoadingStatus,
      onImageLoadingStatusChange: setImageLoadingStatus,
    },
    /*#__PURE__*/ $6FDFN$react.createElement(
      $6FDFN$dssuireactprimitive.Primitive.span,
      $parcel$interopDefault($6FDFN$babelruntimehelpersextends)({}, avatarProps, {
        ref: forwardedRef,
      })
    )
  )
...
/* -------------------------------------------------------------------------------------------------
 * AvatarImage
 * -----------------------------------------------------------------------------------------------*/ const $94437fed6c1d6d8a$var$IMAGE_NAME =
  "AvatarImage"
const $94437fed6c1d6d8a$export$2cd8ae1985206fe8 = /*#__PURE__*/ $6FDFN$react.forwardRef((props, forwardedRef) => {
  ...
  const handleLoadingStatusChange = $6FDFN$dssuireactusecallbackref.useCallbackRef((status) => {
    onLoadingStatusChange(status)
    context.onImageLoadingStatusChange(status)
  })
  $6FDFN$dssuireactuselayouteffect.useLayoutEffect(() => {
    if (imageLoadingStatus !== "idle") handleLoadingStatusChange(imageLoadingStatus)
  }, [imageLoadingStatus, handleLoadingStatusChange])
  return imageLoadingStatus === "loaded"
    ? /*#__PURE__*/ $6FDFN$react.createElement(
        $6FDFN$dssuireactprimitive.Primitive.img,
        $parcel$interopDefault($6FDFN$babelruntimehelpersextends)({}, imageProps, {
          ref: forwardedRef,
          src: src,
        })
      )
...
/* -------------------------------------------------------------------------------------------------
 * AvatarFallback
 * -----------------------------------------------------------------------------------------------*/ const $94437fed6c1d6d8a$var$FALLBACK_NAME =
  "AvatarFallback"
const $94437fed6c1d6d8a$export$69fffb6a9571fbfe = /*#__PURE__*/ $6FDFN$react.forwardRef((props, forwardedRef) => {
  ...
  return canRender && context.imageLoadingStatus !== "loaded"
    ? /*#__PURE__*/ $6FDFN$react.createElement(
        $6FDFN$dssuireactprimitive.Primitive.span,
        $parcel$interopDefault($6FDFN$babelruntimehelpersextends)({}, fallbackProps, {
          ref: forwardedRef,
        })
      )
    : null
...
/* -----------------------------------------------------------------------------------------------*/ function $94437fed6c1d6d8a$var$useImageLoadingStatus(
  src
) {
