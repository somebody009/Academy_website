 ...
 */ function $f98399f7d3345a24$export$5a50ff2cde8c3802(
  /** The element whose rect to observe */ elementToObserve,
  /** The callback which will be called when the rect changes */ callback
) {
  ...
  if (observedData1 === undefined) {
    ...
    if ($f98399f7d3345a24$var$observedElements.size === 1)
  ...
  return () => {
    ...
    if (observedData.callbacks.length === 0) {
      ...
      if ($f98399f7d3345a24$var$observedElements.size === 0)
