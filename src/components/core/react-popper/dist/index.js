...
var $50Iv9$dssuireactarrow = require("../../react-arrow")
var $50Iv9$dssuireactcomposerefs = require("../../react-compose-refs")
var $50Iv9$dssuireactcontext = require("../../react-context")
var $50Iv9$dssuireactprimitive = require("../../react-primitive")
var $50Iv9$dssuireactusecallbackref = require("../../react-use-callback-ref")
var $50Iv9$dssuireactuselayouteffect = require("../../react-use-layout-effect")
var $50Iv9$dssuireactusesize = require("../../react-use-size")
...
/* -------------------------------------------------------------------------------------------------
 * Popper
 * -----------------------------------------------------------------------------------------------*/ const $34310caa050a8d63$var$POPPER_NAME =
  "Popper"
const [$34310caa050a8d63$var$createPopperContext, $34310caa050a8d63$export$722aac194ae923] =
  $50Iv9$dssuireactcontext.createContextScope($34310caa050a8d63$var$POPPER_NAME)
const [$34310caa050a8d63$var$PopperProvider, $34310caa050a8d63$var$usePopperContext] =
  $34310caa050a8d63$var$createPopperContext($34310caa050a8d63$var$POPPER_NAME)
const $34310caa050a8d63$export$badac9ada3a0bdf9 = (props) => {
  const { __scopePopper: __scopePopper, children: children } = props
  const [anchor, setAnchor] = $50Iv9$react.useState(null)
  return /*#__PURE__*/ $50Iv9$react.createElement(
    $34310caa050a8d63$var$PopperProvider,
    {
      scope: __scopePopper,
      anchor: anchor,
...
/* -------------------------------------------------------------------------------------------------
 * PopperAnchor
 * -----------------------------------------------------------------------------------------------*/ const $34310caa050a8d63$var$ANCHOR_NAME =
  "PopperAnchor"
const $34310caa050a8d63$export$ecd4e1ccab6ed6d = /*#__PURE__*/ $50Iv9$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $50Iv9$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref)
  ...
  return virtualRef
    ? null
    : /*#__PURE__*/ $50Iv9$react.createElement(
        $50Iv9$dssuireactprimitive.Primitive.div,
        $parcel$interopDefault($50Iv9$babelruntimehelpersextends)({}, anchorProps, {
          ref: composedRefs,
        })
      )
})
...
/* -------------------------------------------------------------------------------------------------
 * PopperContent
 * -----------------------------------------------------------------------------------------------*/ const $34310caa050a8d63$var$CONTENT_NAME =
  "PopperContent"
const [$34310caa050a8d63$var$PopperContentProvider, $34310caa050a8d63$var$useContentContext] =
  $34310caa050a8d63$var$createPopperContext($34310caa050a8d63$var$CONTENT_NAME)
const $34310caa050a8d63$export$bc4ae5855d3c4fc = /*#__PURE__*/ $50Iv9$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $50Iv9$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) => setContent(node))
  const [arrow, setArrow] = $50Iv9$react.useState(null)
  const arrowSize = $50Iv9$dssuireactusesize.useSize(arrow)
  const arrowWidth =
    (_arrowSize$width = arrowSize === null || arrowSize === void 0 ? void 0 : arrowSize.width) !== null &&
    _arrowSize$width !== void 0
      ? _arrowSize$width
      : 0
  const arrowHeight =
    (_arrowSize$height = arrowSize === null || arrowSize === void 0 ? void 0 : arrowSize.height) !== null &&
  ...
  const {
    ...
    middleware: [
      ...
      avoidCollisions &&
        $50Iv9$floatinguireactdom.shift({
          mainAxis: true,
          crossAxis: false,
      ...
      $50Iv9$floatinguireactdom.size({
        ...
        apply: ({
          ...
          contentStyle.setProperty("--dss-popper-available-width", `${availableWidth}px`)
          contentStyle.setProperty("--dss-popper-available-height", `${availableHeight}px`)
          contentStyle.setProperty("--dss-popper-anchor-width", `${anchorWidth}px`)
          contentStyle.setProperty("--dss-popper-anchor-height", `${anchorHeight}px`)
        },
      }),
      arrow &&
        $50Iv9$floatinguireactdom.arrow({
          element: arrow,
      ...
      hideWhenDetached &&
        $50Iv9$floatinguireactdom.hide({
          strategy: "referenceHidden",
        }),
    ],
  })
  const [placedSide, placedAlign] = $34310caa050a8d63$var$getSideAndAlignFromPlacement(placement)
  const handlePlaced = $50Iv9$dssuireactusecallbackref.useCallbackRef(onPlaced)
  $50Iv9$dssuireactuselayouteffect.useLayoutEffect(() => {
  ...
  return /*#__PURE__*/ $50Iv9$react.createElement(
    "div",
    {
      ...
      "data-dss-popper-content-wrapper": "",
      style: {
        ...floatingStyles,
        ...
        ["--dss-popper-transform-origin"]: [
          (_middlewareData$trans = middlewareData.transformOrigin) === null || _middlewareData$trans === void 0
            ? void 0
            : _middlewareData$trans.x,
          (_middlewareData$trans2 = middlewareData.transformOrigin) === null || _middlewareData$trans2 === void 0
            ? void 0
    ...
    /*#__PURE__*/ $50Iv9$react.createElement(
      $34310caa050a8d63$var$PopperContentProvider,
      {
        scope: __scopePopper,
      ...
      /*#__PURE__*/ $50Iv9$react.createElement(
        $50Iv9$dssuireactprimitive.Primitive.div,
        $parcel$interopDefault($50Iv9$babelruntimehelpersextends)(
          {
...
/* -------------------------------------------------------------------------------------------------
 * PopperArrow
 * -----------------------------------------------------------------------------------------------*/ const $34310caa050a8d63$var$ARROW_NAME =
  "PopperArrow"
...
const $34310caa050a8d63$export$79d62cd4e10a3fd0 = /*#__PURE__*/ $50Iv9$react.forwardRef(
  function $34310caa050a8d63$export$79d62cd4e10a3fd0(props, forwardedRef) {
    ...
    return (
      /*#__PURE__*/ // we have to use an extra wrapper because `ResizeObserver` (used by `useSize`)
      // doesn't report size as we'd expect on SVG elements.
      // it reports their bounding box which is effectively the largest path inside the SVG.
      $50Iv9$react.createElement(
        "span",
        {
        ...
        /*#__PURE__*/ $50Iv9$react.createElement(
          $50Iv9$dssuireactarrow.Root,
          $parcel$interopDefault($50Iv9$babelruntimehelpersextends)({}, arrowProps, {
            ref: forwardedRef,
            style: {
              ...arrowProps.style,
...
/* -----------------------------------------------------------------------------------------------*/ function $34310caa050a8d63$var$isNotNull(
  value
) {
  return value !== null
}
const $34310caa050a8d63$var$transformOrigin = (options) => ({
  ...
  fn(data) {
    ...
    const arrowXCenter =
      ((_middlewareData$arrow5 =
        (_middlewareData$arrow6 = middlewareData.arrow) === null || _middlewareData$arrow6 === void 0
          ? void 0
    ...
    const arrowYCenter =
      ((_middlewareData$arrow7 =
        (_middlewareData$arrow8 = middlewareData.arrow) === null || _middlewareData$arrow8 === void 0
          ? void 0
