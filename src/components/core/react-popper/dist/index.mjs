...
import {
  useState as $kY93V$useState,
  createElement as $kY93V$createElement,
  forwardRef as $kY93V$forwardRef,
  useRef as $kY93V$useRef,
  useEffect as $kY93V$useEffect,
} from "react";
import {
  useFloating as $kY93V$useFloating,
  autoUpdate as $kY93V$autoUpdate,
  offset as $kY93V$offset,
  shift as $kY93V$shift,
  limitShift as $kY93V$limitShift,
  flip as $kY93V$flip,
  size as $kY93V$size,
  arrow as $kY93V$arrow,
  hide as $kY93V$hide,
} from "@floating-ui/react-dom";
import { Root as $kY93V$Root } from "../../react-arrow";
import { useComposedRefs as $kY93V$useComposedRefs } from "../../react-compose-refs";
import { createContextScope as $kY93V$createContextScope } from "../../react-context";
import { Primitive as $kY93V$Primitive } from "../../react-primitive";
import { useCallbackRef as $kY93V$useCallbackRef } from "../../react-use-callback-ref";
import { useLayoutEffect as $kY93V$useLayoutEffect } from "../../react-use-layout-effect";
import { useSize as $kY93V$useSize } from "../../react-use-size";
...
] = $kY93V$createContextScope($cf1ac5d9fe0e8206$var$POPPER_NAME);
const [
...
const $cf1ac5d9fe0e8206$export$badac9ada3a0bdf9 = (props) => {
  ...
  return /*#__PURE__*/ $kY93V$createElement(
    $cf1ac5d9fe0e8206$var$PopperProvider,
    {
      scope: __scopePopper,
      anchor: anchor,
...
const $cf1ac5d9fe0e8206$export$ecd4e1ccab6ed6d =
  /*#__PURE__*/ $kY93V$forwardRef((props, forwardedRef) => {
    const {
    ...
    return virtualRef
      ? null
      : /*#__PURE__*/ $kY93V$createElement(
          $kY93V$Primitive.div,
          $kY93V$babelruntimehelpersesmextends({}, anchorProps, {
            ref: composedRefs,
          })
        );
  });
...
const $cf1ac5d9fe0e8206$export$bc4ae5855d3c4fc =
  /*#__PURE__*/ $kY93V$forwardRef((props, forwardedRef) => {
    ...
    const composedRefs = $kY93V$useComposedRefs(forwardedRef, (node) =>
      setContent(node)
    );
        ...
        $kY93V$size({
          ...
          apply: ({
            ...
            contentStyle.setProperty(
              "--dss-popper-available-width",
              `${availableWidth}px`
            );
            contentStyle.setProperty(
              "--dss-popper-available-height",
              `${availableHeight}px`
            );
            contentStyle.setProperty(
              "--dss-popper-anchor-width",
              `${anchorWidth}px`
            );
            contentStyle.setProperty(
              "--dss-popper-anchor-height",
              `${anchorHeight}px`
            );
          },
        }),
    ...
    return /*#__PURE__*/ $kY93V$createElement(
      ...
      /*#__PURE__*/ $kY93V$createElement(
        ...
        /*#__PURE__*/ $kY93V$createElement(
          $kY93V$Primitive.div,
          $kY93V$babelruntimehelpersesmextends(
            {
...
const $cf1ac5d9fe0e8206$export$79d62cd4e10a3fd0 =
  /*#__PURE__*/ $kY93V$forwardRef(
    function $cf1ac5d9fe0e8206$export$79d62cd4e10a3fd0(props, forwardedRef) {
      ...
      return (
        ...
        $kY93V$createElement(
          ...
          /*#__PURE__*/ $kY93V$createElement(
            $kY93V$Root,
            $kY93V$babelruntimehelpersesmextends({}, arrowProps, {
              ref: forwardedRef,
              style: {
                ...arrowProps.style,
...
export {
  $cf1ac5d9fe0e8206$export$722aac194ae923 as createPopperScope,
  $cf1ac5d9fe0e8206$export$badac9ada3a0bdf9 as Popper,
  $cf1ac5d9fe0e8206$export$ecd4e1ccab6ed6d as PopperAnchor,
  $cf1ac5d9fe0e8206$export$bc4ae5855d3c4fc as PopperContent,
  $cf1ac5d9fe0e8206$export$79d62cd4e10a3fd0 as PopperArrow,
  $cf1ac5d9fe0e8206$export$be92b6f5f03c0fe9 as Root,
  $cf1ac5d9fe0e8206$export$b688253958b8dfe7 as Anchor,
  $cf1ac5d9fe0e8206$export$7c6e2c02157bb7d2 as Content,
  $cf1ac5d9fe0e8206$export$21b07c8f274aebd5 as Arrow,
  $cf1ac5d9fe0e8206$export$36f0086da09c4b9f as SIDE_OPTIONS,
  $cf1ac5d9fe0e8206$export$3671ffab7b302fc9 as ALIGN_OPTIONS,
};
