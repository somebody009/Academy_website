...
import {
  useState as $01b9c$useState,
  useRef as $01b9c$useRef,
  createElement as $01b9c$createElement,
  useCallback as $01b9c$useCallback,
  forwardRef as $01b9c$forwardRef,
  useEffect as $01b9c$useEffect,
  Fragment as $01b9c$Fragment,
  useMemo as $01b9c$useMemo,
} from "react";
import { createPortal as $01b9c$createPortal } from "react-dom";
import { clamp as $01b9c$clamp } from "../../number";
import { composeEventHandlers as $01b9c$composeEventHandlers } from "../../primitive";
import { createCollection as $01b9c$createCollection } from "../../react-collection";
import { useComposedRefs as $01b9c$useComposedRefs } from "../../react-compose-refs";
import { createContextScope as $01b9c$createContextScope } from "../../react-context";
import { useDirection as $01b9c$useDirection } from "../../react-direction";
import { DismissableLayer as $01b9c$DismissableLayer } from "../../react-dismissable-layer";
import { useFocusGuards as $01b9c$useFocusGuards } from "../../react-focus-guards";
import { FocusScope as $01b9c$FocusScope } from "../../react-focus-scope";
import { useId as $01b9c$useId } from "../../react-id";
import {
  createPopperScope as $01b9c$createPopperScope,
  Root as $01b9c$Root,
  Anchor as $01b9c$Anchor,
  Content as $01b9c$Content,
  Arrow as $01b9c$Arrow,
} from "../../react-popper";
import { Portal as $01b9c$Portal } from "../../react-portal";
import { Primitive as $01b9c$Primitive } from "../../react-primitive";
import { Slot as $01b9c$Slot } from "../../react-slot";
import { useCallbackRef as $01b9c$useCallbackRef } from "../../react-use-callback-ref";
import { useControllableState as $01b9c$useControllableState } from "../../react-use-controllable-state";
import { useLayoutEffect as $01b9c$useLayoutEffect } from "../../react-use-layout-effect";
import { usePrevious as $01b9c$usePrevious } from "../../react-use-previous";
import { VisuallyHidden as $01b9c$VisuallyHidden } from "../../react-visually-hidden";
...
const $cc7e05a45900e73f$export$ef9b1a59e592288f = (props) => {
  ...
  const nativeSelectKey = Array.from(nativeOptionsSet)
    ...
    .join(";");
  return /*#__PURE__*/ $01b9c$createElement(
    $01b9c$Root,
    popperScope,
    /*#__PURE__*/ $01b9c$createElement(
      $cc7e05a45900e73f$var$SelectProvider,
      {
        required: required,
        scope: __scopeSelect,
...
/* -------------------------------------------------------------------------------------------------
 * SelectTrigger
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$TRIGGER_NAME =
  "SelectTrigger";
const $cc7e05a45900e73f$export$3ac1e88a1c0b9f1 =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
    const {
      __scopeSelect: __scopeSelect,
    ...
    const composedRefs = $01b9c$useComposedRefs(
      forwardedRef,
    ...
    const [searchRef, handleTypeaheadSearch, resetTypeahead] =
      $cc7e05a45900e73f$var$useTypeaheadSearch((search) => {
        ...
        const nextItem = $cc7e05a45900e73f$var$findNextItem(
          enabledItems,
          search,
          currentItem
        );
    ...
    return /*#__PURE__*/ $01b9c$createElement(
      $01b9c$Anchor,
      $01b9c$babelruntimehelpersesmextends(
        {
          asChild: true,
        },
        popperScope
      ...
      /*#__PURE__*/ $01b9c$createElement(
        ...
        $01b9c$babelruntimehelpersesmextends(
          ...
          triggerProps,
          {
            ...
            onPointerDown: $01b9c$composeEventHandlers(
            ...
            onKeyDown: $01b9c$composeEventHandlers(
...
/* -------------------------------------------------------------------------------------------------
 * SelectValue
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$VALUE_NAME =
  "SelectValue";
const $cc7e05a45900e73f$export$e288731fd71264f0 =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
    ...
    return /*#__PURE__*/ $01b9c$createElement(
      $01b9c$Primitive.span,
      $01b9c$babelruntimehelpersesmextends({}, valueProps, {
...
/* -------------------------------------------------------------------------------------------------
 * SelectIcon
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$ICON_NAME =
  "SelectIcon";
const $cc7e05a45900e73f$export$99b400cabb58c515 =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
    const {
      __scopeSelect: __scopeSelect,
      children: children,
...
/* -------------------------------------------------------------------------------------------------
 * SelectPortal
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$PORTAL_NAME =
  "SelectPortal";
...
/* -------------------------------------------------------------------------------------------------
 * SelectContent
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$CONTENT_NAME =
  "SelectContent";
const $cc7e05a45900e73f$export$c973a4b3cb86a03d =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
    const context = $cc7e05a45900e73f$var$useSelectContext(
        ...
        ? /*#__PURE__*/ $01b9c$createPortal(
            /*#__PURE__*/ $01b9c$createElement(
              ...
              /*#__PURE__*/ $01b9c$createElement(
                ...
                /*#__PURE__*/ $01b9c$createElement("div", null, props.children)
              )
            ),
            frag
          )
    ...
    return /*#__PURE__*/ $01b9c$createElement(
      ...
      $01b9c$babelruntimehelpersesmextends({}, props, {
        ref: forwardedRef,
      })
    );
  });
...
const $cc7e05a45900e73f$var$SelectContentImpl = /*#__PURE__*/ $01b9c$forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect: __scopeSelect,
    ...
    const focusFirst = $01b9c$useCallback(
      (candidates) => {
    ...
    const itemRefCallback = $01b9c$useCallback(
      (node, value, disabled) => {
    ...
    const itemTextRefCallback = $01b9c$useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem =
          context.value !== undefined && context.value === value;
    ...
    const SelectPosition =
      position === "popper"
        ...
        : $cc7e05a45900e73f$var$SelectItemAlignedPosition; // Silently ignore props that are not supported by `SelectItemAlignedPosition`
      ...
      /*#__PURE__*/ $01b9c$createElement(
        ...
        /*#__PURE__*/ $01b9c$createElement(
          $01b9c$FocusScope,
          {
            ...
            onUnmountAutoFocus: $01b9c$composeEventHandlers(
              onCloseAutoFocus,
              (event) => {
 ...
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$ITEM_ALIGNED_POSITION_NAME =
  "SelectItemAlignedPosition";
const $cc7e05a45900e73f$var$SelectItemAlignedPosition =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
    const {
      __scopeSelect: __scopeSelect,
      onPlaced: onPlaced,
    ...
    const contentContext = $cc7e05a45900e73f$var$useSelectContentContext(
      $cc7e05a45900e73f$var$CONTENT_NAME,
      __scopeSelect
    );
    ...
    const handleScrollButtonChange = $01b9c$useCallback(
      (node) => {
    ...
    return /*#__PURE__*/ $01b9c$createElement(
      ...
      /*#__PURE__*/ $01b9c$createElement(
        ...
        /*#__PURE__*/ $01b9c$createElement(
          $01b9c$Primitive.div,
          $01b9c$babelruntimehelpersesmextends({}, popperProps, {
            ref: composedRefs,
            style: {
 ...
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$POPPER_POSITION_NAME =
  "SelectPopperPosition";
const $cc7e05a45900e73f$var$SelectPopperPosition =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
    const {
      __scopeSelect: __scopeSelect,
      align: align = "start",
      collisionPadding: collisionPadding = $cc7e05a45900e73f$var$CONTENT_MARGIN,
      ...popperProps
    } = props;
    const popperScope = $cc7e05a45900e73f$var$usePopperScope(__scopeSelect);
    return /*#__PURE__*/ $01b9c$createElement(
      $01b9c$Content,
      $01b9c$babelruntimehelpersesmextends({}, popperScope, popperProps, {
        ref: forwardedRef,
        align: align,
        collisionPadding: collisionPadding,
        style: {
          ...
          boxSizing: "border-box",
          ...popperProps.style,
          "--dss-select-content-transform-origin":
            "var(--dss-popper-transform-origin)",
          "--dss-select-content-available-width":
            "var(--dss-popper-available-width)",
          "--dss-select-content-available-height":
...
const $cc7e05a45900e73f$export$9ed6e7b40248d36d =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
    ...
    const viewportContext = $cc7e05a45900e73f$var$useSelectViewportContext(
      $cc7e05a45900e73f$var$VIEWPORT_NAME,
      __scopeSelect
    );
    const composedRefs = $01b9c$useComposedRefs(
    ...
    return /*#__PURE__*/ $01b9c$createElement(
      $01b9c$Fragment,
      null,
      /*#__PURE__*/ $01b9c$createElement("style", {
        ...
        /*#__PURE__*/ $01b9c$createElement(
          ...
          $01b9c$babelruntimehelpersesmextends(
            ...
            viewportProps,
            {
              ...
              onScroll: $01b9c$composeEventHandlers(
...
/* -------------------------------------------------------------------------------------------------
 * SelectGroup
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$GROUP_NAME =
  "SelectGroup";
const [
...
const $cc7e05a45900e73f$export$ee25a334c55de1f4 =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
...
/* -------------------------------------------------------------------------------------------------
 * SelectLabel
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$LABEL_NAME =
  "SelectLabel";
const $cc7e05a45900e73f$export$f67338d29bd972f8 =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
    const { __scopeSelect: __scopeSelect, ...labelProps } = props;
    const groupContext = $cc7e05a45900e73f$var$useSelectGroupContext(
...
/* -------------------------------------------------------------------------------------------------
 * SelectItem
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$ITEM_NAME =
  "SelectItem";
const [
...
const $cc7e05a45900e73f$export$13ef48a934230896 =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
    const {
      __scopeSelect: __scopeSelect,
      value: value,
    ...
    const [textValue, setTextValue] = $01b9c$useState(
      ...
      /*#__PURE__*/ $01b9c$createElement(
        ...
        /*#__PURE__*/ $01b9c$createElement(
          ...
          $01b9c$babelruntimehelpersesmextends(
            ...
            {
              ref: composedRefs,
              onFocus: $01b9c$composeEventHandlers(itemProps.onFocus, () =>
                setIsFocused(true)
              ),
              onBlur: $01b9c$composeEventHandlers(itemProps.onBlur, () =>
                setIsFocused(false)
              ),
              ...
              onPointerMove: $01b9c$composeEventHandlers(
              ...
              onPointerLeave: $01b9c$composeEventHandlers(
...
/* -------------------------------------------------------------------------------------------------
 * SelectItemText
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$ITEM_TEXT_NAME =
  "SelectItemText";
const $cc7e05a45900e73f$export$3572fb0fb821ff49 =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
    // We ignore `className` and `style` as this part shouldn't be styled.
    const {
      __scopeSelect: __scopeSelect,
    ...
    const itemContext = $cc7e05a45900e73f$var$useSelectItemContext(
      $cc7e05a45900e73f$var$ITEM_TEXT_NAME,
      __scopeSelect
    );
...
/* -------------------------------------------------------------------------------------------------
 * SelectItemIndicator
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$ITEM_INDICATOR_NAME =
  "SelectItemIndicator";
const $cc7e05a45900e73f$export$6b9198de19accfe6 =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
 ...
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$SCROLL_UP_BUTTON_NAME =
  "SelectScrollUpButton";
const $cc7e05a45900e73f$export$d8117927658af6d7 =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
    const contentContext = $cc7e05a45900e73f$var$useSelectContentContext(
 ...
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$SCROLL_DOWN_BUTTON_NAME =
  "SelectScrollDownButton";
const $cc7e05a45900e73f$export$ff951e476c12189 =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
    const contentContext = $cc7e05a45900e73f$var$useSelectContentContext(
...
const $cc7e05a45900e73f$var$SelectScrollButtonImpl =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
    const {
      __scopeSelect: __scopeSelect,
...
/* -------------------------------------------------------------------------------------------------
 * SelectSeparator
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$SEPARATOR_NAME =
  "SelectSeparator";
...
/* -------------------------------------------------------------------------------------------------
 * SelectArrow
 * -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$ARROW_NAME =
  "SelectArrow";
const $cc7e05a45900e73f$export$314f4cb8f8099628 =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
    const { __scopeSelect: __scopeSelect, ...arrowProps } = props;
    const popperScope = $cc7e05a45900e73f$var$usePopperScope(__scopeSelect);
    const context = $cc7e05a45900e73f$var$useSelectContext(
      $cc7e05a45900e73f$var$ARROW_NAME,
      __scopeSelect
    );
    const contentContext = $cc7e05a45900e73f$var$useSelectContentContext(
      $cc7e05a45900e73f$var$ARROW_NAME,
    ...
    return context.open && contentContext.position === "popper"
      ? /*#__PURE__*/ $01b9c$createElement(
          $01b9c$Arrow,
          $01b9c$babelruntimehelpersesmextends({}, popperScope, arrowProps, {
            ref: forwardedRef,
          })
        )
      : null;
...
/* -----------------------------------------------------------------------------------------------*/ const $cc7e05a45900e73f$var$BubbleSelect =
  /*#__PURE__*/ $01b9c$forwardRef((props, forwardedRef) => {
     ...
     */ return /*#__PURE__*/ $01b9c$createElement(
      $01b9c$VisuallyHidden,
      {
        asChild: true,
      },
      /*#__PURE__*/ $01b9c$createElement(
        "select",
        $01b9c$babelruntimehelpersesmextends({}, selectProps, {
          ref: composedRefs,
          defaultValue: value,
        })
      )
...
function $cc7e05a45900e73f$var$useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = $01b9c$useCallback(
    (key) => {
 ...
 */ function $cc7e05a45900e73f$var$findNextItem(items, search, currentItem) {
  ...
  let wrappedItems = $cc7e05a45900e73f$var$wrapArray(
    items,
...
const $cc7e05a45900e73f$export$41fb9f06171c75f4 =
  $cc7e05a45900e73f$export$3ac1e88a1c0b9f1;
const $cc7e05a45900e73f$export$4c8d1a57a761ef94 =
  $cc7e05a45900e73f$export$e288731fd71264f0;
const $cc7e05a45900e73f$export$f04a61298a47a40f =
  $cc7e05a45900e73f$export$99b400cabb58c515;
const $cc7e05a45900e73f$export$602eac185826482c =
  $cc7e05a45900e73f$export$b2af6c9944296213;
const $cc7e05a45900e73f$export$7c6e2c02157bb7d2 =
  $cc7e05a45900e73f$export$c973a4b3cb86a03d;
const $cc7e05a45900e73f$export$d5c6c08dc2d3ca7 =
  $cc7e05a45900e73f$export$9ed6e7b40248d36d;
const $cc7e05a45900e73f$export$eb2fcfdbd7ba97d4 =
  $cc7e05a45900e73f$export$ee25a334c55de1f4;
const $cc7e05a45900e73f$export$b04be29aa201d4f5 =
  $cc7e05a45900e73f$export$f67338d29bd972f8;
const $cc7e05a45900e73f$export$6d08773d2e66f8f2 =
  $cc7e05a45900e73f$export$13ef48a934230896;
const $cc7e05a45900e73f$export$d6e5bf9c43ea9319 =
  $cc7e05a45900e73f$export$3572fb0fb821ff49;
const $cc7e05a45900e73f$export$c3468e2714d175fa =
  $cc7e05a45900e73f$export$6b9198de19accfe6;
const $cc7e05a45900e73f$export$2f60d3ec9ad468f2 =
  $cc7e05a45900e73f$export$d8117927658af6d7;
const $cc7e05a45900e73f$export$bf1aedc3039c8d63 =
  $cc7e05a45900e73f$export$ff951e476c12189;
const $cc7e05a45900e73f$export$1ff3c3f08ae963c0 =
  $cc7e05a45900e73f$export$eba4b1df07cb1d3;
const $cc7e05a45900e73f$export$21b07c8f274aebd5 =
