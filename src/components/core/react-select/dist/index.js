...
var $cg2C9$dssuinumber = require("../../number")
var $cg2C9$dssuiprimitive = require("../../primitive")
var $cg2C9$dssuireactcollection = require("../../react-collection")
var $cg2C9$dssuireactcomposerefs = require("../../react-compose-refs")
var $cg2C9$dssuireactcontext = require("../../react-context")
var $cg2C9$dssuireactdirection = require("../../react-direction")
var $cg2C9$dssuireactdismissablelayer = require("../../react-dismissable-layer")
var $cg2C9$dssuireactfocusguards = require("../../react-focus-guards")
var $cg2C9$dssuireactfocusscope = require("../../react-focus-scope")
var $cg2C9$dssuireactid = require("../../react-id")
var $cg2C9$dssuireactpopper = require("../../react-popper")
var $cg2C9$dssuireactportal = require("../../react-portal")
var $cg2C9$dssuireactprimitive = require("../../react-primitive")
var $cg2C9$dssuireactslot = require("../../react-slot")
var $cg2C9$dssuireactusecallbackref = require("../../react-use-callback-ref")
var $cg2C9$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
var $cg2C9$dssuireactuselayouteffect = require("../../react-use-layout-effect")
var $cg2C9$dssuireactuseprevious = require("../../react-use-previous")
var $cg2C9$dssuireactvisuallyhidden = require("../../react-visually-hidden")
...
] = $cg2C9$dssuireactcollection.createCollection($1345bda09ffc1bc6$var$SELECT_NAME)
const [$1345bda09ffc1bc6$var$createSelectContext, $1345bda09ffc1bc6$export$286727a75dc039bd] =
  $cg2C9$dssuireactcontext.createContextScope($1345bda09ffc1bc6$var$SELECT_NAME, [
    $1345bda09ffc1bc6$var$createCollectionScope,
    $cg2C9$dssuireactpopper.createPopperScope,
  ])
const $1345bda09ffc1bc6$var$usePopperScope = $cg2C9$dssuireactpopper.createPopperScope()
const [$1345bda09ffc1bc6$var$SelectProvider, $1345bda09ffc1bc6$var$useSelectContext] =
  $1345bda09ffc1bc6$var$createSelectContext($1345bda09ffc1bc6$var$SELECT_NAME)
const [$1345bda09ffc1bc6$var$SelectNativeOptionsProvider, $1345bda09ffc1bc6$var$useSelectNativeOptionsContext] =
  $1345bda09ffc1bc6$var$createSelectContext($1345bda09ffc1bc6$var$SELECT_NAME)
const $1345bda09ffc1bc6$export$ef9b1a59e592288f = (props) => {
  ...
  const direction = $cg2C9$dssuireactdirection.useDirection(dir)
  const [open = false, setOpen] = $cg2C9$dssuireactusecontrollablestate.useControllableState({
    prop: openProp,
    defaultProp: defaultOpen,
    onChange: onOpenChange,
  })
  const [value, setValue] = $cg2C9$dssuireactusecontrollablestate.useControllableState({
    prop: valueProp,
  ...
  return /*#__PURE__*/ $cg2C9$react.createElement(
    ...
    /*#__PURE__*/ $cg2C9$react.createElement(
      $1345bda09ffc1bc6$var$SelectProvider,
      {
        ...
        contentId: $cg2C9$dssuireactid.useId(),
        value: value,
...
const $1345bda09ffc1bc6$export$3ac1e88a1c0b9f1 = /*#__PURE__*/ $cg2C9$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $cg2C9$dssuireactcomposerefs.useComposedRefs(forwardedRef, context.onTriggerChange)
  ...
  return /*#__PURE__*/ $cg2C9$react.createElement(
    ...
    /*#__PURE__*/ $cg2C9$react.createElement(
      $cg2C9$dssuireactprimitive.Primitive.button,
      $parcel$interopDefault($cg2C9$babelruntimehelpersextends)(
        {
          type: "button",
          role: "combobox",
        ...
        triggerProps,
        {
          ...
          onClick: $cg2C9$dssuiprimitive.composeEventHandlers(triggerProps.onClick, (event) => {
          ...
          onPointerDown: $cg2C9$dssuiprimitive.composeEventHandlers(triggerProps.onPointerDown, (event) => {
          ...
          onKeyDown: $cg2C9$dssuiprimitive.composeEventHandlers(triggerProps.onKeyDown, (event) => {
...
const $1345bda09ffc1bc6$export$e288731fd71264f0 = /*#__PURE__*/ $cg2C9$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $cg2C9$dssuireactcomposerefs.useComposedRefs(forwardedRef, context.onValueNodeChange)
  $cg2C9$dssuireactuselayouteffect.useLayoutEffect(() => {
    onValueNodeHasChildrenChange(hasChildren)
  }, [onValueNodeHasChildrenChange, hasChildren])
  return /*#__PURE__*/ $cg2C9$react.createElement(
    $cg2C9$dssuireactprimitive.Primitive.span,
    $parcel$interopDefault($cg2C9$babelruntimehelpersextends)({}, valueProps, {
      ...
      ? /*#__PURE__*/ $cg2C9$reactdom.createPortal(
          /*#__PURE__*/ $cg2C9$react.createElement(
            ...
            /*#__PURE__*/ $cg2C9$react.createElement(
              ...
              /*#__PURE__*/ $cg2C9$react.createElement("div", null, props.children)
            )
          ),
          frag
        )
...
const [$1345bda09ffc1bc6$var$SelectContentProvider, $1345bda09ffc1bc6$var$useSelectContentContext] =
  $1345bda09ffc1bc6$var$createSelectContext($1345bda09ffc1bc6$var$CONTENT_NAME)
...
const $1345bda09ffc1bc6$var$SelectContentImpl = /*#__PURE__*/ $cg2C9$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $cg2C9$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) => setContent(node))
  ...
  $cg2C9$dssuireactfocusguards.useFocusGuards()
          ...
          x: Math.abs(
            Math.round(event.pageX) -
              ((_triggerPointerDownPo =
                (_triggerPointerDownPo2 = triggerPointerDownPosRef.current) === null ||
                _triggerPointerDownPo2 === void 0
                  ? void 0
                  : _triggerPointerDownPo2.x) !== null && _triggerPointerDownPo !== void 0
                ? _triggerPointerDownPo
                : 0)
          ),
          y: Math.abs(
            Math.round(event.pageY) -
              ((_triggerPointerDownPo3 =
                (_triggerPointerDownPo4 = triggerPointerDownPosRef.current) === null ||
                _triggerPointerDownPo4 === void 0
                  ? void 0
                  : _triggerPointerDownPo4.y) !== null && _triggerPointerDownPo3 !== void 0
                ? _triggerPointerDownPo3
                : 0)
          ),
        }
  ...
  const SelectPosition =
    position === "popper" ? $1345bda09ffc1bc6$var$SelectPopperPosition : $1345bda09ffc1bc6$var$SelectItemAlignedPosition // Silently ignore props that are not supported by `SelectItemAlignedPosition`
  ...
  return /*#__PURE__*/ $cg2C9$react.createElement(
    ...
    /*#__PURE__*/ $cg2C9$react.createElement(
      ...
      {
        as: $cg2C9$dssuireactslot.Slot,
        allowPinchZoom: true,
      },
      /*#__PURE__*/ $cg2C9$react.createElement(
        $cg2C9$dssuireactfocusscope.FocusScope,
        {
          ...
          onUnmountAutoFocus: $cg2C9$dssuiprimitive.composeEventHandlers(onCloseAutoFocus, (event) => {
        ...
        /*#__PURE__*/ $cg2C9$react.createElement(
          $cg2C9$dssuireactdismissablelayer.DismissableLayer,
          {
            asChild: true,
          ...
          /*#__PURE__*/ $cg2C9$react.createElement(
            ...
            $parcel$interopDefault($cg2C9$babelruntimehelpersextends)(
              ...
              popperContentProps,
              {
                ...
                onKeyDown: $cg2C9$dssuiprimitive.composeEventHandlers(contentProps.onKeyDown, (event) => {
...
const $1345bda09ffc1bc6$var$SelectItemAlignedPosition = /*#__PURE__*/ $cg2C9$react.forwardRef((props, forwardedRef) => {
  ...
  const position = $cg2C9$react.useCallback(() => {
    if (
      ...
      if (context.dir !== "rtl") {
        ...
        const clampedLeft = $cg2C9$dssuinumber.clamp(left, [
        ...
        const clampedRight = $cg2C9$dssuinumber.clamp(right, [
          $1345bda09ffc1bc6$var$CONTENT_MARGIN,
  ...
  $cg2C9$dssuireactuselayouteffect.useLayoutEffect(() => position(), [position]) // copy z-index from content to wrapper
  ...
  return /*#__PURE__*/ $cg2C9$react.createElement(
    ...
    /*#__PURE__*/ $cg2C9$react.createElement(
      ...
      /*#__PURE__*/ $cg2C9$react.createElement(
        $cg2C9$dssuireactprimitive.Primitive.div,
        $parcel$interopDefault($cg2C9$babelruntimehelpersextends)({}, popperProps, {
          ref: composedRefs,
          style: {
...
const $1345bda09ffc1bc6$var$SelectPopperPosition = /*#__PURE__*/ $cg2C9$react.forwardRef((props, forwardedRef) => {
  ...
  const popperScope = $1345bda09ffc1bc6$var$usePopperScope(__scopeSelect)
  return /*#__PURE__*/ $cg2C9$react.createElement(
    $cg2C9$dssuireactpopper.Content,
    $parcel$interopDefault($cg2C9$babelruntimehelpersextends)({}, popperScope, popperProps, {
      ref: forwardedRef,
      align: align,
      collisionPadding: collisionPadding,
      style: {
        ...
        boxSizing: "border-box",
        ...popperProps.style,
        "--dss-select-content-transform-origin": "var(--dss-popper-transform-origin)",
        "--dss-select-content-available-width": "var(--dss-popper-available-width)",
        "--dss-select-content-available-height": "var(--dss-popper-available-height)",
        "--dss-select-trigger-width": "var(--dss-popper-anchor-width)",
        "--dss-select-trigger-height": "var(--dss-popper-anchor-height)",
      },
    })
  )
})
...
const $1345bda09ffc1bc6$export$9ed6e7b40248d36d = /*#__PURE__*/ $cg2C9$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $cg2C9$dssuireactcomposerefs.useComposedRefs(forwardedRef, contentContext.onViewportChange)
  ...
  return /*#__PURE__*/ $cg2C9$react.createElement(
    ...
    /*#__PURE__*/ $cg2C9$react.createElement("style", {
      dangerouslySetInnerHTML: {
        __html: `[data-dss-select-viewport]{scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;}[data-dss-select-viewport]::-webkit-scrollbar{display:none}`,
      },
    }),
    /*#__PURE__*/ $cg2C9$react.createElement(
      $1345bda09ffc1bc6$var$Collection.Slot,
      ...
      /*#__PURE__*/ $cg2C9$react.createElement(
        ...
        $parcel$interopDefault($cg2C9$babelruntimehelpersextends)(
          ...
          viewportProps,
          {
            ...
            onScroll: $cg2C9$dssuiprimitive.composeEventHandlers(viewportProps.onScroll, (event) => {
 ...
 * -----------------------------------------------------------------------------------------------*/ const $1345bda09ffc1bc6$var$GROUP_NAME =
  "SelectGroup"
const [$1345bda09ffc1bc6$var$SelectGroupContextProvider, $1345bda09ffc1bc6$var$useSelectGroupContext] =
...
const $1345bda09ffc1bc6$export$ee25a334c55de1f4 = /*#__PURE__*/ $cg2C9$react.forwardRef((props, forwardedRef) => {
  ...
  const groupId = $cg2C9$dssuireactid.useId()
  return /*#__PURE__*/ $cg2C9$react.createElement(
 ...
 * -----------------------------------------------------------------------------------------------*/ const $1345bda09ffc1bc6$var$ITEM_NAME =
  "SelectItem"
const [$1345bda09ffc1bc6$var$SelectItemContextProvider, $1345bda09ffc1bc6$var$useSelectItemContext] =
...
const $1345bda09ffc1bc6$export$13ef48a934230896 = /*#__PURE__*/ $cg2C9$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $cg2C9$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) => {
    var _contentContext$itemR
    return (_contentContext$itemR = contentContext.itemRefCallback) === null || _contentContext$itemR === void 0
      ? void 0
      : _contentContext$itemR.call(contentContext, node, value, disabled)
  })
  const textId = $cg2C9$dssuireactid.useId()
  const handleSelect = () => {
    if (!disabled) {
    ...
    $1345bda09ffc1bc6$var$SelectItemContextProvider,
    {
      ...
      onItemTextChange: $cg2C9$react.useCallback((node) => {
        setTextValue((prevTextValue) => {
          ...
          return (
            prevTextValue ||
            ((_node$textContent = node === null || node === void 0 ? void 0 : node.textContent) !== null &&
    ...
    /*#__PURE__*/ $cg2C9$react.createElement(
      ...
      /*#__PURE__*/ $cg2C9$react.createElement(
        ...
        $parcel$interopDefault($cg2C9$babelruntimehelpersextends)(
          ...
          {
            ref: composedRefs,
            onFocus: $cg2C9$dssuiprimitive.composeEventHandlers(itemProps.onFocus, () => setIsFocused(true)),
            onBlur: $cg2C9$dssuiprimitive.composeEventHandlers(itemProps.onBlur, () => setIsFocused(false)),
            onPointerUp: $cg2C9$dssuiprimitive.composeEventHandlers(itemProps.onPointerUp, handleSelect),
            onPointerMove: $cg2C9$dssuiprimitive.composeEventHandlers(itemProps.onPointerMove, (event) => {
              if (disabled) {
                var _contentContext$onIte
                ;(_contentContext$onIte = contentContext.onItemLeave) === null ||
            ...
            onPointerLeave: $cg2C9$dssuiprimitive.composeEventHandlers(itemProps.onPointerLeave, (event) => {
              if (event.currentTarget === document.activeElement) {
                var _contentContext$onIte2
                ;(_contentContext$onIte2 = contentContext.onItemLeave) === null ||
                  _contentContext$onIte2 === void 0 ||
                  _contentContext$onIte2.call(contentContext)
              }
            }),
            onKeyDown: $cg2C9$dssuiprimitive.composeEventHandlers(itemProps.onKeyDown, (event) => {
              var _contentContext$searc
              const isTypingAhead =
                ((_contentContext$searc = contentContext.searchRef) === null || _contentContext$searc === void 0
                  ? void 0
...
const $1345bda09ffc1bc6$export$3572fb0fb821ff49 = /*#__PURE__*/ $cg2C9$react.forwardRef((props, forwardedRef) => {
  ...
  const nativeOptionsContext = $1345bda09ffc1bc6$var$useSelectNativeOptionsContext(
    $1345bda09ffc1bc6$var$ITEM_TEXT_NAME,
    __scopeSelect
  )
  const [itemTextNode, setItemTextNode] = $cg2C9$react.useState(null)
  const composedRefs = $cg2C9$dssuireactcomposerefs.useComposedRefs(
    forwardedRef,
    (node) => setItemTextNode(node),
    itemContext.onItemTextChange,
    (node) => {
      var _contentContext$itemT
      return (_contentContext$itemT = contentContext.itemTextRefCallback) === null || _contentContext$itemT === void 0
        ? void 0
        : _contentContext$itemT.call(contentContext, node, itemContext.value, itemContext.disabled)
    }
  )
  ...
  return /*#__PURE__*/ $cg2C9$react.createElement(
    ...
    itemContext.isSelected && context.valueNode && !context.valueNodeHasChildren
      ? /*#__PURE__*/ $cg2C9$reactdom.createPortal(itemTextProps.children, context.valueNode)
      : null
  )
})
...
const $1345bda09ffc1bc6$export$d8117927658af6d7 = /*#__PURE__*/ $cg2C9$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $cg2C9$dssuireactcomposerefs.useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange)
  $cg2C9$dssuireactuselayouteffect.useLayoutEffect(() => {
  ...
  return /*#__PURE__*/ $cg2C9$react.createElement(
    ...
    $parcel$interopDefault($cg2C9$babelruntimehelpersextends)(
      ...
      scrollIndicatorProps,
      {
        ...
        onPointerDown: $cg2C9$dssuiprimitive.composeEventHandlers(scrollIndicatorProps.onPointerDown, () => {
          if (autoScrollTimerRef.current === null) autoScrollTimerRef.current = window.setInterval(onAutoScroll, 50)
        }),
        onPointerMove: $cg2C9$dssuiprimitive.composeEventHandlers(scrollIndicatorProps.onPointerMove, () => {
        ...
        onPointerLeave: $cg2C9$dssuiprimitive.composeEventHandlers(scrollIndicatorProps.onPointerLeave, () => {
...
const $1345bda09ffc1bc6$export$314f4cb8f8099628 = /*#__PURE__*/ $cg2C9$react.forwardRef((props, forwardedRef) => {
  ...
  return context.open && contentContext.position === "popper"
    ? /*#__PURE__*/ $cg2C9$react.createElement(
        $cg2C9$dssuireactpopper.Arrow,
        $parcel$interopDefault($cg2C9$babelruntimehelpersextends)({}, popperScope, arrowProps, {
          ref: forwardedRef,
        })
      )
    : null
...
/* -----------------------------------------------------------------------------------------------*/ const $1345bda09ffc1bc6$var$BubbleSelect =
  /*#__PURE__*/ $cg2C9$react.forwardRef((props, forwardedRef) => {
    ...
    const composedRefs = $cg2C9$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref)
    const prevValue = $cg2C9$dssuireactuseprevious.usePrevious(value) // Bubble value change to parents (e.g form change event)
    $cg2C9$react.useEffect(() => {
     ...
     */ return /*#__PURE__*/ $cg2C9$react.createElement(
      $cg2C9$dssuireactvisuallyhidden.VisuallyHidden,
      {
        asChild: true,
      },
      /*#__PURE__*/ $cg2C9$react.createElement(
        "select",
        $parcel$interopDefault($cg2C9$babelruntimehelpersextends)({}, selectProps, {
          ref: composedRefs,
          defaultValue: value,
        })
      )
...
function $1345bda09ffc1bc6$var$useTypeaheadSearch(onSearchChange) {
  const handleSearchChange = $cg2C9$dssuireactusecallbackref.useCallbackRef(onSearchChange)
