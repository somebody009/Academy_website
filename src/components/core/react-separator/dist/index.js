...
var $3sOcx$dssuireactprimitive = require("../../react-primitive")
...
/* -------------------------------------------------------------------------------------------------
 *  Separator
 * -----------------------------------------------------------------------------------------------*/ const $1d2e81bd6a105992$var$NAME =
  "Separator"
const $1d2e81bd6a105992$var$DEFAULT_ORIENTATION = "horizontal"
const $1d2e81bd6a105992$var$ORIENTATIONS = ["horizontal", "vertical"]
const $1d2e81bd6a105992$export$1ff3c3f08ae963c0 = /*#__PURE__*/ $3sOcx$react.forwardRef((props, forwardedRef) => {
  const {
    decorative: decorative,
    orientation: orientationProp = $1d2e81bd6a105992$var$DEFAULT_ORIENTATION,
    ...domProps
  } = props
  const orientation = $1d2e81bd6a105992$var$isValidOrientation(orientationProp)
    ? orientationProp
    : $1d2e81bd6a105992$var$DEFAULT_ORIENTATION // `aria-orientation` defaults to `horizontal` so we only need it if `orientation` is vertical
  ...
  return /*#__PURE__*/ $3sOcx$react.createElement(
    $3sOcx$dssuireactprimitive.Primitive.div,
    $parcel$interopDefault($3sOcx$babelruntimehelpersextends)(
      {
...
$1d2e81bd6a105992$export$1ff3c3f08ae963c0.propTypes = {
  orientation(props, propName, componentName) {
    ...
    if (propValue && !$1d2e81bd6a105992$var$isValidOrientation(propValue))
      return new Error($1d2e81bd6a105992$var$getInvalidOrientationError(strVal, componentName))
    return null
  },
}
