import {
  useCallback as $bnPw9$useCallback,
  useState as $bnPw9$useState,
  useRef as $bnPw9$useRef,
  useEffect as $bnPw9$useEffect,
} from "react";
import { useCallbackRef as $bnPw9$useCallbackRef } from "../../react-use-callback-ref";
...
function $71cd76cc60e0454e$export$6f32135080cb4c3({
  ...
  const setValue = $bnPw9$useCallback(
    (nextValue) => {
      if (isControlled) {
