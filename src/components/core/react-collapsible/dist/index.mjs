...
import {
  forwardRef as $73KQ4$forwardRef,
  createElement as $73KQ4$createElement,
  useCallback as $73KQ4$useCallback,
  useState as $73KQ4$useState,
  useRef as $73KQ4$useRef,
  useEffect as $73KQ4$useEffect,
} from "react";
import { composeEventHandlers as $73KQ4$composeEventHandlers } from "../../primitive";
import { createContextScope as $73KQ4$createContextScope } from "../../react-context";
import { useControllableState as $73KQ4$useControllableState } from "../../react-use-controllable-state";
import { useLayoutEffect as $73KQ4$useLayoutEffect } from "../../react-use-layout-effect";
import { useComposedRefs as $73KQ4$useComposedRefs } from "../../react-compose-refs";
import { Primitive as $73KQ4$Primitive } from "../../react-primitive";
import { Presence as $73KQ4$Presence } from "../../react-presence";
import { useId as $73KQ4$useId } from "../../react-id";

/* -------------------------------------------------------------------------------------------------
 * Collapsible
 * -----------------------------------------------------------------------------------------------*/ const $409067139f391064$var$COLLAPSIBLE_NAME =
  "Collapsible";
const [
  $409067139f391064$var$createCollapsibleContext,
  $409067139f391064$export$952b32dcbe73087a,
] = $73KQ4$createContextScope($409067139f391064$var$COLLAPSIBLE_NAME);
const [
  $409067139f391064$var$CollapsibleProvider,
  $409067139f391064$var$useCollapsibleContext,
] = $409067139f391064$var$createCollapsibleContext(
  $409067139f391064$var$COLLAPSIBLE_NAME
);
const $409067139f391064$export$6eb0f7ddcda6131f =
  /*#__PURE__*/ $73KQ4$forwardRef((props, forwardedRef) => {
    const {
    ...
    return /*#__PURE__*/ $73KQ4$createElement(
      $409067139f391064$var$CollapsibleProvider,
      {
        ...
        open: open,
        onOpenToggle: $73KQ4$useCallback(
          () => setOpen((prevOpen) => !prevOpen),
          [setOpen]
        ),
      },
      /*#__PURE__*/ $73KQ4$createElement(
        $73KQ4$Primitive.div,
        $73KQ4$babelruntimehelpersesmextends(
          {
...
/* -------------------------------------------------------------------------------------------------
 * CollapsibleTrigger
 * -----------------------------------------------------------------------------------------------*/ const $409067139f391064$var$TRIGGER_NAME =
  "CollapsibleTrigger";
const $409067139f391064$export$c135dce7b15bbbdc =
  /*#__PURE__*/ $73KQ4$forwardRef((props, forwardedRef) => {
    const { __scopeCollapsible: __scopeCollapsible, ...triggerProps } = props;
    const context = $409067139f391064$var$useCollapsibleContext(
      $409067139f391064$var$TRIGGER_NAME,
      __scopeCollapsible
    );
    return /*#__PURE__*/ $73KQ4$createElement(
      $73KQ4$Primitive.button,
      $73KQ4$babelruntimehelpersesmextends(
        {
          type: "button",
        ...
        {
          ref: forwardedRef,
          onClick: $73KQ4$composeEventHandlers(
            props.onClick,
...
/* -------------------------------------------------------------------------------------------------
 * CollapsibleContent
 * -----------------------------------------------------------------------------------------------*/ const $409067139f391064$var$CONTENT_NAME =
  "CollapsibleContent";
const $409067139f391064$export$aadde00976f34151 =
  /*#__PURE__*/ $73KQ4$forwardRef((props, forwardedRef) => {
    const { forceMount: forceMount, ...contentProps } = props;
    const context = $409067139f391064$var$useCollapsibleContext(
      $409067139f391064$var$CONTENT_NAME,
    ...
    return /*#__PURE__*/ $73KQ4$createElement(
      ...
      ({ present: present }) =>
        /*#__PURE__*/ $73KQ4$createElement(
          ...
          $73KQ4$babelruntimehelpersesmextends({}, contentProps, {
            ref: forwardedRef,
            present: present,
          })
        )
...
/* -----------------------------------------------------------------------------------------------*/ const $409067139f391064$var$CollapsibleContentImpl =
  /*#__PURE__*/ $73KQ4$forwardRef((props, forwardedRef) => {
    const {
      __scopeCollapsible: __scopeCollapsible,
      present: present,
    ...
    return /*#__PURE__*/ $73KQ4$createElement(
      ...
      $73KQ4$babelruntimehelpersesmextends(
        ...
        contentProps,
        {
          ref: composedRefs,
          style: {
            [`--dss-collapsible-content-height`]: height
              ? `${height}px`
              : undefined,
            [`--dss-collapsible-content-width`]: width
              ? `${width}px`
              : undefined,
            ...props.style,
          },
...
/* -----------------------------------------------------------------------------------------------*/ function $409067139f391064$var$getState(
  open
) {
...
const $409067139f391064$export$41fb9f06171c75f4 =
  $409067139f391064$export$c135dce7b15bbbdc;
const $409067139f391064$export$7c6e2c02157bb7d2 =
