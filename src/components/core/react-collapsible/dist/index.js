...
var $f0mF1$dssuiprimitive = require("../../primitive")
var $f0mF1$dssuireactcontext = require("../../react-context")
var $f0mF1$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
var $f0mF1$dssuireactuselayouteffect = require("../../react-use-layout-effect")
var $f0mF1$dssuireactcomposerefs = require("../../react-compose-refs")
var $f0mF1$dssuireactprimitive = require("../../react-primitive")
var $f0mF1$dssuireactpresence = require("../../react-presence")
var $f0mF1$dssuireactid = require("../../react-id")
...
/* -------------------------------------------------------------------------------------------------
 * Collapsible
 * -----------------------------------------------------------------------------------------------*/ const $e729681ae85df948$var$COLLAPSIBLE_NAME =
  "Collapsible"
const [$e729681ae85df948$var$createCollapsibleContext, $e729681ae85df948$export$952b32dcbe73087a] =
  $f0mF1$dssuireactcontext.createContextScope($e729681ae85df948$var$COLLAPSIBLE_NAME)
const [$e729681ae85df948$var$CollapsibleProvider, $e729681ae85df948$var$useCollapsibleContext] =
  $e729681ae85df948$var$createCollapsibleContext($e729681ae85df948$var$COLLAPSIBLE_NAME)
const $e729681ae85df948$export$6eb0f7ddcda6131f = /*#__PURE__*/ $f0mF1$react.forwardRef((props, forwardedRef) => {
  ...
  const [open = false, setOpen] = $f0mF1$dssuireactusecontrollablestate.useControllableState({
    prop: openProp,
    defaultProp: defaultOpen,
    onChange: onOpenChange,
  })
  return /*#__PURE__*/ $f0mF1$react.createElement(
    $e729681ae85df948$var$CollapsibleProvider,
    {
      scope: __scopeCollapsible,
      disabled: disabled,
      contentId: $f0mF1$dssuireactid.useId(),
      open: open,
      onOpenToggle: $f0mF1$react.useCallback(() => setOpen((prevOpen) => !prevOpen), [setOpen]),
    },
    /*#__PURE__*/ $f0mF1$react.createElement(
      $f0mF1$dssuireactprimitive.Primitive.div,
      $parcel$interopDefault($f0mF1$babelruntimehelpersextends)(
        {
...
/* -------------------------------------------------------------------------------------------------
 * CollapsibleTrigger
 * -----------------------------------------------------------------------------------------------*/ const $e729681ae85df948$var$TRIGGER_NAME =
  "CollapsibleTrigger"
const $e729681ae85df948$export$c135dce7b15bbbdc = /*#__PURE__*/ $f0mF1$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $f0mF1$react.createElement(
    $f0mF1$dssuireactprimitive.Primitive.button,
    $parcel$interopDefault($f0mF1$babelruntimehelpersextends)(
      {
        type: "button",
      ...
      {
        ref: forwardedRef,
        onClick: $f0mF1$dssuiprimitive.composeEventHandlers(props.onClick, context.onOpenToggle),
      }
    )
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * CollapsibleContent
 * -----------------------------------------------------------------------------------------------*/ const $e729681ae85df948$var$CONTENT_NAME =
  "CollapsibleContent"
const $e729681ae85df948$export$aadde00976f34151 = /*#__PURE__*/ $f0mF1$react.forwardRef((props, forwardedRef) => {
  const { forceMount: forceMount, ...contentProps } = props
  const context = $e729681ae85df948$var$useCollapsibleContext(
    $e729681ae85df948$var$CONTENT_NAME,
    props.__scopeCollapsible
  )
  return /*#__PURE__*/ $f0mF1$react.createElement(
    $f0mF1$dssuireactpresence.Presence,
    {
      present: forceMount || context.open,
    },
    ({ present: present }) =>
      /*#__PURE__*/ $f0mF1$react.createElement(
        $e729681ae85df948$var$CollapsibleContentImpl,
        $parcel$interopDefault($f0mF1$babelruntimehelpersextends)({}, contentProps, {
          ref: forwardedRef,
          present: present,
        })
      )
...
/* -----------------------------------------------------------------------------------------------*/ const $e729681ae85df948$var$CollapsibleContentImpl =
  /*#__PURE__*/ $f0mF1$react.forwardRef((props, forwardedRef) => {
    ...
    const composedRefs = $f0mF1$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref)
    ...
    $f0mF1$dssuireactuselayouteffect.useLayoutEffect(() => {
    ...
    return /*#__PURE__*/ $f0mF1$react.createElement(
      ...
      $parcel$interopDefault($f0mF1$babelruntimehelpersextends)(
        ...
        contentProps,
        {
          ref: composedRefs,
          style: {
            [`--dss-collapsible-content-height`]: height ? `${height}px` : undefined,
            [`--dss-collapsible-content-width`]: width ? `${width}px` : undefined,
            ...props.style,
          },
        }
      ),
...
/* -----------------------------------------------------------------------------------------------*/ function $e729681ae85df948$var$getState(
  open
) {
