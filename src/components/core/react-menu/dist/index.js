...
var $cnSS2$dssuiprimitive = require("../../primitive")
var $cnSS2$dssuireactcollection = require("../../react-collection")
var $cnSS2$dssuireactcomposerefs = require("../../react-compose-refs")
var $cnSS2$dssuireactcontext = require("../../react-context")
var $cnSS2$dssuireactdirection = require("../../react-direction")
var $cnSS2$dssuireactdismissablelayer = require("../../react-dismissable-layer")
var $cnSS2$dssuireactfocusguards = require("../../react-focus-guards")
var $cnSS2$dssuireactfocusscope = require("../../react-focus-scope")
var $cnSS2$dssuireactid = require("../../react-id")
var $cnSS2$dssuireactpopper = require("../../react-popper")
var $cnSS2$dssuireactportal = require("../../react-portal")
var $cnSS2$dssuireactpresence = require("../../react-presence")
var $cnSS2$dssuireactprimitive = require("../../react-primitive")
var $cnSS2$dssuireactrovingfocus = require("../../react-roving-focus")
var $cnSS2$dssuireactslot = require("../../react-slot")
var $cnSS2$dssuireactusecallbackref = require("../../react-use-callback-ref")
...
/* -------------------------------------------------------------------------------------------------
 * Menu
 * -----------------------------------------------------------------------------------------------*/ const $213e4d2df823067d$var$MENU_NAME =
  "Menu"
const [
  $213e4d2df823067d$var$Collection,
  $213e4d2df823067d$var$useCollection,
  $213e4d2df823067d$var$createCollectionScope,
] = $cnSS2$dssuireactcollection.createCollection($213e4d2df823067d$var$MENU_NAME)
const [$213e4d2df823067d$var$createMenuContext, $213e4d2df823067d$export$4027731b685e72eb] =
  $cnSS2$dssuireactcontext.createContextScope($213e4d2df823067d$var$MENU_NAME, [
    $213e4d2df823067d$var$createCollectionScope,
    $cnSS2$dssuireactpopper.createPopperScope,
    $cnSS2$dssuireactrovingfocus.createRovingFocusGroupScope,
  ])
const $213e4d2df823067d$var$usePopperScope = $cnSS2$dssuireactpopper.createPopperScope()
const $213e4d2df823067d$var$useRovingFocusGroupScope = $cnSS2$dssuireactrovingfocus.createRovingFocusGroupScope()
const [$213e4d2df823067d$var$MenuProvider, $213e4d2df823067d$var$useMenuContext] =
  $213e4d2df823067d$var$createMenuContext($213e4d2df823067d$var$MENU_NAME)
const [$213e4d2df823067d$var$MenuRootProvider, $213e4d2df823067d$var$useMenuRootContext] =
  $213e4d2df823067d$var$createMenuContext($213e4d2df823067d$var$MENU_NAME)
const $213e4d2df823067d$export$d9b273488cd8ce6f = (props) => {
  ...
  const handleOpenChange = $cnSS2$dssuireactusecallbackref.useCallbackRef(onOpenChange)
  const direction = $cnSS2$dssuireactdirection.useDirection(dir)
  ...
  return /*#__PURE__*/ $cnSS2$react.createElement(
    $cnSS2$dssuireactpopper.Root,
    popperScope,
    /*#__PURE__*/ $cnSS2$react.createElement(
      $213e4d2df823067d$var$MenuProvider,
      {
        scope: __scopeMenu,
        open: open,
      ...
      /*#__PURE__*/ $cnSS2$react.createElement(
        $213e4d2df823067d$var$MenuRootProvider,
        {
          scope: __scopeMenu,
...
/* -------------------------------------------------------------------------------------------------
 * MenuAnchor
 * -----------------------------------------------------------------------------------------------*/ const $213e4d2df823067d$var$ANCHOR_NAME =
  "MenuAnchor"
const $213e4d2df823067d$export$9fa5ebd18bee4d43 = /*#__PURE__*/ $cnSS2$react.forwardRef((props, forwardedRef) => {
  const { __scopeMenu: __scopeMenu, ...anchorProps } = props
  const popperScope = $213e4d2df823067d$var$usePopperScope(__scopeMenu)
  return /*#__PURE__*/ $cnSS2$react.createElement(
    $cnSS2$dssuireactpopper.Anchor,
    $parcel$interopDefault($cnSS2$babelruntimehelpersextends)({}, popperScope, anchorProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * MenuPortal
 * -----------------------------------------------------------------------------------------------*/ const $213e4d2df823067d$var$PORTAL_NAME =
  "MenuPortal"
const [$213e4d2df823067d$var$PortalProvider, $213e4d2df823067d$var$usePortalContext] =
  $213e4d2df823067d$var$createMenuContext($213e4d2df823067d$var$PORTAL_NAME, {
...
const $213e4d2df823067d$export$793392f970497feb = (props) => {
  ...
  return /*#__PURE__*/ $cnSS2$react.createElement(
    $213e4d2df823067d$var$PortalProvider,
    {
      scope: __scopeMenu,
      forceMount: forceMount,
    },
    /*#__PURE__*/ $cnSS2$react.createElement(
      $cnSS2$dssuireactpresence.Presence,
      {
        present: forceMount || context.open,
      },
      /*#__PURE__*/ $cnSS2$react.createElement(
        $cnSS2$dssuireactportal.Portal,
        {
          asChild: true,
          container: container,
        },
...
/* -------------------------------------------------------------------------------------------------
 * MenuContent
 * -----------------------------------------------------------------------------------------------*/ const $213e4d2df823067d$var$CONTENT_NAME =
  "MenuContent"
const [$213e4d2df823067d$var$MenuContentProvider, $213e4d2df823067d$var$useMenuContentContext] =
  $213e4d2df823067d$var$createMenuContext($213e4d2df823067d$var$CONTENT_NAME)
const $213e4d2df823067d$export$479f0f2f71193efe = /*#__PURE__*/ $cnSS2$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $cnSS2$react.createElement(
    $213e4d2df823067d$var$Collection.Provider,
    {
    ...
    /*#__PURE__*/ $cnSS2$react.createElement(
      ...
      /*#__PURE__*/ $cnSS2$react.createElement(
        $213e4d2df823067d$var$Collection.Slot,
        {
          scope: props.__scopeMenu,
        },
        rootContext.modal
          ? /*#__PURE__*/ $cnSS2$react.createElement(
              $213e4d2df823067d$var$MenuRootContentModal,
              $parcel$interopDefault($cnSS2$babelruntimehelpersextends)({}, contentProps, {
                ref: forwardedRef,
              })
            )
          : /*#__PURE__*/ $cnSS2$react.createElement(
              $213e4d2df823067d$var$MenuRootContentNonModal,
              $parcel$interopDefault($cnSS2$babelruntimehelpersextends)({}, contentProps, {
                ref: forwardedRef,
              })
            )
...
/* ---------------------------------------------------------------------------------------------- */ const $213e4d2df823067d$var$MenuRootContentModal =
  /*#__PURE__*/ $cnSS2$react.forwardRef((props, forwardedRef) => {
    const context = $213e4d2df823067d$var$useMenuContext($213e4d2df823067d$var$CONTENT_NAME, props.__scopeMenu)
    const ref = $cnSS2$react.useRef(null)
    const composedRefs = $cnSS2$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref) // Hide everything from ARIA except the `MenuContent`
    $cnSS2$react.useEffect(() => {
      const content = ref.current
      if (content) return $cnSS2$ariahidden.hideOthers(content)
    }, [])
    return /*#__PURE__*/ $cnSS2$react.createElement(
      $213e4d2df823067d$var$MenuContentImpl,
      $parcel$interopDefault($cnSS2$babelruntimehelpersextends)({}, props, {
        ref: composedRefs, // we make sure we're not trapping once it's been closed
        trapFocus: context.open, // make sure to only disable pointer events when open
        disableOutsidePointerEvents: context.open,
        disableOutsideScroll: true, // When focus is trapped, a `focusout` event may still happen.
        onFocusOutside: $cnSS2$dssuiprimitive.composeEventHandlers(
...
/* ---------------------------------------------------------------------------------------------- */ const $213e4d2df823067d$var$MenuContentImpl =
  /*#__PURE__*/ $cnSS2$react.forwardRef((props, forwardedRef) => {
    const {
      __scopeMenu: __scopeMenu,
      loop: loop = false,
    ...
    const composedRefs = $cnSS2$dssuireactcomposerefs.useComposedRefs(forwardedRef, contentRef, context.onContentChange)
    ...
    const handleTypeaheadSearch = (key) => {
      ...
      const currentMatch =
        (_items$find = items.find((item) => item.ref.current === currentItem)) === null || _items$find === void 0
          ? void 0
          : _items$find.textValue
      const values = items.map((item) => item.textValue)
      const nextMatch = $213e4d2df823067d$var$getNextMatch(values, search, currentMatch)
      const newItem =
        (_items$find2 = items.find((item) => item.textValue === nextMatch)) === null || _items$find2 === void 0
          ? void 0
          : _items$find2.ref.current // Reset `searchRef` 1 second after it was last updated
    ...
    $cnSS2$dssuireactfocusguards.useFocusGuards()
    const isPointerMovingToSubmenu = $cnSS2$react.useCallback((event) => {
      var _pointerGraceIntentRe, _pointerGraceIntentRe2
      const isMovingTowards =
        pointerDirRef.current ===
        ((_pointerGraceIntentRe = pointerGraceIntentRef.current) === null || _pointerGraceIntentRe === void 0
          ? void 0
          : _pointerGraceIntentRe.side)
      return (
        isMovingTowards &&
        $213e4d2df823067d$var$isPointerInGraceArea(
          event,
          (_pointerGraceIntentRe2 = pointerGraceIntentRef.current) === null || _pointerGraceIntentRe2 === void 0
            ? void 0
    ...
    return /*#__PURE__*/ $cnSS2$react.createElement(
      $213e4d2df823067d$var$MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef: searchRef,
        onItemEnter: $cnSS2$react.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault()
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: $cnSS2$react.useCallback(
          (event) => {
        ...
        onTriggerLeave: $cnSS2$react.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault()
          },
          [isPointerMovingToSubmenu]
      ...
      /*#__PURE__*/ $cnSS2$react.createElement(
        ...
        /*#__PURE__*/ $cnSS2$react.createElement(
          $cnSS2$dssuireactfocusscope.FocusScope,
          {
            asChild: true,
            trapped: trapFocus,
            onMountAutoFocus: $cnSS2$dssuiprimitive.composeEventHandlers(onOpenAutoFocus, (event) => {
          ...
          /*#__PURE__*/ $cnSS2$react.createElement(
            $cnSS2$dssuireactdismissablelayer.DismissableLayer,
            {
              asChild: true,
              disableOutsidePointerEvents: disableOutsidePointerEvents,
              onEscapeKeyDown: onEscapeKeyDown,
            ...
            /*#__PURE__*/ $cnSS2$react.createElement(
              $cnSS2$dssuireactrovingfocus.Root,
              $parcel$interopDefault($cnSS2$babelruntimehelpersextends)(
                {
                  asChild: true,
                },
                rovingFocusGroupScope,
                {
                  ...
                  onEntryFocus: $cnSS2$dssuiprimitive.composeEventHandlers(onEntryFocus, (event) => {
              ...
              /*#__PURE__*/ $cnSS2$react.createElement(
                ...
                $parcel$interopDefault($cnSS2$babelruntimehelpersextends)(
                  ...
                  contentProps,
                  {
                    ...
                    onKeyDown: $cnSS2$dssuiprimitive.composeEventHandlers(contentProps.onKeyDown, (event) => {
                      // submenu key events bubble through portals. We only care about keys in this menu.
                      const target = event.target
                      const isKeyDownInside = target.closest("[data-dss-menu-content]") === event.currentTarget
                    ...
                    onBlur: $cnSS2$dssuiprimitive.composeEventHandlers(props.onBlur, (event) => {
                    ...
                    onPointerMove: $cnSS2$dssuiprimitive.composeEventHandlers(
                      props.onPointerMove,
                      $213e4d2df823067d$var$whenMouse((event) => {
                        const target = event.target
...
/* -------------------------------------------------------------------------------------------------
 * MenuItem
 * -----------------------------------------------------------------------------------------------*/ const $213e4d2df823067d$var$ITEM_NAME =
  "MenuItem"
...
const $213e4d2df823067d$export$2ce376c2cc3355c8 = /*#__PURE__*/ $cnSS2$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $cnSS2$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref)
  ...
  const handleSelect = () => {
    ...
    if (!disabled && menuItem) {
      ...
      $cnSS2$dssuireactprimitive.dispatchDiscreteCustomEvent(menuItem, itemSelectEvent)
      if (itemSelectEvent.defaultPrevented) isPointerDownRef.current = false
      else rootContext.onClose()
    }
  }
  return /*#__PURE__*/ $cnSS2$react.createElement(
    $213e4d2df823067d$var$MenuItemImpl,
    $parcel$interopDefault($cnSS2$babelruntimehelpersextends)({}, itemProps, {
      ref: composedRefs,
      disabled: disabled,
      onClick: $cnSS2$dssuiprimitive.composeEventHandlers(props.onClick, handleSelect),
      onPointerDown: (event) => {
      ...
      onPointerUp: $cnSS2$dssuiprimitive.composeEventHandlers(props.onPointerUp, (event) => {
      ...
      onKeyDown: $cnSS2$dssuiprimitive.composeEventHandlers(props.onKeyDown, (event) => {
...
/* ---------------------------------------------------------------------------------------------- */ const $213e4d2df823067d$var$MenuItemImpl =
  /*#__PURE__*/ $cnSS2$react.forwardRef((props, forwardedRef) => {
    ...
    $cnSS2$react.useEffect(() => {
      ...
      if (menuItem) {
        ...
        setTextContent(
          ((_menuItem$textContent = menuItem.textContent) !== null && _menuItem$textContent !== void 0
    ...
    return /*#__PURE__*/ $cnSS2$react.createElement(
      $213e4d2df823067d$var$Collection.ItemSlot,
      {
        scope: __scopeMenu,
        disabled: disabled,
      ...
      /*#__PURE__*/ $cnSS2$react.createElement(
        $cnSS2$dssuireactrovingfocus.Item,
        $parcel$interopDefault($cnSS2$babelruntimehelpersextends)(
          {
            asChild: true,
          },
        ...
        /*#__PURE__*/ $cnSS2$react.createElement(
          ...
          $parcel$interopDefault($cnSS2$babelruntimehelpersextends)(
            ...
            itemProps,
            {
              ...
              onPointerLeave: $cnSS2$dssuiprimitive.composeEventHandlers(
                props.onPointerLeave,
                $213e4d2df823067d$var$whenMouse((event) => contentContext.onItemLeave(event))
              ),
              onFocus: $cnSS2$dssuiprimitive.composeEventHandlers(props.onFocus, () => setIsFocused(true)),
              onBlur: $cnSS2$dssuiprimitive.composeEventHandlers(props.onBlur, () => setIsFocused(false)),
            }
          )
        )
      )
...
/* -------------------------------------------------------------------------------------------------
 * MenuCheckboxItem
 * -----------------------------------------------------------------------------------------------*/ const $213e4d2df823067d$var$CHECKBOX_ITEM_NAME =
  "MenuCheckboxItem"
    ...
    /*#__PURE__*/ $cnSS2$react.createElement(
      ...
      $parcel$interopDefault($cnSS2$babelruntimehelpersextends)(
        ...
        checkboxItemProps,
        {
          ...
          onSelect: $cnSS2$dssuiprimitive.composeEventHandlers(
            checkboxItemProps.onSelect,
            () =>
              onCheckedChange === null || onCheckedChange === void 0
                ? void 0
                : onCheckedChange($213e4d2df823067d$var$isIndeterminate(checked) ? true : !checked),
            {
              checkForDefaultPrevented: false,
            }
          ),
 ...
 * -----------------------------------------------------------------------------------------------*/ const $213e4d2df823067d$var$RADIO_GROUP_NAME =
  "MenuRadioGroup"
const [$213e4d2df823067d$var$RadioGroupProvider, $213e4d2df823067d$var$useRadioGroupContext] =
  $213e4d2df823067d$var$createMenuContext($213e4d2df823067d$var$RADIO_GROUP_NAME, {
    value: undefined,
    onValueChange: () => {},
  })
const $213e4d2df823067d$export$ea2200c9eee416b3 = /*#__PURE__*/ $cnSS2$react.forwardRef((props, forwardedRef) => {
  ...
  const handleValueChange = $cnSS2$dssuireactusecallbackref.useCallbackRef(onValueChange)
  return /*#__PURE__*/ $cnSS2$react.createElement(
    $213e4d2df823067d$var$RadioGroupProvider,
    {
      scope: props.__scopeMenu,
      value: value,
    ...
    /*#__PURE__*/ $cnSS2$react.createElement(
      $213e4d2df823067d$export$22a631d1f72787bb,
      $parcel$interopDefault($cnSS2$babelruntimehelpersextends)({}, groupProps, {
        ref: forwardedRef,
      })
    )
  )
...
/* -------------------------------------------------------------------------------------------------
 * MenuRadioItem
 * -----------------------------------------------------------------------------------------------*/ const $213e4d2df823067d$var$RADIO_ITEM_NAME =
  "MenuRadioItem"
        ...
        radioItemProps,
        {
          ...
          onSelect: $cnSS2$dssuiprimitive.composeEventHandlers(
            ...
            () => {
              ...
              return (_context$onValueChang = context.onValueChange) === null || _context$onValueChang === void 0
                ? void 0
                : _context$onValueChang.call(context, value)
            },
            {
              checkForDefaultPrevented: false,
            }
...
/* -------------------------------------------------------------------------------------------------
 * MenuItemIndicator
 * -----------------------------------------------------------------------------------------------*/ const $213e4d2df823067d$var$ITEM_INDICATOR_NAME =
  "MenuItemIndicator"
const [$213e4d2df823067d$var$ItemIndicatorProvider, $213e4d2df823067d$var$useItemIndicatorContext] =
  $213e4d2df823067d$var$createMenuContext($213e4d2df823067d$var$ITEM_INDICATOR_NAME, {
    checked: false,
  })
const $213e4d2df823067d$export$a2593e23056970a3 = /*#__PURE__*/ $cnSS2$react.forwardRef((props, forwardedRef) => {
  ...
  const indicatorContext = $213e4d2df823067d$var$useItemIndicatorContext(
    $213e4d2df823067d$var$ITEM_INDICATOR_NAME,
    __scopeMenu
  )
  return /*#__PURE__*/ $cnSS2$react.createElement(
    $cnSS2$dssuireactpresence.Presence,
    {
      present:
        forceMount ||
        $213e4d2df823067d$var$isIndeterminate(indicatorContext.checked) ||
        indicatorContext.checked === true,
    },
    /*#__PURE__*/ $cnSS2$react.createElement(
      $cnSS2$dssuireactprimitive.Primitive.span,
      $parcel$interopDefault($cnSS2$babelruntimehelpersextends)({}, itemIndicatorProps, {
        ref: forwardedRef,
...
/* -------------------------------------------------------------------------------------------------
 * MenuSeparator
 * -----------------------------------------------------------------------------------------------*/ const $213e4d2df823067d$var$SEPARATOR_NAME =
  "MenuSeparator"
...
/* -------------------------------------------------------------------------------------------------
 * MenuArrow
 * -----------------------------------------------------------------------------------------------*/ const $213e4d2df823067d$var$ARROW_NAME =
  "MenuArrow"
const $213e4d2df823067d$export$bcdda4773debf5fa = /*#__PURE__*/ $cnSS2$react.forwardRef((props, forwardedRef) => {
  const { __scopeMenu: __scopeMenu, ...arrowProps } = props
  const popperScope = $213e4d2df823067d$var$usePopperScope(__scopeMenu)
  return /*#__PURE__*/ $cnSS2$react.createElement(
    $cnSS2$dssuireactpopper.Arrow,
    $parcel$interopDefault($cnSS2$babelruntimehelpersextends)({}, popperScope, arrowProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * MenuSub
 * -----------------------------------------------------------------------------------------------*/ const $213e4d2df823067d$var$SUB_NAME =
  "MenuSub"
const [$213e4d2df823067d$var$MenuSubProvider, $213e4d2df823067d$var$useMenuSubContext] =
  $213e4d2df823067d$var$createMenuContext($213e4d2df823067d$var$SUB_NAME)
const $213e4d2df823067d$export$71bdb9d1e2909932 = (props) => {
  ...
  const [content, setContent] = $cnSS2$react.useState(null)
  const handleOpenChange = $cnSS2$dssuireactusecallbackref.useCallbackRef(onOpenChange) // Prevent the parent menu from reopening with open submenus.
  $cnSS2$react.useEffect(() => {
  ...
  return /*#__PURE__*/ $cnSS2$react.createElement(
    ...
    /*#__PURE__*/ $cnSS2$react.createElement(
      ...
      /*#__PURE__*/ $cnSS2$react.createElement(
        $213e4d2df823067d$var$MenuSubProvider,
        {
          scope: __scopeMenu,
          contentId: $cnSS2$dssuireactid.useId(),
          triggerId: $cnSS2$dssuireactid.useId(),
          trigger: trigger,
...
/* -------------------------------------------------------------------------------------------------
 * MenuSubTrigger
 * -----------------------------------------------------------------------------------------------*/ const $213e4d2df823067d$var$SUB_TRIGGER_NAME =
  "MenuSubTrigger"
const $213e4d2df823067d$export$5fbbb3ba7297405f = /*#__PURE__*/ $cnSS2$react.forwardRef((props, forwardedRef) => {
  ...
  const rootContext = $213e4d2df823067d$var$useMenuRootContext(
    $213e4d2df823067d$var$SUB_TRIGGER_NAME,
    props.__scopeMenu
  )
  const subContext = $213e4d2df823067d$var$useMenuSubContext($213e4d2df823067d$var$SUB_TRIGGER_NAME, props.__scopeMenu)
  const contentContext = $213e4d2df823067d$var$useMenuContentContext(
    $213e4d2df823067d$var$SUB_TRIGGER_NAME,
    props.__scopeMenu
  )
  const openTimerRef = $cnSS2$react.useRef(null)
  const { pointerGraceTimerRef: pointerGraceTimerRef, onPointerGraceIntentChange: onPointerGraceIntentChange } =
    contentContext
  const scope = {
  ...
  return /*#__PURE__*/ $cnSS2$react.createElement(
    $213e4d2df823067d$export$9fa5ebd18bee4d43,
    $parcel$interopDefault($cnSS2$babelruntimehelpersextends)(
      {
        asChild: true,
      },
    ...
    /*#__PURE__*/ $cnSS2$react.createElement(
      ...
      $parcel$interopDefault($cnSS2$babelruntimehelpersextends)(
        ...
        props,
        {
          ref: $cnSS2$dssuireactcomposerefs.composeRefs(forwardedRef, subContext.onTriggerChange), // This is redundant for mouse users but we cannot determine pointer type from
          onClick: (event) => {
            var _props$onClick
          ...
          onKeyDown: $cnSS2$dssuiprimitive.composeEventHandlers(props.onKeyDown, (event) => {
            ...
            if ($213e4d2df823067d$var$SUB_OPEN_KEYS[rootContext.dir].includes(event.key)) {
              ...
              ;(_context$content3 = context.content) === null ||
                ...
                _context$content3.focus() // prevent window from scrolling
              event.preventDefault()
            }
          }),
        }
...
/* -------------------------------------------------------------------------------------------------
 * MenuSubContent
 * -----------------------------------------------------------------------------------------------*/ const $213e4d2df823067d$var$SUB_CONTENT_NAME =
  "MenuSubContent"
        ...
        /*#__PURE__*/ $cnSS2$react.createElement(
          ...
          $parcel$interopDefault($cnSS2$babelruntimehelpersextends)(
            ...
            subContentProps,
            {
              ...
              onFocusOutside: $cnSS2$dssuiprimitive.composeEventHandlers(props.onFocusOutside, (event) => {
                // We prevent closing when the trigger is focused to avoid triggering a re-open animation
                // on pointer interaction.
                if (event.target !== subContext.trigger) context.onOpenChange(false)
              }),
              onEscapeKeyDown: $cnSS2$dssuiprimitive.composeEventHandlers(props.onEscapeKeyDown, (event) => {
              ...
              onKeyDown: $cnSS2$dssuiprimitive.composeEventHandlers(props.onKeyDown, (event) => {
                ...
                if (isKeyDownInside && isCloseKey) {
                  ...
                  ;(_subContext$trigger = subContext.trigger) === null ||
                    ...
                    _subContext$trigger.focus() // prevent window from scrolling
                  event.preventDefault()
                }
              }),
            }
...
/* -----------------------------------------------------------------------------------------------*/ function $213e4d2df823067d$var$getOpenState(
  open
) {
