...
type PopperAnchorProps = dss.ComponentPropsWithoutRef<
...
export const MenuContent: React.ForwardRefExoticComponent<
...
export const MenuGroup: React.ForwardRefExoticComponent<
