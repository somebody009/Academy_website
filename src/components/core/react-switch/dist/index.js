...
var $cWV9h$dssuiprimitive = require("../../primitive")
var $cWV9h$dssuireactcomposerefs = require("../../react-compose-refs")
var $cWV9h$dssuireactcontext = require("../../react-context")
var $cWV9h$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
var $cWV9h$dssuireactuseprevious = require("../../react-use-previous")
var $cWV9h$dssuireactusesize = require("../../react-use-size")
var $cWV9h$dssuireactprimitive = require("../../react-primitive")
...
/* -------------------------------------------------------------------------------------------------
 * Switch
 * -----------------------------------------------------------------------------------------------*/ const $4465bdeb0ef4ccd7$var$SWITCH_NAME =
  "Switch"
const [$4465bdeb0ef4ccd7$var$createSwitchContext, $4465bdeb0ef4ccd7$export$cf7f5f17f69cbd43] =
  $cWV9h$dssuireactcontext.createContextScope($4465bdeb0ef4ccd7$var$SWITCH_NAME)
const [$4465bdeb0ef4ccd7$var$SwitchProvider, $4465bdeb0ef4ccd7$var$useSwitchContext] =
  $4465bdeb0ef4ccd7$var$createSwitchContext($4465bdeb0ef4ccd7$var$SWITCH_NAME)
const $4465bdeb0ef4ccd7$export$b5d5cf8927ab7262 = /*#__PURE__*/ $cWV9h$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $cWV9h$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) => setButton(node))
  ...
  const [checked = false, setChecked] = $cWV9h$dssuireactusecontrollablestate.useControllableState({
    prop: checkedProp,
    defaultProp: defaultChecked,
    onChange: onCheckedChange,
  })
  return /*#__PURE__*/ $cWV9h$react.createElement(
    $4465bdeb0ef4ccd7$var$SwitchProvider,
    {
      scope: __scopeSwitch,
      checked: checked,
      disabled: disabled,
    },
    /*#__PURE__*/ $cWV9h$react.createElement(
      $cWV9h$dssuireactprimitive.Primitive.button,
      $parcel$interopDefault($cWV9h$babelruntimehelpersextends)(
        {
          type: "button",
          role: "switch",
        ...
        {
          ref: composedRefs,
          onClick: $cWV9h$dssuiprimitive.composeEventHandlers(props.onClick, (event) => {
    ...
    isFormControl &&
      /*#__PURE__*/ $cWV9h$react.createElement($4465bdeb0ef4ccd7$var$BubbleInput, {
        control: button,
...
/* -------------------------------------------------------------------------------------------------
 * SwitchThumb
 * -----------------------------------------------------------------------------------------------*/ const $4465bdeb0ef4ccd7$var$THUMB_NAME =
  "SwitchThumb"
const $4465bdeb0ef4ccd7$export$4d07bf653ea69106 = /*#__PURE__*/ $cWV9h$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $cWV9h$react.createElement(
    $cWV9h$dssuireactprimitive.Primitive.span,
    $parcel$interopDefault($cWV9h$babelruntimehelpersextends)(
      {
...
/* ---------------------------------------------------------------------------------------------- */ const $4465bdeb0ef4ccd7$var$BubbleInput =
  (props) => {
    const { control: control, checked: checked, bubbles: bubbles = true, ...inputProps } = props
    const ref = $cWV9h$react.useRef(null)
    const prevChecked = $cWV9h$dssuireactuseprevious.usePrevious(checked)
    const controlSize = $cWV9h$dssuireactusesize.useSize(control) // Bubble checked change to parents (e.g form change event)
