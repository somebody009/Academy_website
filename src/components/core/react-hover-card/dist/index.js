...
var $eFX7w$dssuiprimitive = require("../../primitive")
var $eFX7w$dssuireactcontext = require("../../react-context")
var $eFX7w$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
var $eFX7w$dssuireactcomposerefs = require("../../react-compose-refs")
var $eFX7w$dssuireactpopper = require("../../react-popper")
var $eFX7w$dssuireactportal = require("../../react-portal")
var $eFX7w$dssuireactpresence = require("../../react-presence")
var $eFX7w$dssuireactprimitive = require("../../react-primitive")
var $eFX7w$dssuireactdismissablelayer = require("../../react-dismissable-layer")
...
const [$e5715e9205c1e1fe$var$createHoverCardContext, $e5715e9205c1e1fe$export$47b6998a836b7260] =
  $eFX7w$dssuireactcontext.createContextScope($e5715e9205c1e1fe$var$HOVERCARD_NAME, [
    $eFX7w$dssuireactpopper.createPopperScope,
  ])
const $e5715e9205c1e1fe$var$usePopperScope = $eFX7w$dssuireactpopper.createPopperScope()
const [$e5715e9205c1e1fe$var$HoverCardProvider, $e5715e9205c1e1fe$var$useHoverCardContext] =
  $e5715e9205c1e1fe$var$createHoverCardContext($e5715e9205c1e1fe$var$HOVERCARD_NAME)
const $e5715e9205c1e1fe$export$57a077cc9fbe653e = (props) => {
  ...
  const [open = false, setOpen] = $eFX7w$dssuireactusecontrollablestate.useControllableState({
    prop: openProp,
  ...
  const handleDismiss = $eFX7w$react.useCallback(() => setOpen(false), [setOpen]) // cleanup any queued state updates on unmount
  ...
  return /*#__PURE__*/ $eFX7w$react.createElement(
    $e5715e9205c1e1fe$var$HoverCardProvider,
    {
    ...
    /*#__PURE__*/ $eFX7w$react.createElement($eFX7w$dssuireactpopper.Root, popperScope, children)
  )
}
...
/* -------------------------------------------------------------------------------------------------
 * HoverCardTrigger
 * -----------------------------------------------------------------------------------------------*/ const $e5715e9205c1e1fe$var$TRIGGER_NAME =
  "HoverCardTrigger"
const $e5715e9205c1e1fe$export$ef9f7fd8e4ba882f = /*#__PURE__*/ $eFX7w$react.forwardRef((props, forwardedRef) => {
  ...
  const popperScope = $e5715e9205c1e1fe$var$usePopperScope(__scopeHoverCard)
  return /*#__PURE__*/ $eFX7w$react.createElement(
    $eFX7w$dssuireactpopper.Anchor,
    $parcel$interopDefault($eFX7w$babelruntimehelpersextends)(
      {
        asChild: true,
      },
      popperScope
    ),
    /*#__PURE__*/ $eFX7w$react.createElement(
      $eFX7w$dssuireactprimitive.Primitive.a,
      $parcel$interopDefault($eFX7w$babelruntimehelpersextends)(
        {
        ...
        {
          ref: forwardedRef,
          onPointerEnter: $eFX7w$dssuiprimitive.composeEventHandlers(
            props.onPointerEnter,
            $e5715e9205c1e1fe$var$excludeTouch(context.onOpen)
          ),
          onPointerLeave: $eFX7w$dssuiprimitive.composeEventHandlers(
            props.onPointerLeave,
            $e5715e9205c1e1fe$var$excludeTouch(context.onClose)
          ),
          onFocus: $eFX7w$dssuiprimitive.composeEventHandlers(props.onFocus, context.onOpen),
          onBlur: $eFX7w$dssuiprimitive.composeEventHandlers(props.onBlur, context.onClose), // prevent focus event on touch devices
          onTouchStart: $eFX7w$dssuiprimitive.composeEventHandlers(props.onTouchStart, (event) =>
...
/* -------------------------------------------------------------------------------------------------
 * HoverCardPortal
 * -----------------------------------------------------------------------------------------------*/ const $e5715e9205c1e1fe$var$PORTAL_NAME =
  "HoverCardPortal"
const [$e5715e9205c1e1fe$var$PortalProvider, $e5715e9205c1e1fe$var$usePortalContext] =
  $e5715e9205c1e1fe$var$createHoverCardContext($e5715e9205c1e1fe$var$PORTAL_NAME, {
...
const $e5715e9205c1e1fe$export$b384c6e0a789f88b = (props) => {
  ...
  return /*#__PURE__*/ $eFX7w$react.createElement(
    $e5715e9205c1e1fe$var$PortalProvider,
    {
      scope: __scopeHoverCard,
      forceMount: forceMount,
    },
    /*#__PURE__*/ $eFX7w$react.createElement(
      $eFX7w$dssuireactpresence.Presence,
      {
        present: forceMount || context.open,
      },
      /*#__PURE__*/ $eFX7w$react.createElement(
        $eFX7w$dssuireactportal.Portal,
        {
          asChild: true,
          container: container,
        },
...
/* -------------------------------------------------------------------------------------------------
 * HoverCardContent
 * -----------------------------------------------------------------------------------------------*/ const $e5715e9205c1e1fe$var$CONTENT_NAME =
  "HoverCardContent"
const $e5715e9205c1e1fe$export$aa4724a5938c586 = /*#__PURE__*/ $eFX7w$react.forwardRef((props, forwardedRef) => {
  const portalContext = $e5715e9205c1e1fe$var$usePortalContext(
    $e5715e9205c1e1fe$var$CONTENT_NAME,
  ...
  return /*#__PURE__*/ $eFX7w$react.createElement(
    ...
    /*#__PURE__*/ $eFX7w$react.createElement(
      $e5715e9205c1e1fe$var$HoverCardContentImpl,
      $parcel$interopDefault($eFX7w$babelruntimehelpersextends)(
        {
          "data-state": context.open ? "open" : "closed",
        },
...
/* ---------------------------------------------------------------------------------------------- */ const $e5715e9205c1e1fe$var$HoverCardContentImpl =
  /*#__PURE__*/ $eFX7w$react.forwardRef((props, forwardedRef) => {
    const {
      __scopeHoverCard: __scopeHoverCard,
    ...
    const composedRefs = $eFX7w$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref)
      ...
      if (ref.current) {
        const handlePointerUp = () => {
          ...
          setTimeout(() => {
            ...
            const hasSelection =
              ((_document$getSelectio = document.getSelection()) === null || _document$getSelectio === void 0
                ? void 0
    ...
    return /*#__PURE__*/ $eFX7w$react.createElement(
      $eFX7w$dssuireactdismissablelayer.DismissableLayer,
      {
        asChild: true,
        ...
        onEscapeKeyDown: onEscapeKeyDown,
        onPointerDownOutside: onPointerDownOutside,
        onFocusOutside: $eFX7w$dssuiprimitive.composeEventHandlers(onFocusOutside, (event) => {
          event.preventDefault()
        }),
        onDismiss: context.onDismiss,
      },
      /*#__PURE__*/ $eFX7w$react.createElement(
        $eFX7w$dssuireactpopper.Content,
        $parcel$interopDefault($eFX7w$babelruntimehelpersextends)({}, popperScope, contentProps, {
          onPointerDown: $eFX7w$dssuiprimitive.composeEventHandlers(contentProps.onPointerDown, (event) => {
          ...
          style: {
            ...
            "--dss-hover-card-content-transform-origin": "var(--dss-popper-transform-origin)",
            "--dss-hover-card-content-available-width": "var(--dss-popper-available-width)",
            "--dss-hover-card-content-available-height": "var(--dss-popper-available-height)",
            "--dss-hover-card-trigger-width": "var(--dss-popper-anchor-width)",
            "--dss-hover-card-trigger-height": "var(--dss-popper-anchor-height)",
          },
        })
      )
    )
...
/* -------------------------------------------------------------------------------------------------
 * HoverCardArrow
 * -----------------------------------------------------------------------------------------------*/ const $e5715e9205c1e1fe$var$ARROW_NAME =
  "HoverCardArrow"
const $e5715e9205c1e1fe$export$b9744d3e7456d806 = /*#__PURE__*/ $eFX7w$react.forwardRef((props, forwardedRef) => {
  ...
  const popperScope = $e5715e9205c1e1fe$var$usePopperScope(__scopeHoverCard)
  return /*#__PURE__*/ $eFX7w$react.createElement(
    $eFX7w$dssuireactpopper.Arrow,
    $parcel$interopDefault($eFX7w$babelruntimehelpersextends)({}, popperScope, arrowProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -----------------------------------------------------------------------------------------------*/ function $e5715e9205c1e1fe$var$excludeTouch(
  eventHandler
) {
