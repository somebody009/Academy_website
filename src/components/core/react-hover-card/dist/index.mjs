...
import {
  useRef as $eRSIW$useRef,
  useCallback as $eRSIW$useCallback,
  useEffect as $eRSIW$useEffect,
  createElement as $eRSIW$createElement,
  forwardRef as $eRSIW$forwardRef,
  useState as $eRSIW$useState,
} from "react";
import { composeEventHandlers as $eRSIW$composeEventHandlers } from "../../primitive";
import { createContextScope as $eRSIW$createContextScope } from "../../react-context";
import { useControllableState as $eRSIW$useControllableState } from "../../react-use-controllable-state";
import { useComposedRefs as $eRSIW$useComposedRefs } from "../../react-compose-refs";
import {
  createPopperScope as $eRSIW$createPopperScope,
  Root as $eRSIW$Root,
  Anchor as $eRSIW$Anchor,
  Content as $eRSIW$Content,
  Arrow as $eRSIW$Arrow,
} from "../../react-popper";
import { Portal as $eRSIW$Portal } from "../../react-portal";
import { Presence as $eRSIW$Presence } from "../../react-presence";
import { Primitive as $eRSIW$Primitive } from "../../react-primitive";
import { DismissableLayer as $eRSIW$DismissableLayer } from "../../react-dismissable-layer";
...
] = $eRSIW$createContextScope($cef8881cdc69808e$var$HOVERCARD_NAME, [
...
const [
  ...
  $cef8881cdc69808e$var$HOVERCARD_NAME
);
...
/* -------------------------------------------------------------------------------------------------
 * HoverCardTrigger
 * -----------------------------------------------------------------------------------------------*/ const $cef8881cdc69808e$var$TRIGGER_NAME =
  "HoverCardTrigger";
const $cef8881cdc69808e$export$ef9f7fd8e4ba882f =
  /*#__PURE__*/ $eRSIW$forwardRef((props, forwardedRef) => {
    const { __scopeHoverCard: __scopeHoverCard, ...triggerProps } = props;
    const context = $cef8881cdc69808e$var$useHoverCardContext(
      $cef8881cdc69808e$var$TRIGGER_NAME,
      __scopeHoverCard
    );
    const popperScope = $cef8881cdc69808e$var$usePopperScope(__scopeHoverCard);
    return /*#__PURE__*/ $eRSIW$createElement(
      $eRSIW$Anchor,
      $eRSIW$babelruntimehelpersesmextends(
        {
          asChild: true,
        },
        popperScope
      ),
      /*#__PURE__*/ $eRSIW$createElement(
        $eRSIW$Primitive.a,
        $eRSIW$babelruntimehelpersesmextends(
          {
          ...
          {
            ref: forwardedRef,
            onPointerEnter: $eRSIW$composeEventHandlers(
              props.onPointerEnter,
              $cef8881cdc69808e$var$excludeTouch(context.onOpen)
            ),
            onPointerLeave: $eRSIW$composeEventHandlers(
              props.onPointerLeave,
              $cef8881cdc69808e$var$excludeTouch(context.onClose)
            ),
            ...
            onTouchStart: $eRSIW$composeEventHandlers(
              props.onTouchStart,
...
/* -------------------------------------------------------------------------------------------------
 * HoverCardContent
 * -----------------------------------------------------------------------------------------------*/ const $cef8881cdc69808e$var$CONTENT_NAME =
  "HoverCardContent";
const $cef8881cdc69808e$export$aa4724a5938c586 =
  /*#__PURE__*/ $eRSIW$forwardRef((props, forwardedRef) => {
    const portalContext = $cef8881cdc69808e$var$usePortalContext(
      $cef8881cdc69808e$var$CONTENT_NAME,
...
/* ---------------------------------------------------------------------------------------------- */ const $cef8881cdc69808e$var$HoverCardContentImpl =
  /*#__PURE__*/ $eRSIW$forwardRef((props, forwardedRef) => {
    const {
      __scopeHoverCard: __scopeHoverCard,
    ...
    return /*#__PURE__*/ $eRSIW$createElement(
      ...
      /*#__PURE__*/ $eRSIW$createElement(
        $eRSIW$Content,
        $eRSIW$babelruntimehelpersesmextends({}, popperScope, contentProps, {
          onPointerDown: $eRSIW$composeEventHandlers(
...
/* -------------------------------------------------------------------------------------------------
 * HoverCardArrow
 * -----------------------------------------------------------------------------------------------*/ const $cef8881cdc69808e$var$ARROW_NAME =
  "HoverCardArrow";
const $cef8881cdc69808e$export$b9744d3e7456d806 =
  /*#__PURE__*/ $eRSIW$forwardRef((props, forwardedRef) => {
    const { __scopeHoverCard: __scopeHoverCard, ...arrowProps } = props;
    const popperScope = $cef8881cdc69808e$var$usePopperScope(__scopeHoverCard);
    return /*#__PURE__*/ $eRSIW$createElement(
      $eRSIW$Arrow,
      $eRSIW$babelruntimehelpersesmextends({}, popperScope, arrowProps, {
        ref: forwardedRef,
      })
    );
  });
...
/* -----------------------------------------------------------------------------------------------*/ function $cef8881cdc69808e$var$excludeTouch(
  eventHandler
) {
  return (event) =>
...
const $cef8881cdc69808e$export$41fb9f06171c75f4 =
  $cef8881cdc69808e$export$ef9f7fd8e4ba882f;
const $cef8881cdc69808e$export$602eac185826482c =
  $cef8881cdc69808e$export$b384c6e0a789f88b;
const $cef8881cdc69808e$export$7c6e2c02157bb7d2 =
  $cef8881cdc69808e$export$aa4724a5938c586;
const $cef8881cdc69808e$export$21b07c8f274aebd5 =
  $cef8881cdc69808e$export$b9744d3e7456d806;
