...
import { Primitive as $fnFM9$Primitive } from "../../react-primitive";
import { Presence as $fnFM9$Presence } from "../../react-presence";
import { createContextScope as $fnFM9$createContextScope } from "../../react-context";
import { useComposedRefs as $fnFM9$useComposedRefs } from "../../react-compose-refs";
import { useCallbackRef as $fnFM9$useCallbackRef } from "../../react-use-callback-ref";
import { useDirection as $fnFM9$useDirection } from "../../react-direction";
import { useLayoutEffect as $fnFM9$useLayoutEffect } from "../../react-use-layout-effect";
import { clamp as $fnFM9$clamp } from "../../number";
import { composeEventHandlers as $fnFM9$composeEventHandlers } from "../../primitive";
      ...
      $fnFM9$babelruntimehelpersesmextends(
        ...
        scrollbarProps,
        {
          ...
          style: {
            bottom: 0,
            left:
              context.dir === "rtl" ? "var(--dss-scroll-area-corner-width)" : 0,
            right:
              context.dir === "ltr" ? "var(--dss-scroll-area-corner-width)" : 0,
            ["--dss-scroll-area-thumb-width"]:
