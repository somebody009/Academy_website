...
var $4huGU$dssuireactprimitive = require("../../react-primitive")
var $4huGU$dssuireactpresence = require("../../react-presence")
var $4huGU$dssuireactcontext = require("../../react-context")
var $4huGU$dssuireactcomposerefs = require("../../react-compose-refs")
var $4huGU$dssuireactusecallbackref = require("../../react-use-callback-ref")
var $4huGU$dssuireactdirection = require("../../react-direction")
var $4huGU$dssuireactuselayouteffect = require("../../react-use-layout-effect")
var $4huGU$dssuinumber = require("../../number")
var $4huGU$dssuiprimitive = require("../../primitive")
 ...
 * -----------------------------------------------------------------------------------------------*/ const $f8fcbf76d19b7361$var$SCROLL_AREA_NAME =
  "ScrollArea"
const [$f8fcbf76d19b7361$var$createScrollAreaContext, $f8fcbf76d19b7361$export$488468afe3a6f2b1] =
  $4huGU$dssuireactcontext.createContextScope($f8fcbf76d19b7361$var$SCROLL_AREA_NAME)
const [$f8fcbf76d19b7361$var$ScrollAreaProvider, $f8fcbf76d19b7361$var$useScrollAreaContext] =
  $f8fcbf76d19b7361$var$createScrollAreaContext($f8fcbf76d19b7361$var$SCROLL_AREA_NAME)
const $f8fcbf76d19b7361$export$ccf8d8d7bbf3c2cc = /*#__PURE__*/ $4huGU$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $4huGU$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) => setScrollArea(node))
  const direction = $4huGU$dssuireactdirection.useDirection(dir)
  return /*#__PURE__*/ $4huGU$react.createElement(
    ...
    /*#__PURE__*/ $4huGU$react.createElement(
      $4huGU$dssuireactprimitive.Primitive.div,
      $parcel$interopDefault($4huGU$babelruntimehelpersextends)(
        ...
        scrollAreaProps,
        {
          ...
          style: {
            ...
            ["--dss-scroll-area-corner-width"]: cornerWidth + "px",
            ["--dss-scroll-area-corner-height"]: cornerHeight + "px",
            ...props.style,
          },
        }
      )
...
const $f8fcbf76d19b7361$export$a21cbf9f11fca853 = /*#__PURE__*/ $4huGU$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $4huGU$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref, context.onViewportChange)
  return /*#__PURE__*/ $4huGU$react.createElement(
    $4huGU$react.Fragment,
    null,
    /*#__PURE__*/ $4huGU$react.createElement("style", {
      dangerouslySetInnerHTML: {
        __html: `[data-dss-scroll-area-viewport]{scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;}[data-dss-scroll-area-viewport]::-webkit-scrollbar{display:none}`,
      },
    }),
    /*#__PURE__*/ $4huGU$react.createElement(
      $4huGU$dssuireactprimitive.Primitive.div,
...
const $f8fcbf76d19b7361$export$2fabd85d0eba3c57 = /*#__PURE__*/ $4huGU$react.forwardRef((props, forwardedRef) => {
  ...
  const { onScrollbarXEnabledChange: onScrollbarXEnabledChange, onScrollbarYEnabledChange: onScrollbarYEnabledChange } =
    context
  ...
  return context.type === "hover"
    ? /*#__PURE__*/ $4huGU$react.createElement(
        ...
        $parcel$interopDefault($4huGU$babelruntimehelpersextends)({}, scrollbarProps, {
          ref: forwardedRef,
...
/* -----------------------------------------------------------------------------------------------*/ const $f8fcbf76d19b7361$var$ScrollAreaScrollbarHover =
  /*#__PURE__*/ $4huGU$react.forwardRef((props, forwardedRef) => {
    ...
    return /*#__PURE__*/ $4huGU$react.createElement(
      $4huGU$dssuireactpresence.Presence,
      {
...
const $f8fcbf76d19b7361$var$ScrollAreaScrollbarScroll = /*#__PURE__*/ $4huGU$react.forwardRef((props, forwardedRef) => {
  ...
  const isHorizontal = props.orientation === "horizontal"
  const debounceScrollEnd = $f8fcbf76d19b7361$var$useDebounceCallback(() => send("SCROLL_END"), 100)
  ...
  return /*#__PURE__*/ $4huGU$react.createElement(
    ...
    /*#__PURE__*/ $4huGU$react.createElement(
      ...
      $parcel$interopDefault($4huGU$babelruntimehelpersextends)(
        ...
        {
          ref: forwardedRef,
          onPointerEnter: $4huGU$dssuiprimitive.composeEventHandlers(props.onPointerEnter, () => send("POINTER_ENTER")),
          onPointerLeave: $4huGU$dssuiprimitive.composeEventHandlers(props.onPointerLeave, () => send("POINTER_LEAVE")),
        }
      )
    )
  )
  ...
  /*#__PURE__*/ $4huGU$react.forwardRef((props, forwardedRef) => {
    ...
    if (orientation === "horizontal")
      return /*#__PURE__*/ $4huGU$react.createElement(
        ...
        $parcel$interopDefault($4huGU$babelruntimehelpersextends)({}, commonProps, {
          ref: forwardedRef,
...
/* -----------------------------------------------------------------------------------------------*/ const $f8fcbf76d19b7361$var$ScrollAreaScrollbarX =
  /*#__PURE__*/ $4huGU$react.forwardRef((props, forwardedRef) => {
    ...
    const ref = $4huGU$react.useRef(null)
    const composeRefs = $4huGU$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref, context.onScrollbarXChange)
    $4huGU$react.useEffect(() => {
    ...
    return /*#__PURE__*/ $4huGU$react.createElement(
      ...
      $parcel$interopDefault($4huGU$babelruntimehelpersextends)(
        ...
        scrollbarProps,
        {
          ...
          style: {
            bottom: 0,
            left: context.dir === "rtl" ? "var(--dss-scroll-area-corner-width)" : 0,
            right: context.dir === "ltr" ? "var(--dss-scroll-area-corner-width)" : 0,
            ["--dss-scroll-area-thumb-width"]: $f8fcbf76d19b7361$var$getThumbSize(sizes) + "px",
            ...props.style,
          },
          ...
          onWheelScroll: (event, maxScrollPos) => {
            if (context.viewport) {
              ...
              if ($f8fcbf76d19b7361$var$isScrollingWithinScrollbarBounds(scrollPos, maxScrollPos))
...
const $f8fcbf76d19b7361$var$ScrollAreaScrollbarY = /*#__PURE__*/ $4huGU$react.forwardRef((props, forwardedRef) => {
  ...
  const [computedStyle, setComputedStyle] = $4huGU$react.useState()
  const ref = $4huGU$react.useRef(null)
  const composeRefs = $4huGU$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref, context.onScrollbarYChange)
  $4huGU$react.useEffect(() => {
    if (ref.current) setComputedStyle(getComputedStyle(ref.current))
  }, [ref])
  return /*#__PURE__*/ $4huGU$react.createElement(
    ...
    $parcel$interopDefault($4huGU$babelruntimehelpersextends)(
      ...
      scrollbarProps,
      {
        ...
        style: {
          ...
          bottom: "var(--dss-scroll-area-corner-height)",
          ["--dss-scroll-area-thumb-height"]: $f8fcbf76d19b7361$var$getThumbSize(sizes) + "px",
          ...props.style,
        },
...
] = $f8fcbf76d19b7361$var$createScrollAreaContext($f8fcbf76d19b7361$var$SCROLLBAR_NAME)
const $f8fcbf76d19b7361$var$ScrollAreaScrollbarImpl = /*#__PURE__*/ $4huGU$react.forwardRef((props, forwardedRef) => {
  ...
  const composeRefs = $4huGU$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) => setScrollbar(node))
  const rectRef = $4huGU$react.useRef(null)
  const prevWebkitUserSelectRef = $4huGU$react.useRef("")
  const viewport = context.viewport
  const maxScrollPos = sizes.content - sizes.viewport
  const handleWheelScroll = $4huGU$dssuireactusecallbackref.useCallbackRef(onWheelScroll)
  const handleThumbPositionChange = $4huGU$dssuireactusecallbackref.useCallbackRef(onThumbPositionChange)
   ...
   */ $4huGU$react.useEffect(handleThumbPositionChange, [sizes, handleThumbPositionChange])
  ...
  return /*#__PURE__*/ $4huGU$react.createElement(
    $f8fcbf76d19b7361$var$ScrollbarProvider,
    {
      ...
      scrollbar: scrollbar,
      hasThumb: hasThumb,
      onThumbChange: $4huGU$dssuireactusecallbackref.useCallbackRef(onThumbChange),
      onThumbPointerUp: $4huGU$dssuireactusecallbackref.useCallbackRef(onThumbPointerUp),
      onThumbPositionChange: handleThumbPositionChange,
      onThumbPointerDown: $4huGU$dssuireactusecallbackref.useCallbackRef(onThumbPointerDown),
    },
    /*#__PURE__*/ $4huGU$react.createElement(
      $4huGU$dssuireactprimitive.Primitive.div,
      $parcel$interopDefault($4huGU$babelruntimehelpersextends)({}, scrollbarProps, {
        ...
        onPointerDown: $4huGU$dssuiprimitive.composeEventHandlers(props.onPointerDown, (event) => {
          const mainPointer = 0
        ...
        onPointerMove: $4huGU$dssuiprimitive.composeEventHandlers(props.onPointerMove, handleDragScroll),
        onPointerUp: $4huGU$dssuiprimitive.composeEventHandlers(props.onPointerUp, (event) => {
          const element = event.target
...
const $f8fcbf76d19b7361$var$ScrollAreaThumbImpl = /*#__PURE__*/ $4huGU$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRef = $4huGU$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) =>
  ...
  return /*#__PURE__*/ $4huGU$react.createElement(
    ...
    $parcel$interopDefault($4huGU$babelruntimehelpersextends)(
      ...
      thumbProps,
      {
        ref: composedRef,
        style: {
          width: "var(--dss-scroll-area-thumb-width)",
          height: "var(--dss-scroll-area-thumb-height)",
          ...style,
        },
        onPointerDownCapture: $4huGU$dssuiprimitive.composeEventHandlers(props.onPointerDownCapture, (event) => {
        ...
        onPointerUp: $4huGU$dssuiprimitive.composeEventHandlers(props.onPointerUp, scrollbarContext.onThumbPointerUp),
      }
    )
  )
})
...
/* -----------------------------------------------------------------------------------------------*/ const $f8fcbf76d19b7361$var$ScrollAreaCornerImpl =
  /*#__PURE__*/ $4huGU$react.forwardRef((props, forwardedRef) => {
    ...
    return hasSize
      ? /*#__PURE__*/ $4huGU$react.createElement(
          $4huGU$dssuireactprimitive.Primitive.div,
          $parcel$interopDefault($4huGU$babelruntimehelpersextends)({}, cornerProps, {
            ref: forwardedRef,
            style: {
              width: width1,
              height: height1,
...
function $f8fcbf76d19b7361$var$getScrollPositionFromPointer(pointerPos, pointerOffset, sizes, dir = "ltr") {
  ...
  const interpolate = $f8fcbf76d19b7361$var$linearScale([minPointerPos, maxPointerPos], scrollRange)
...
function $f8fcbf76d19b7361$var$getThumbOffsetFromScroll(scrollPos, sizes, dir = "ltr") {
  ...
  const scrollWithoutMomentum = $4huGU$dssuinumber.clamp(scrollPos, scrollClampRange)
  const interpolate = $f8fcbf76d19b7361$var$linearScale([0, maxScrollPos], [0, maxThumbPos])
...
function $f8fcbf76d19b7361$var$useDebounceCallback(callback, delay) {
  const handleCallback = $4huGU$dssuireactusecallbackref.useCallbackRef(callback)
...
function $f8fcbf76d19b7361$var$useResizeObserver(element, onResize) {
  const handleResize = $4huGU$dssuireactusecallbackref.useCallbackRef(onResize)
  $4huGU$dssuireactuselayouteffect.useLayoutEffect(() => {
    let rAF = 0
    if (element) {
      /**
