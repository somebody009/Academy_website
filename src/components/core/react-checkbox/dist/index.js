...
var $dKOox$dssuireactcomposerefs = require("../../react-compose-refs")
var $dKOox$dssuireactcontext = require("../../react-context")
var $dKOox$dssuiprimitive = require("../../primitive")
var $dKOox$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
var $dKOox$dssuireactuseprevious = require("../../react-use-previous")
var $dKOox$dssuireactusesize = require("../../react-use-size")
var $dKOox$dssuireactpresence = require("../../react-presence")
var $dKOox$dssuireactprimitive = require("../../react-primitive")
...
/* -------------------------------------------------------------------------------------------------
 * Checkbox
 * -----------------------------------------------------------------------------------------------*/ const $a17f2c9fbf2ccf8c$var$CHECKBOX_NAME =
  "Checkbox"
const [$a17f2c9fbf2ccf8c$var$createCheckboxContext, $a17f2c9fbf2ccf8c$export$b566c4ff5488ea01] =
  $dKOox$dssuireactcontext.createContextScope($a17f2c9fbf2ccf8c$var$CHECKBOX_NAME)
const [$a17f2c9fbf2ccf8c$var$CheckboxProvider, $a17f2c9fbf2ccf8c$var$useCheckboxContext] =
  $a17f2c9fbf2ccf8c$var$createCheckboxContext($a17f2c9fbf2ccf8c$var$CHECKBOX_NAME)
const $a17f2c9fbf2ccf8c$export$48513f6b9f8ce62d = /*#__PURE__*/ $dKOox$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $dKOox$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) => setButton(node))
  ...
  const [checked = false, setChecked] = $dKOox$dssuireactusecontrollablestate.useControllableState({
    prop: checkedProp,
  ...
  return /*#__PURE__*/ $dKOox$react.createElement(
    $a17f2c9fbf2ccf8c$var$CheckboxProvider,
    {
      scope: __scopeCheckbox,
      state: checked,
      disabled: disabled,
    },
    /*#__PURE__*/ $dKOox$react.createElement(
      $dKOox$dssuireactprimitive.Primitive.button,
      $parcel$interopDefault($dKOox$babelruntimehelpersextends)(
        {
          type: "button",
          role: "checkbox",
        ...
        {
          ref: composedRefs,
          onKeyDown: $dKOox$dssuiprimitive.composeEventHandlers(props.onKeyDown, (event) => {
            // According to WAI ARIA, Checkboxes don't activate on enter keypress
            if (event.key === "Enter") event.preventDefault()
          }),
          onClick: $dKOox$dssuiprimitive.composeEventHandlers(props.onClick, (event) => {
    ...
    isFormControl &&
      /*#__PURE__*/ $dKOox$react.createElement($a17f2c9fbf2ccf8c$var$BubbleInput, {
        control: button,
...
/* -------------------------------------------------------------------------------------------------
 * CheckboxIndicator
 * -----------------------------------------------------------------------------------------------*/ const $a17f2c9fbf2ccf8c$var$INDICATOR_NAME =
  "CheckboxIndicator"
...
/* ---------------------------------------------------------------------------------------------- */ const $a17f2c9fbf2ccf8c$var$BubbleInput =
  (props) => {
    const { control: control, checked: checked, bubbles: bubbles = true, ...inputProps } = props
    const ref = $dKOox$react.useRef(null)
    const prevChecked = $dKOox$dssuireactuseprevious.usePrevious(checked)
    const controlSize = $dKOox$dssuireactusesize.useSize(control) // Bubble checked change to parents (e.g form change event)
    $dKOox$react.useEffect(() => {
