...
var $47woD$dssuireactuselayouteffect = require("../../react-use-layout-effect")
...
function $dc478e4659f630c5$export$f680877a34711e37(deterministicId) {
  ...
  $47woD$dssuireactuselayouteffect.useLayoutEffect(() => {
    if (!deterministicId)
      setId((reactId) => (reactId !== null && reactId !== void 0 ? reactId : String($dc478e4659f630c5$var$count++)))
  }, [deterministicId])
  return deterministicId || (id ? `dss-${id}` : "")
}
