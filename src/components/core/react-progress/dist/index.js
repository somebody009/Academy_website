...
var $1DGzP$dssuireactcontext = require("../../react-context")
var $1DGzP$dssuireactprimitive = require("../../react-primitive")
...
/* -------------------------------------------------------------------------------------------------
 * Progress
 * -----------------------------------------------------------------------------------------------*/ const $66e9ff9cece0fdb5$var$PROGRESS_NAME =
  "Progress"
const $66e9ff9cece0fdb5$var$DEFAULT_MAX = 100
const [$66e9ff9cece0fdb5$var$createProgressContext, $66e9ff9cece0fdb5$export$388eb2d8f6d3261f] =
  $1DGzP$dssuireactcontext.createContextScope($66e9ff9cece0fdb5$var$PROGRESS_NAME)
const [$66e9ff9cece0fdb5$var$ProgressProvider, $66e9ff9cece0fdb5$var$useProgressContext] =
  $66e9ff9cece0fdb5$var$createProgressContext($66e9ff9cece0fdb5$var$PROGRESS_NAME)
const $66e9ff9cece0fdb5$export$b25a304ec7d746bb = /*#__PURE__*/ $1DGzP$react.forwardRef((props, forwardedRef) => {
  const {
    ...
    value: valueProp,
    max: maxProp,
    getValueLabel: getValueLabel = $66e9ff9cece0fdb5$var$defaultGetValueLabel,
    ...progressProps
  } = props
  ...
  return /*#__PURE__*/ $1DGzP$react.createElement(
    $66e9ff9cece0fdb5$var$ProgressProvider,
    {
      scope: __scopeProgress,
      value: value,
      max: max,
    },
    /*#__PURE__*/ $1DGzP$react.createElement(
      $1DGzP$dssuireactprimitive.Primitive.div,
      $parcel$interopDefault($1DGzP$babelruntimehelpersextends)(
        {
          "aria-valuemax": max,
          "aria-valuemin": 0,
...
$66e9ff9cece0fdb5$export$b25a304ec7d746bb.propTypes = {
  max(props, propName, componentName) {
    ...
    if (propValue && !$66e9ff9cece0fdb5$var$isValidMaxNumber(propValue))
      return new Error($66e9ff9cece0fdb5$var$getInvalidMaxError(strVal, componentName))
    return null
  },
  value(props, propName, componentName) {
    ...
    if (valueProp != null && !$66e9ff9cece0fdb5$var$isValidValueNumber(valueProp, max))
      return new Error($66e9ff9cece0fdb5$var$getInvalidValueError(strVal, componentName))
    return null
  },
}
/* -------------------------------------------------------------------------------------------------
 * ProgressIndicator
 * -----------------------------------------------------------------------------------------------*/ const $66e9ff9cece0fdb5$var$INDICATOR_NAME =
  "ProgressIndicator"
    ...
    $parcel$interopDefault($1DGzP$babelruntimehelpersextends)(
      {
        ...
        "data-value":
          (_context$value = context.value) !== null && _context$value !== void 0 ? _context$value : undefined,
...
/* ---------------------------------------------------------------------------------------------- */ function $66e9ff9cece0fdb5$var$defaultGetValueLabel(
  value,
  max
) {
