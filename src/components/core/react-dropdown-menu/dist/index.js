...
var $7dQ7Q$dssuiprimitive = require("../../primitive")
var $7dQ7Q$dssuireactcomposerefs = require("../../react-compose-refs")
var $7dQ7Q$dssuireactcontext = require("../../react-context")
var $7dQ7Q$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
var $7dQ7Q$dssuireactprimitive = require("../../react-primitive")
var $7dQ7Q$dssuireactmenu = require("../../react-menu")
var $7dQ7Q$dssuireactid = require("../../react-id")
...
/* -------------------------------------------------------------------------------------------------
 * DropdownMenu
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$DROPDOWN_MENU_NAME =
  "DropdownMenu"
const [$d1bf075a6b218014$var$createDropdownMenuContext, $d1bf075a6b218014$export$c0623cd925aeb687] =
  $7dQ7Q$dssuireactcontext.createContextScope($d1bf075a6b218014$var$DROPDOWN_MENU_NAME, [
    $7dQ7Q$dssuireactmenu.createMenuScope,
  ])
const $d1bf075a6b218014$var$useMenuScope = $7dQ7Q$dssuireactmenu.createMenuScope()
const [$d1bf075a6b218014$var$DropdownMenuProvider, $d1bf075a6b218014$var$useDropdownMenuContext] =
  $d1bf075a6b218014$var$createDropdownMenuContext($d1bf075a6b218014$var$DROPDOWN_MENU_NAME)
const $d1bf075a6b218014$export$e44a253a59704894 = (props) => {
  ...
  const [open = false, setOpen] = $7dQ7Q$dssuireactusecontrollablestate.useControllableState({
    prop: openProp,
    defaultProp: defaultOpen,
    onChange: onOpenChange,
  })
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    $d1bf075a6b218014$var$DropdownMenuProvider,
    {
      scope: __scopeDropdownMenu,
      triggerId: $7dQ7Q$dssuireactid.useId(),
      triggerRef: triggerRef,
      contentId: $7dQ7Q$dssuireactid.useId(),
      open: open,
      onOpenChange: setOpen,
      onOpenToggle: $7dQ7Q$react.useCallback(() => setOpen((prevOpen) => !prevOpen), [setOpen]),
      modal: modal,
    },
    /*#__PURE__*/ $7dQ7Q$react.createElement(
      $7dQ7Q$dssuireactmenu.Root,
      $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)({}, menuScope, {
        open: open,
        onOpenChange: setOpen,
        dir: dir,
        modal: modal,
...
/* -------------------------------------------------------------------------------------------------
 * DropdownMenuTrigger
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$TRIGGER_NAME =
  "DropdownMenuTrigger"
const $d1bf075a6b218014$export$d2469213b3befba9 = /*#__PURE__*/ $7dQ7Q$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $d1bf075a6b218014$var$useMenuScope(__scopeDropdownMenu)
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    $7dQ7Q$dssuireactmenu.Anchor,
    $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)(
      {
        asChild: true,
      },
      menuScope
    ...
    /*#__PURE__*/ $7dQ7Q$react.createElement(
      $7dQ7Q$dssuireactprimitive.Primitive.button,
      $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)(
        {
          type: "button",
        ...
        triggerProps,
        {
          ref: $7dQ7Q$dssuireactcomposerefs.composeRefs(forwardedRef, context.triggerRef),
          onPointerDown: $7dQ7Q$dssuiprimitive.composeEventHandlers(props.onPointerDown, (event) => {
          ...
          onKeyDown: $7dQ7Q$dssuiprimitive.composeEventHandlers(props.onKeyDown, (event) => {
            if (disabled) return
...
/* -------------------------------------------------------------------------------------------------
 * DropdownMenuPortal
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$PORTAL_NAME =
  "DropdownMenuPortal"
const $d1bf075a6b218014$export$cd369b4d4d54efc9 = (props) => {
  const { __scopeDropdownMenu: __scopeDropdownMenu, ...portalProps } = props
  const menuScope = $d1bf075a6b218014$var$useMenuScope(__scopeDropdownMenu)
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    $7dQ7Q$dssuireactmenu.Portal,
    $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)({}, menuScope, portalProps)
  )
}
...
/* -------------------------------------------------------------------------------------------------
 * DropdownMenuContent
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$CONTENT_NAME =
  "DropdownMenuContent"
const $d1bf075a6b218014$export$6e76d93a37c01248 = /*#__PURE__*/ $7dQ7Q$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    ...
    $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)(
      ...
      {
        ref: forwardedRef,
        onCloseAutoFocus: $7dQ7Q$dssuiprimitive.composeEventHandlers(props.onCloseAutoFocus, (event) => {
        ...
        onInteractOutside: $7dQ7Q$dssuiprimitive.composeEventHandlers(props.onInteractOutside, (event) => {
        ...
        style: {
          ...props.style,
          "--dss-dropdown-menu-content-transform-origin": "var(--dss-popper-transform-origin)",
          "--dss-dropdown-menu-content-available-width": "var(--dss-popper-available-width)",
          "--dss-dropdown-menu-content-available-height": "var(--dss-popper-available-height)",
          "--dss-dropdown-menu-trigger-width": "var(--dss-popper-anchor-width)",
          "--dss-dropdown-menu-trigger-height": "var(--dss-popper-anchor-height)",
        },
      }
    )
  )
...
/* -------------------------------------------------------------------------------------------------
 * DropdownMenuGroup
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$GROUP_NAME =
  "DropdownMenuGroup"
const $d1bf075a6b218014$export$246bebaba3a2f70e = /*#__PURE__*/ $7dQ7Q$react.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu: __scopeDropdownMenu, ...groupProps } = props
  const menuScope = $d1bf075a6b218014$var$useMenuScope(__scopeDropdownMenu)
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    $7dQ7Q$dssuireactmenu.Group,
    $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)({}, menuScope, groupProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * DropdownMenuLabel
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$LABEL_NAME =
  "DropdownMenuLabel"
const $d1bf075a6b218014$export$76e48c5b57f24495 = /*#__PURE__*/ $7dQ7Q$react.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu: __scopeDropdownMenu, ...labelProps } = props
  const menuScope = $d1bf075a6b218014$var$useMenuScope(__scopeDropdownMenu)
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    $7dQ7Q$dssuireactmenu.Label,
    $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)({}, menuScope, labelProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * DropdownMenuItem
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$ITEM_NAME =
  "DropdownMenuItem"
const $d1bf075a6b218014$export$ed97964d1871885d = /*#__PURE__*/ $7dQ7Q$react.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu: __scopeDropdownMenu, ...itemProps } = props
  const menuScope = $d1bf075a6b218014$var$useMenuScope(__scopeDropdownMenu)
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    $7dQ7Q$dssuireactmenu.Item,
    $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)({}, menuScope, itemProps, {
      ref: forwardedRef,
    })
  )
})
 ...
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$CHECKBOX_ITEM_NAME =
  "DropdownMenuCheckboxItem"
const $d1bf075a6b218014$export$53a69729da201fa9 = /*#__PURE__*/ $7dQ7Q$react.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu: __scopeDropdownMenu, ...checkboxItemProps } = props
  const menuScope = $d1bf075a6b218014$var$useMenuScope(__scopeDropdownMenu)
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    $7dQ7Q$dssuireactmenu.CheckboxItem,
    $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)({}, menuScope, checkboxItemProps, {
      ref: forwardedRef,
    })
  )
})
 ...
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$RADIO_GROUP_NAME =
  "DropdownMenuRadioGroup"
const $d1bf075a6b218014$export$3323ad73d55f587e = /*#__PURE__*/ $7dQ7Q$react.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu: __scopeDropdownMenu, ...radioGroupProps } = props
  const menuScope = $d1bf075a6b218014$var$useMenuScope(__scopeDropdownMenu)
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    $7dQ7Q$dssuireactmenu.RadioGroup,
    $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)({}, menuScope, radioGroupProps, {
      ref: forwardedRef,
    })
  )
})
 ...
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$RADIO_ITEM_NAME =
  "DropdownMenuRadioItem"
const $d1bf075a6b218014$export$e4f69b41b1637536 = /*#__PURE__*/ $7dQ7Q$react.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu: __scopeDropdownMenu, ...radioItemProps } = props
  const menuScope = $d1bf075a6b218014$var$useMenuScope(__scopeDropdownMenu)
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    $7dQ7Q$dssuireactmenu.RadioItem,
    $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)({}, menuScope, radioItemProps, {
      ref: forwardedRef,
    })
  )
})
 ...
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$INDICATOR_NAME =
  "DropdownMenuItemIndicator"
const $d1bf075a6b218014$export$42355ae145153fb6 = /*#__PURE__*/ $7dQ7Q$react.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu: __scopeDropdownMenu, ...itemIndicatorProps } = props
  const menuScope = $d1bf075a6b218014$var$useMenuScope(__scopeDropdownMenu)
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    $7dQ7Q$dssuireactmenu.ItemIndicator,
    $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)({}, menuScope, itemIndicatorProps, {
      ref: forwardedRef,
    })
  )
})
 ...
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$SEPARATOR_NAME =
  "DropdownMenuSeparator"
const $d1bf075a6b218014$export$da160178fd3bc7e9 = /*#__PURE__*/ $7dQ7Q$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $d1bf075a6b218014$var$useMenuScope(__scopeDropdownMenu)
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    $7dQ7Q$dssuireactmenu.Separator,
    $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)({}, menuScope, separatorProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * DropdownMenuArrow
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$ARROW_NAME =
  "DropdownMenuArrow"
const $d1bf075a6b218014$export$34b8980744021ec5 = /*#__PURE__*/ $7dQ7Q$react.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu: __scopeDropdownMenu, ...arrowProps } = props
  const menuScope = $d1bf075a6b218014$var$useMenuScope(__scopeDropdownMenu)
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    $7dQ7Q$dssuireactmenu.Arrow,
    $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)({}, menuScope, arrowProps, {
      ref: forwardedRef,
    })
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * DropdownMenuSub
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$export$2f307d81a64f5442 =
  (props) => {
    const {
      __scopeDropdownMenu: __scopeDropdownMenu,
      children: children,
 ...
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$SUB_TRIGGER_NAME =
  "DropdownMenuSubTrigger"
const $d1bf075a6b218014$export$21dcb7ec56f874cf = /*#__PURE__*/ $7dQ7Q$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $d1bf075a6b218014$var$useMenuScope(__scopeDropdownMenu)
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    $7dQ7Q$dssuireactmenu.SubTrigger,
    $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)({}, menuScope, subTriggerProps, {
      ref: forwardedRef,
    })
  )
})
 ...
 * -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$var$SUB_CONTENT_NAME =
  "DropdownMenuSubContent"
const $d1bf075a6b218014$export$f34ec8bc2482cc5f = /*#__PURE__*/ $7dQ7Q$react.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = $d1bf075a6b218014$var$useMenuScope(__scopeDropdownMenu)
  return /*#__PURE__*/ $7dQ7Q$react.createElement(
    $7dQ7Q$dssuireactmenu.SubContent,
    $parcel$interopDefault($7dQ7Q$babelruntimehelpersextends)({}, menuScope, subContentProps, {
      ref: forwardedRef,
      style: {
        ...props.style,
        "--dss-dropdown-menu-content-transform-origin": "var(--dss-popper-transform-origin)",
...
/* -----------------------------------------------------------------------------------------------*/ const $d1bf075a6b218014$export$be92b6f5f03c0fe9 =
  $d1bf075a6b218014$export$e44a253a59704894
