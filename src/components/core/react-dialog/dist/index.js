...
var $aJCrN$dssuiprimitive = require("../../primitive")
var $aJCrN$dssuireactcomposerefs = require("../../react-compose-refs")
var $aJCrN$dssuireactcontext = require("../../react-context")
var $aJCrN$dssuireactid = require("../../react-id")
var $aJCrN$dssuireactusecontrollablestate = require("../../react-use-controllable-state")
var $aJCrN$dssuireactdismissablelayer = require("../../react-dismissable-layer")
var $aJCrN$dssuireactfocusscope = require("../../react-focus-scope")
var $aJCrN$dssuireactportal = require("../../react-portal")
var $aJCrN$dssuireactpresence = require("../../react-presence")
var $aJCrN$dssuireactprimitive = require("../../react-primitive")
var $aJCrN$dssuireactfocusguards = require("../../react-focus-guards")
var $aJCrN$reactremovescroll = require("react-remove-scroll")
var $aJCrN$ariahidden = require("aria-hidden")
var $aJCrN$dssuireactslot = require("../../react-slot")
...
/* -------------------------------------------------------------------------------------------------
 * Dialog
 * -----------------------------------------------------------------------------------------------*/ const $f4833395aa1bca1a$var$DIALOG_NAME =
  "Dialog"
const [$f4833395aa1bca1a$var$createDialogContext, $f4833395aa1bca1a$export$cc702773b8ea3e41] =
  $aJCrN$dssuireactcontext.createContextScope($f4833395aa1bca1a$var$DIALOG_NAME)
const [$f4833395aa1bca1a$var$DialogProvider, $f4833395aa1bca1a$var$useDialogContext] =
  $f4833395aa1bca1a$var$createDialogContext($f4833395aa1bca1a$var$DIALOG_NAME)
const $f4833395aa1bca1a$export$3ddf2d174ce01153 = (props) => {
  ...
  const [open = false, setOpen] = $aJCrN$dssuireactusecontrollablestate.useControllableState({
    prop: openProp,
    defaultProp: defaultOpen,
    onChange: onOpenChange,
  })
  return /*#__PURE__*/ $aJCrN$react.createElement(
    $f4833395aa1bca1a$var$DialogProvider,
    {
      scope: __scopeDialog,
      triggerRef: triggerRef,
      contentRef: contentRef,
      contentId: $aJCrN$dssuireactid.useId(),
      titleId: $aJCrN$dssuireactid.useId(),
      descriptionId: $aJCrN$dssuireactid.useId(),
      open: open,
...
/* -------------------------------------------------------------------------------------------------
 * DialogTrigger
 * -----------------------------------------------------------------------------------------------*/ const $f4833395aa1bca1a$var$TRIGGER_NAME =
  "DialogTrigger"
const $f4833395aa1bca1a$export$2e1e1122cf0cba88 = /*#__PURE__*/ $aJCrN$react.forwardRef((props, forwardedRef) => {
  ...
  const composedTriggerRef = $aJCrN$dssuireactcomposerefs.useComposedRefs(forwardedRef, context.triggerRef)
  return /*#__PURE__*/ $aJCrN$react.createElement(
    $aJCrN$dssuireactprimitive.Primitive.button,
    $parcel$interopDefault($aJCrN$babelruntimehelpersextends)(
      {
        type: "button",
      ...
      triggerProps,
      {
        ...
        onClick: $aJCrN$dssuiprimitive.composeEventHandlers(props.onClick, context.onOpenToggle),
      }
    )
  )
})
...
/* -------------------------------------------------------------------------------------------------
 * DialogPortal
 * -----------------------------------------------------------------------------------------------*/ const $f4833395aa1bca1a$var$PORTAL_NAME =
  "DialogPortal"
const [$f4833395aa1bca1a$var$PortalProvider, $f4833395aa1bca1a$var$usePortalContext] =
  $f4833395aa1bca1a$var$createDialogContext($f4833395aa1bca1a$var$PORTAL_NAME, {
...
const $f4833395aa1bca1a$export$dad7c95542bacce0 = (props) => {
  ...
  return /*#__PURE__*/ $aJCrN$react.createElement(
    $f4833395aa1bca1a$var$PortalProvider,
    {
      scope: __scopeDialog,
      forceMount: forceMount,
    },
    $aJCrN$react.Children.map(children, (child) =>
      /*#__PURE__*/ $aJCrN$react.createElement(
        $aJCrN$dssuireactpresence.Presence,
        {
          present: forceMount || context.open,
        },
        /*#__PURE__*/ $aJCrN$react.createElement(
          $aJCrN$dssuireactportal.Portal,
          {
            asChild: true,
            container: container,
          },
...
/* -------------------------------------------------------------------------------------------------
 * DialogOverlay
 * -----------------------------------------------------------------------------------------------*/ const $f4833395aa1bca1a$var$OVERLAY_NAME =
  "DialogOverlay"
const $f4833395aa1bca1a$export$bd1d06c79be19e17 = /*#__PURE__*/ $aJCrN$react.forwardRef((props, forwardedRef) => {
  ...
  return context.modal
    ? /*#__PURE__*/ $aJCrN$react.createElement(
        ...
        /*#__PURE__*/ $aJCrN$react.createElement(
          $f4833395aa1bca1a$var$DialogOverlayImpl,
          $parcel$interopDefault($aJCrN$babelruntimehelpersextends)({}, overlayProps, {
            ref: forwardedRef,
          })
        )
      )
...
const $f4833395aa1bca1a$var$DialogOverlayImpl = /*#__PURE__*/ $aJCrN$react.forwardRef((props, forwardedRef) => {
  ...
  return (
    ...
    $aJCrN$react.createElement(
      $aJCrN$reactremovescroll.RemoveScroll,
      {
        as: $aJCrN$dssuireactslot.Slot,
        allowPinchZoom: true,
        shards: [context.contentRef],
      },
      /*#__PURE__*/ $aJCrN$react.createElement(
        $aJCrN$dssuireactprimitive.Primitive.div,
        $parcel$interopDefault($aJCrN$babelruntimehelpersextends)(
          {
            "data-state": $f4833395aa1bca1a$var$getState(context.open),
          },
...
/* -------------------------------------------------------------------------------------------------
 * DialogContent
 * -----------------------------------------------------------------------------------------------*/ const $f4833395aa1bca1a$var$CONTENT_NAME =
  "DialogContent"
const $f4833395aa1bca1a$export$b6d9565de1e068cf = /*#__PURE__*/ $aJCrN$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $aJCrN$react.createElement(
    ...
    context.modal
      ? /*#__PURE__*/ $aJCrN$react.createElement(
          $f4833395aa1bca1a$var$DialogContentModal,
          $parcel$interopDefault($aJCrN$babelruntimehelpersextends)({}, contentProps, {
            ref: forwardedRef,
          })
        )
      : /*#__PURE__*/ $aJCrN$react.createElement(
          $f4833395aa1bca1a$var$DialogContentNonModal,
          $parcel$interopDefault($aJCrN$babelruntimehelpersextends)({}, contentProps, {
            ref: forwardedRef,
          })
        )
...
/* -----------------------------------------------------------------------------------------------*/ const $f4833395aa1bca1a$var$DialogContentModal =
  /*#__PURE__*/ $aJCrN$react.forwardRef((props, forwardedRef) => {
    const context = $f4833395aa1bca1a$var$useDialogContext($f4833395aa1bca1a$var$CONTENT_NAME, props.__scopeDialog)
    const contentRef = $aJCrN$react.useRef(null)
    const composedRefs = $aJCrN$dssuireactcomposerefs.useComposedRefs(forwardedRef, context.contentRef, contentRef) // aria-hide everything except the content (better supported equivalent to setting aria-modal)
    $aJCrN$react.useEffect(() => {
      const content = contentRef.current
      if (content) return $aJCrN$ariahidden.hideOthers(content)
    }, [])
    return /*#__PURE__*/ $aJCrN$react.createElement(
      $f4833395aa1bca1a$var$DialogContentImpl,
      $parcel$interopDefault($aJCrN$babelruntimehelpersextends)({}, props, {
        ref: composedRefs, // we make sure focus isn't trapped once `DialogContent` has been closed
        trapFocus: context.open,
        disableOutsidePointerEvents: true,
        onCloseAutoFocus: $aJCrN$dssuiprimitive.composeEventHandlers(props.onCloseAutoFocus, (event) => {
        ...
        onPointerDownOutside: $aJCrN$dssuiprimitive.composeEventHandlers(props.onPointerDownOutside, (event) => {
        ...
        onFocusOutside: $aJCrN$dssuiprimitive.composeEventHandlers(props.onFocusOutside, (event) =>
          event.preventDefault()
        ),
      })
    )
  })
/* -----------------------------------------------------------------------------------------------*/ const $f4833395aa1bca1a$var$DialogContentNonModal =
  /*#__PURE__*/ $aJCrN$react.forwardRef((props, forwardedRef) => {
    const context = $f4833395aa1bca1a$var$useDialogContext($f4833395aa1bca1a$var$CONTENT_NAME, props.__scopeDialog)
...
/* -----------------------------------------------------------------------------------------------*/ const $f4833395aa1bca1a$var$DialogContentImpl =
  /*#__PURE__*/ $aJCrN$react.forwardRef((props, forwardedRef) => {
    const {
      __scopeDialog: __scopeDialog,
      trapFocus: trapFocus,
    ...
    const contentRef = $aJCrN$react.useRef(null)
    const composedRefs = $aJCrN$dssuireactcomposerefs.useComposedRefs(forwardedRef, contentRef) // Make sure the whole tree has focus guards as our `Dialog` will be
    // the last element in the DOM (beacuse of the `Portal`)
    $aJCrN$dssuireactfocusguards.useFocusGuards()
    return /*#__PURE__*/ $aJCrN$react.createElement(
      $aJCrN$react.Fragment,
      null,
      /*#__PURE__*/ $aJCrN$react.createElement(
        $aJCrN$dssuireactfocusscope.FocusScope,
        {
          asChild: true,
          loop: true,
          trapped: trapFocus,
        ...
        /*#__PURE__*/ $aJCrN$react.createElement(
          $aJCrN$dssuireactdismissablelayer.DismissableLayer,
          $parcel$interopDefault($aJCrN$babelruntimehelpersextends)(
            {
              role: "dialog",
...
/* -------------------------------------------------------------------------------------------------
 * DialogTitle
 * -----------------------------------------------------------------------------------------------*/ const $f4833395aa1bca1a$var$TITLE_NAME =
  "DialogTitle"
const $f4833395aa1bca1a$export$16f7638e4a34b909 = /*#__PURE__*/ $aJCrN$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $aJCrN$react.createElement(
    $aJCrN$dssuireactprimitive.Primitive.h2,
    $parcel$interopDefault($aJCrN$babelruntimehelpersextends)(
      {
        id: context.titleId,
      },
...
const $f4833395aa1bca1a$export$94e94c2ec2c954d5 = /*#__PURE__*/ $aJCrN$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $aJCrN$react.createElement(
    $aJCrN$dssuireactprimitive.Primitive.p,
    $parcel$interopDefault($aJCrN$babelruntimehelpersextends)(
      {
...
/* -------------------------------------------------------------------------------------------------
 * DialogClose
 * -----------------------------------------------------------------------------------------------*/ const $f4833395aa1bca1a$var$CLOSE_NAME =
  "DialogClose"
const $f4833395aa1bca1a$export$fba2fb7cd781b7ac = /*#__PURE__*/ $aJCrN$react.forwardRef((props, forwardedRef) => {
  ...
  return /*#__PURE__*/ $aJCrN$react.createElement(
    ...
    $parcel$interopDefault($aJCrN$babelruntimehelpersextends)(
      ...
      {
        ref: forwardedRef,
        onClick: $aJCrN$dssuiprimitive.composeEventHandlers(props.onClick, () => context.onOpenChange(false)),
      }
    )
  )
})
...
/* -----------------------------------------------------------------------------------------------*/ function $f4833395aa1bca1a$var$getState(
  open
) {
  return open ? "open" : "closed"
}
const $f4833395aa1bca1a$var$TITLE_WARNING_NAME = "DialogTitleWarning"
const [$f4833395aa1bca1a$export$69b62a49393917d6, $f4833395aa1bca1a$var$useWarningContext] =
  $aJCrN$dssuireactcontext.createContext($f4833395aa1bca1a$var$TITLE_WARNING_NAME, {
...
For more information, see https://dss-ui.com/primitives/docs/components/${titleWarningContext.docsSlug}`
  $aJCrN$react.useEffect(() => {
    if (titleId) {
...
const $f4833395aa1bca1a$var$DescriptionWarning = ({ contentRef: contentRef, descriptionId: descriptionId }) => {
  const descriptionWarningContext = $f4833395aa1bca1a$var$useWarningContext(
    $f4833395aa1bca1a$var$DESCRIPTION_WARNING_NAME
  )
