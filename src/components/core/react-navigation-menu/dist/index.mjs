...
import {
  forwardRef as $yHMN2$forwardRef,
  useState as $yHMN2$useState,
  useRef as $yHMN2$useRef,
  useCallback as $yHMN2$useCallback,
  useEffect as $yHMN2$useEffect,
  createElement as $yHMN2$createElement,
  Fragment as $yHMN2$Fragment,
  useMemo as $yHMN2$useMemo,
} from "react";
import $yHMN2$reactdom from "react-dom";
import { createContextScope as $yHMN2$createContextScope } from "../../react-context";
import { composeEventHandlers as $yHMN2$composeEventHandlers } from "../../primitive";
import {
  Primitive as $yHMN2$Primitive,
  dispatchDiscreteCustomEvent as $yHMN2$dispatchDiscreteCustomEvent,
} from "../../react-primitive";
import { useControllableState as $yHMN2$useControllableState } from "../../react-use-controllable-state";
import {
  useComposedRefs as $yHMN2$useComposedRefs,
  composeRefs as $yHMN2$composeRefs,
} from "../../react-compose-refs";
import { useDirection as $yHMN2$useDirection } from "../../react-direction";
import { Presence as $yHMN2$Presence } from "../../react-presence";
import { useId as $yHMN2$useId } from "../../react-id";
import { createCollection as $yHMN2$createCollection } from "../../react-collection";
import { DismissableLayer as $yHMN2$DismissableLayer } from "../../react-dismissable-layer";
import { usePrevious as $yHMN2$usePrevious } from "../../react-use-previous";
import { useLayoutEffect as $yHMN2$useLayoutEffect } from "../../react-use-layout-effect";
import { useCallbackRef as $yHMN2$useCallbackRef } from "../../react-use-callback-ref";
import { Root as $yHMN2$Root } from "../../react-visually-hidden";

/* -------------------------------------------------------------------------------------------------
 * NavigationMenu
 * -----------------------------------------------------------------------------------------------*/ const $322c88a641701f3b$var$NAVIGATION_MENU_NAME =
  "NavigationMenu";
const [
  $322c88a641701f3b$var$Collection,
  $322c88a641701f3b$var$useCollection,
  $322c88a641701f3b$var$createCollectionScope,
] = $yHMN2$createCollection($322c88a641701f3b$var$NAVIGATION_MENU_NAME);
const [
...
] = $yHMN2$createContextScope($322c88a641701f3b$var$NAVIGATION_MENU_NAME, [
  $322c88a641701f3b$var$createCollectionScope,
  $322c88a641701f3b$var$createFocusGroupCollectionScope,
]);
const [
  ...
  $322c88a641701f3b$var$NAVIGATION_MENU_NAME
);
const [
...
const $322c88a641701f3b$export$5b2278cf1e8bcae2 =
  /*#__PURE__*/ $yHMN2$forwardRef((props, forwardedRef) => {
    const {
    ...
    const composedRef = $yHMN2$useComposedRefs(forwardedRef, (node) =>
    ...
    const handleOpen = $yHMN2$useCallback(
      (itemValue) => {
        window.clearTimeout(closeTimerRef.current);
        setValue(itemValue);
      },
    ...
    const handleDelayedOpen = $yHMN2$useCallback(
      (itemValue) => {
    ...
    return /*#__PURE__*/ $yHMN2$createElement(
      ...
      /*#__PURE__*/ $yHMN2$createElement(
        $yHMN2$Primitive.nav,
        $yHMN2$babelruntimehelpersesmextends(
          {
            "aria-label": "Main",
...
/* -------------------------------------------------------------------------------------------------
 * NavigationMenuSub
 * -----------------------------------------------------------------------------------------------*/ const $322c88a641701f3b$var$SUB_NAME =
  "NavigationMenuSub";
const $322c88a641701f3b$export$5958edd6c4ee7c79 =
  /*#__PURE__*/ $yHMN2$forwardRef((props, forwardedRef) => {
    const {
      __scopeNavigationMenu: __scopeNavigationMenu,
      value: valueProp,
    ...
    const context = $322c88a641701f3b$var$useNavigationMenuContext(
      $322c88a641701f3b$var$SUB_NAME,
...
/* -----------------------------------------------------------------------------------------------*/ const $322c88a641701f3b$var$NavigationMenuProvider =
  (props) => {
    const {
      scope: scope,
    ...
    return /*#__PURE__*/ $yHMN2$createElement(
      $322c88a641701f3b$var$NavigationMenuProviderImpl,
      {
        ...
        onViewportContentChange: $yHMN2$useCallback(
...
/* -------------------------------------------------------------------------------------------------
 * NavigationMenuList
 * -----------------------------------------------------------------------------------------------*/ const $322c88a641701f3b$var$LIST_NAME =
  "NavigationMenuList";
const $322c88a641701f3b$export$c361068a95fd2286 =
  /*#__PURE__*/ $yHMN2$forwardRef((props, forwardedRef) => {
    const { __scopeNavigationMenu: __scopeNavigationMenu, ...listProps } =
      props;
    const context = $322c88a641701f3b$var$useNavigationMenuContext(
      $322c88a641701f3b$var$LIST_NAME,
      __scopeNavigationMenu
    );
    const list = /*#__PURE__*/ $yHMN2$createElement(
      $yHMN2$Primitive.ul,
      $yHMN2$babelruntimehelpersesmextends(
        {
...
/* -------------------------------------------------------------------------------------------------
 * NavigationMenuItem
 * -----------------------------------------------------------------------------------------------*/ const $322c88a641701f3b$var$ITEM_NAME =
  "NavigationMenuItem";
const [
  $322c88a641701f3b$var$NavigationMenuItemContextProvider,
  $322c88a641701f3b$var$useNavigationMenuItemContext,
] = $322c88a641701f3b$var$createNavigationMenuContext(
  $322c88a641701f3b$var$ITEM_NAME
);
const $322c88a641701f3b$export$ffdbb83a2de845c2 =
  /*#__PURE__*/ $yHMN2$forwardRef((props, forwardedRef) => {
    const {
      __scopeNavigationMenu: __scopeNavigationMenu,
      value: valueProp,
    ...
    const handleContentEntry = $yHMN2$useCallback((side = "start") => {
      if (contentRef.current) {
        ...
        const candidates = $322c88a641701f3b$var$getTabbableCandidates(
          contentRef.current
        );
        if (candidates.length)
          $322c88a641701f3b$var$focusFirst(
            side === "start" ? candidates : candidates.reverse()
          );
      }
    }, []);
    const handleContentExit = $yHMN2$useCallback(() => {
      if (contentRef.current) {
        ...
        if (candidates.length)
          restoreContentTabOrderRef.current =
            $322c88a641701f3b$var$removeFromTabOrder(candidates);
      }
    }, []);
    return /*#__PURE__*/ $yHMN2$createElement(
      $322c88a641701f3b$var$NavigationMenuItemContextProvider,
      ...
      /*#__PURE__*/ $yHMN2$createElement(
        $yHMN2$Primitive.li,
        $yHMN2$babelruntimehelpersesmextends({}, itemProps, {
          ref: forwardedRef,
        })
      )
    );
 ...
 * -----------------------------------------------------------------------------------------------*/ const $322c88a641701f3b$var$TRIGGER_NAME =
  "NavigationMenuTrigger";
const $322c88a641701f3b$export$37fe8002734d8f2 =
  /*#__PURE__*/ $yHMN2$forwardRef((props, forwardedRef) => {
    const {
      __scopeNavigationMenu: __scopeNavigationMenu,
      disabled: disabled,
    ...
    const context = $322c88a641701f3b$var$useNavigationMenuContext(
      $322c88a641701f3b$var$TRIGGER_NAME,
      props.__scopeNavigationMenu
    );
    const itemContext = $322c88a641701f3b$var$useNavigationMenuItemContext(
      $322c88a641701f3b$var$TRIGGER_NAME,
      props.__scopeNavigationMenu
    );
    const ref = $yHMN2$useRef(null);
    const composedRefs = $yHMN2$useComposedRefs(
      ref,
      itemContext.triggerRef,
      forwardedRef
    );
    const triggerId = $322c88a641701f3b$var$makeTriggerId(
      context.baseId,
      itemContext.value
    );
    const contentId = $322c88a641701f3b$var$makeContentId(
      context.baseId,
      itemContext.value
    );
    ...
    return /*#__PURE__*/ $yHMN2$createElement(
        ...
        /*#__PURE__*/ $yHMN2$createElement(
          ...
          /*#__PURE__*/ $yHMN2$createElement(
            ...
            $yHMN2$babelruntimehelpersesmextends(
              ...
              {
                ref: composedRefs,
                onPointerEnter: $yHMN2$composeEventHandlers(
                ...
                onPointerMove: $yHMN2$composeEventHandlers(
                  props.onPointerMove,
                ...
                onPointerLeave: $yHMN2$composeEventHandlers(
                ...
                onKeyDown: $yHMN2$composeEventHandlers(
                  props.onKeyDown,
                  (event) => {
      ...
      open &&
        /*#__PURE__*/ $yHMN2$createElement(
          $yHMN2$Fragment,
          null,
          /*#__PURE__*/ $yHMN2$createElement($yHMN2$Root, {
            "aria-hidden": true,
            tabIndex: 0,
          ...
          context.viewport &&
            /*#__PURE__*/ $yHMN2$createElement("span", {
              "aria-owns": contentId,
            })
        )
    );
...
/* -------------------------------------------------------------------------------------------------
 * NavigationMenuLink
 * -----------------------------------------------------------------------------------------------*/ const $322c88a641701f3b$var$LINK_NAME =
  "NavigationMenuLink";
const $322c88a641701f3b$var$LINK_SELECT = "navigationMenu.linkSelect";
const $322c88a641701f3b$export$6893bf21536567da =
  /*#__PURE__*/ $yHMN2$forwardRef((props, forwardedRef) => {
    const {
      __scopeNavigationMenu: __scopeNavigationMenu,
      active: active,
    ...
    return /*#__PURE__*/ $yHMN2$createElement(
      ...
      /*#__PURE__*/ $yHMN2$createElement(
        ...
        $yHMN2$babelruntimehelpersesmextends(
          ...
          {
            ref: forwardedRef,
            onClick: $yHMN2$composeEventHandlers(
              props.onClick,
              (event1) => {
                const target = event1.target;
                const linkSelectEvent = new CustomEvent(
                ...
                if (!linkSelectEvent.defaultPrevented && !event1.metaKey) {
                  ...
                  $yHMN2$dispatchDiscreteCustomEvent(
                    target,
 ...
 * -----------------------------------------------------------------------------------------------*/ const $322c88a641701f3b$var$INDICATOR_NAME =
  "NavigationMenuIndicator";
const $322c88a641701f3b$export$8ddb526647c0d8fb =
  /*#__PURE__*/ $yHMN2$forwardRef((props, forwardedRef) => {
    const { forceMount: forceMount, ...indicatorProps } = props;
    const context = $322c88a641701f3b$var$useNavigationMenuContext(
      $322c88a641701f3b$var$INDICATOR_NAME,
      props.__scopeNavigationMenu
    );
    const isVisible = Boolean(context.value);
    return context.indicatorTrack
      ? /*#__PURE__*/ $yHMN2$reactdom.createPortal(
          /*#__PURE__*/ $yHMN2$createElement(
            $yHMN2$Presence,
            {
            ...
            /*#__PURE__*/ $yHMN2$createElement(
              ...
              $yHMN2$babelruntimehelpersesmextends({}, indicatorProps, {
                ref: forwardedRef,
              })
            )
          ),
...
const $322c88a641701f3b$var$NavigationMenuIndicatorImpl =
  /*#__PURE__*/ $yHMN2$forwardRef((props, forwardedRef) => {
    const { __scopeNavigationMenu: __scopeNavigationMenu, ...indicatorProps } =
      props;
    const context = $322c88a641701f3b$var$useNavigationMenuContext(
      $322c88a641701f3b$var$INDICATOR_NAME,
      __scopeNavigationMenu
    ...
    $yHMN2$useEffect(() => {
      ...
      const triggerNode =
        (_items$find = items.find((item) => item.value === context.value)) ===
 ...
 * -----------------------------------------------------------------------------------------------*/ const $322c88a641701f3b$var$CONTENT_NAME =
  "NavigationMenuContent";
const $322c88a641701f3b$export$38e00e996c2f93f7 =
  /*#__PURE__*/ $yHMN2$forwardRef((props, forwardedRef) => {
    const { forceMount: forceMount, ...contentProps } = props;
    const context = $322c88a641701f3b$var$useNavigationMenuContext(
      $322c88a641701f3b$var$CONTENT_NAME,
      props.__scopeNavigationMenu
    );
    const itemContext = $322c88a641701f3b$var$useNavigationMenuItemContext(
      $322c88a641701f3b$var$CONTENT_NAME,
          ...
          /*#__PURE__*/ $yHMN2$createElement(
            ...
            $yHMN2$babelruntimehelpersesmextends(
              ...
              commonProps,
              {
                ...
                onPointerLeave: $yHMN2$composeEventHandlers(
                  props.onPointerLeave,
                  $322c88a641701f3b$var$whenMouse(context.onContentLeave)
                ),
                style: {
                  // Prevent interaction when animating out
                  pointerEvents:
                    !open && context.isRootMenu ? "none" : undefined,
                  ...commonProps.style,
                },
              }
            )
...
/* -----------------------------------------------------------------------------------------------*/ const $322c88a641701f3b$var$ViewportContentMounter =
  /*#__PURE__*/ $yHMN2$forwardRef((props, forwardedRef) => {
    const context = $322c88a641701f3b$var$useNavigationMenuContext(
      $322c88a641701f3b$var$CONTENT_NAME,
      props.__scopeNavigationMenu
...
/* -----------------------------------------------------------------------------------------------*/ const $322c88a641701f3b$var$ROOT_CONTENT_DISMISS =
  "navigationMenu.rootContentDismiss";
const $322c88a641701f3b$var$NavigationMenuContentImpl =
  /*#__PURE__*/ $yHMN2$forwardRef((props, forwardedRef) => {
    const {
      __scopeNavigationMenu: __scopeNavigationMenu,
      value: value,
      ...
      const attribute = (() => {
        ...
        if (index !== prevIndex) {
          ...
          if (isSelected && prevIndex !== -1)
            return index > prevIndex ? "from-end" : "from-start"; // If we're leaving this item for another
      ...
      /*#__PURE__*/ $yHMN2$createElement(
        ...
        $yHMN2$babelruntimehelpersesmextends(
          ...
          contentProps,
          {
            ...
            onFocusOutside: $yHMN2$composeEventHandlers(
              ...
              (event) => {
                ...
                if (
                  (_context$rootNavigati = context.rootNavigationMenu) !==
                    null &&
            ...
            onPointerDownOutside: $yHMN2$composeEventHandlers(
              ...
              (event) => {
                ...
                const isTrigger = getItems().some((item) => {
                  ...
                  return (_item$ref$current = item.ref.current) === null ||
                    _item$ref$current === void 0
                    ? void 0
            ...
            onEscapeKeyDown: $yHMN2$composeEventHandlers(
 ...
 * -----------------------------------------------------------------------------------------------*/ const $322c88a641701f3b$var$VIEWPORT_NAME =
  "NavigationMenuViewport";
const $322c88a641701f3b$export$ee880b97cc6d44a5 =
  /*#__PURE__*/ $yHMN2$forwardRef((props, forwardedRef) => {
    const { forceMount: forceMount, ...viewportProps } = props;
    const context = $322c88a641701f3b$var$useNavigationMenuContext(
      $322c88a641701f3b$var$VIEWPORT_NAME,
      props.__scopeNavigationMenu
    );
    ...
    return /*#__PURE__*/ $yHMN2$createElement(
      ...
      /*#__PURE__*/ $yHMN2$createElement(
        ...
        $yHMN2$babelruntimehelpersesmextends({}, viewportProps, {
          ref: forwardedRef,
        })
      )
    );
...
/* -----------------------------------------------------------------------------------------------*/ const $322c88a641701f3b$var$NavigationMenuViewportImpl =
  /*#__PURE__*/ $yHMN2$forwardRef((props1, forwardedRef) => {
    const {
      __scopeNavigationMenu: __scopeNavigationMenu,
      children: children,
      ...viewportImplProps
    ...
    const viewportWidth = size
      ? (size === null || size === void 0 ? void 0 : size.width) + "px"
      : undefined;
    const viewportHeight = size
      ? (size === null || size === void 0 ? void 0 : size.height) + "px"
      : undefined;
    ...
    return /*#__PURE__*/ $yHMN2$createElement(
      ...
      Array.from(viewportContentContext.items).map(
        ([value, { ref: ref, forceMount: forceMount, ...props }]) => {
          ...
          return /*#__PURE__*/ $yHMN2$createElement(
            ...
            /*#__PURE__*/ $yHMN2$createElement(
              $322c88a641701f3b$var$NavigationMenuContentImpl,
              $yHMN2$babelruntimehelpersesmextends({}, props, {
...
/* -----------------------------------------------------------------------------------------------*/ const $322c88a641701f3b$var$FOCUS_GROUP_NAME =
  "FocusGroup";
const $322c88a641701f3b$var$FocusGroup = /*#__PURE__*/ $yHMN2$forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu: __scopeNavigationMenu, ...groupProps } =
      props;
    const context = $322c88a641701f3b$var$useNavigationMenuContext(
      $322c88a641701f3b$var$FOCUS_GROUP_NAME,
      __scopeNavigationMenu
    );
    return /*#__PURE__*/ $yHMN2$createElement(
...
const $322c88a641701f3b$var$FocusGroupItem = /*#__PURE__*/ $yHMN2$forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu: __scopeNavigationMenu, ...groupProps } =
      props;
    const getItems = $322c88a641701f3b$var$useFocusGroupCollection(
      __scopeNavigationMenu
    );
    const context = $322c88a641701f3b$var$useNavigationMenuContext(
      $322c88a641701f3b$var$FOCUS_GROUP_ITEM_NAME,
      __scopeNavigationMenu
    );
    return /*#__PURE__*/ $yHMN2$createElement(
      ...
      /*#__PURE__*/ $yHMN2$createElement(
        $yHMN2$Primitive.button,
        $yHMN2$babelruntimehelpersesmextends({}, groupProps, {
          ref: forwardedRef,
          onKeyDown: $yHMN2$composeEventHandlers(props.onKeyDown, (event) => {
...
const $322c88a641701f3b$export$d7a01e11500dfb6f =
  $322c88a641701f3b$export$5958edd6c4ee7c79;
const $322c88a641701f3b$export$54c2e3dc7acea9f5 =
  $322c88a641701f3b$export$c361068a95fd2286;
const $322c88a641701f3b$export$6d08773d2e66f8f2 =
  $322c88a641701f3b$export$ffdbb83a2de845c2;
const $322c88a641701f3b$export$41fb9f06171c75f4 =
  $322c88a641701f3b$export$37fe8002734d8f2;
const $322c88a641701f3b$export$a6c7ac8248d6e38a =
  $322c88a641701f3b$export$6893bf21536567da;
const $322c88a641701f3b$export$adb584737d712b70 =
  $322c88a641701f3b$export$8ddb526647c0d8fb;
const $322c88a641701f3b$export$7c6e2c02157bb7d2 =
  $322c88a641701f3b$export$38e00e996c2f93f7;
const $322c88a641701f3b$export$d5c6c08dc2d3ca7 =
