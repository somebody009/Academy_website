...
export const createNavigationMenuScope: import("../../react-context").CreateScope
type NavigationMenuElement = React.ElementRef<typeof Primitive.nav>
type PrimitiveNavProps = dss.ComponentPropsWithoutRef<typeof Primitive.nav>
...
export const NavigationMenuSub: React.ForwardRefExoticComponent<
...
type PrimitiveUnorderedListProps = dss.ComponentPropsWithoutRef<typeof Primitive.ul>
...
type PrimitiveListItemProps = dss.ComponentPropsWithoutRef<typeof Primitive.li>
