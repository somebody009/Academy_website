...
var $g2vWm$dssuiprimitive = require("../../primitive")
var $g2vWm$dssuireactprimitive = require("../../react-primitive")
var $g2vWm$dssuireactcomposerefs = require("../../react-compose-refs")
var $g2vWm$dssuireactusecallbackref = require("../../react-use-callback-ref")
var $g2vWm$dssuireactuseescapekeydown = require("../../react-use-escape-keydown")
...
/* -------------------------------------------------------------------------------------------------
 * DismissableLayer
 * -----------------------------------------------------------------------------------------------*/ const $d715e0554b679f1f$var$DISMISSABLE_LAYER_NAME =
  "DismissableLayer"
...
const $d715e0554b679f1f$export$177fb62ff3ec1f22 = /*#__PURE__*/ $g2vWm$react.forwardRef((props, forwardedRef) => {
  ...
  const ownerDocument =
    (_node$ownerDocument = node1 === null || node1 === void 0 ? void 0 : node1.ownerDocument) !== null &&
  ...
  const composedRefs = $g2vWm$dssuireactcomposerefs.useComposedRefs(forwardedRef, (node) => setNode(node))
  ...
  $g2vWm$dssuireactuseescapekeydown.useEscapeKeydown((event) => {
  ...
  return /*#__PURE__*/ $g2vWm$react.createElement(
    $g2vWm$dssuireactprimitive.Primitive.div,
    $parcel$interopDefault($g2vWm$babelruntimehelpersextends)({}, layerProps, {
      ref: composedRefs,
      style: {
        pointerEvents: isBodyPointerEventsDisabled ? (isPointerEventsEnabled ? "auto" : "none") : undefined,
        ...props.style,
      },
      onFocusCapture: $g2vWm$dssuiprimitive.composeEventHandlers(props.onFocusCapture, focusOutside.onFocusCapture),
      onBlurCapture: $g2vWm$dssuiprimitive.composeEventHandlers(props.onBlurCapture, focusOutside.onBlurCapture),
      onPointerDownCapture: $g2vWm$dssuiprimitive.composeEventHandlers(
 ...
 * -----------------------------------------------------------------------------------------------*/ const $d715e0554b679f1f$var$BRANCH_NAME =
  "DismissableLayerBranch"
const $d715e0554b679f1f$export$4d5eb2109db14228 = /*#__PURE__*/ $g2vWm$react.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = $g2vWm$dssuireactcomposerefs.useComposedRefs(forwardedRef, ref)
  $g2vWm$react.useEffect(() => {
  ...
  return /*#__PURE__*/ $g2vWm$react.createElement(
    $g2vWm$dssuireactprimitive.Primitive.div,
    $parcel$interopDefault($g2vWm$babelruntimehelpersextends)({}, props, {
      ref: composedRefs,
    })
  )
})
 ...
 */ function $d715e0554b679f1f$var$usePointerDownOutside(
  onPointerDownOutside,
  ownerDocument = globalThis === null || globalThis === void 0 ? void 0 : globalThis.document
) {
  const handlePointerDownOutside = $g2vWm$dssuireactusecallbackref.useCallbackRef(onPointerDownOutside)
    ...
    const handlePointerDown = (event) => {
      if (event.target && !isPointerInsideReactTreeRef.current) {
        ...
        function handleAndDispatchPointerDownOutsideEvent() {
          $d715e0554b679f1f$var$handleAndDispatchCustomEvent(
            $d715e0554b679f1f$var$POINTER_DOWN_OUTSIDE,
 ...
 */ function $d715e0554b679f1f$var$useFocusOutside(
  onFocusOutside,
  ownerDocument = globalThis === null || globalThis === void 0 ? void 0 : globalThis.document
) {
  const handleFocusOutside = $g2vWm$dssuireactusecallbackref.useCallbackRef(onFocusOutside)
  ...
  $g2vWm$react.useEffect(() => {
    const handleFocus = (event) => {
      if (event.target && !isFocusInsideReactTreeRef.current) {
        ...
        $d715e0554b679f1f$var$handleAndDispatchCustomEvent(
          $d715e0554b679f1f$var$FOCUS_OUTSIDE,
          handleFocusOutside,
          eventDetail,
          {
            discrete: false,
...
function $d715e0554b679f1f$var$handleAndDispatchCustomEvent(name, handler, detail, { discrete: discrete }) {
  ...
  if (discrete) $g2vWm$dssuireactprimitive.dispatchDiscreteCustomEvent(target, event)
